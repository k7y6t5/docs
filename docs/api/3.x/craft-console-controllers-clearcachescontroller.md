---
title: craft\console\controllers\ClearCachesController
code:
  - php
  - twig
---

# ClearCachesController
...
:   [craft\console\controllers\ClearCachesController](craft-console-controllers-clearcachescontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/ClearCachesController.php)
...
| [actionAll()](craft-console-controllers-clearcachescontroller.md#method-actionall)                                                                            | Clear all caches.
| [actionIndex()](craft-console-controllers-clearcachescontroller.md#method-actionindex)                                                                        | Lists the caches that can be cleared.
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/ClearCachesController.php#L62-L70)
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/ClearCachesController.php#L31-L53)
...
| Method                                                                                                                                                          | Description
| --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------
| [defineActions()](craft-console-controllers-clearcachescontroller.md#method-defineactions)                                                                      | Returns an array of custom actions that should be available on the controller.
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/ClearCachesController.php#L75-L92)
