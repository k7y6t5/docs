---
title: craft\controllers\InstallController
code:
  - php
  - twig
---
...
:   [craft\controllers\InstallController](craft-controllers-installcontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/InstallController.php)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/InstallController.php#L42)
...
| [actionIndex()](craft-controllers-installcontroller.md#method-actionindex)                                                                              | Index action.
| [actionInstall()](craft-controllers-installcontroller.md#method-actioninstall)                                                                          | Install action.
| [actionValidateAccount()](craft-controllers-installcontroller.md#method-actionvalidateaccount)                                                          | Validates the user account credentials.
| [actionValidateDb()](craft-controllers-installcontroller.md#method-actionvalidatedb)                                                                    | Validates the DB connection settings.
| [actionValidateSite()](craft-controllers-installcontroller.md#method-actionvalidatesite)                                                                | Validates the site settings.
...
| [init()](craft-controllers-installcontroller.md#method-init)                                                                                            | Initializes the object.
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/InstallController.php#L65-L113)



#### Returns

[yii\base\Response](https://www.yiiframework.com/doc/api/2.0/yii-base-response), [string](http://php.net/language.types.string) – The requirements check response if the server doesn’t meet Craft’s requirements, or the rendering result
...
- [craft\errors\DbConnectException](craft-errors-dbconnectexception.md)\
  if a .env file can't be found and the current DB credentials are invalid
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/InstallController.php#L230-L315)



#### Returns

[yii\base\Response](https://www.yiiframework.com/doc/api/2.0/yii-base-response)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/InstallController.php#L182-L201)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/InstallController.php#L120-L175)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/InstallController.php#L208-L223)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/InstallController.php#L48-L56)
