...
:   [craft\events\AssetTransformImageEvent](craft-events-assettransformimageevent.md), [craft\events\GenerateTransformEvent](craft-events-generatetransformevent.md), [craft\events\ReplaceAssetEvent](craft-events-replaceassetevent.md)
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/AssetEvent.php)
...
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [asset](craft-events-assetevent.md#asset)                                                                      | [craft\elements\Asset](craft-elements-asset.md), [null](http://php.net/language.types.null) – The asset model associated with the event.
...
| [isNew](craft-events-assetevent.md#isnew)                                                                      | [boolean](http://php.net/language.types.boolean) – Whether the asset is brand new
...
The asset model associated with the event.



[View source](https://github.com/craftcms/cms/blob/master/src/events/AssetEvent.php#L23)
...
Whether the asset is brand new



[View source](https://github.com/craftcms/cms/blob/master/src/events/AssetEvent.php#L28)
