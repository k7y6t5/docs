---
title: craft\console\controllers\BackupController
code:
  - php
  - twig
---
...
:   [craft\console\controllers\BackupController](craft-console-controllers-backupcontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/BackupController.php)
...
| [defaultAction](craft-console-controllers-backupcontroller.md#defaultaction)                                                                         | [string](http://php.net/language.types.string) – The ID of the action that is used when the action ID is not specified in the request.
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/BackupController.php#L27)
...
| [actionDb()](craft-console-controllers-backupcontroller.md#method-actiondb)                                                                                   | Creates a new database backup.
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/BackupController.php#L42-L80)
