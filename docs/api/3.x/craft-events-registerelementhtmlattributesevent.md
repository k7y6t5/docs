---
title: craft\events\RegisterElementHtmlAttributesEvent
code:
  - php
  - twig
---
...
:   [craft\events\RegisterElementHtmlAttributesEvent](craft-events-registerelementhtmlattributesevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterElementHtmlAttributesEvent.php)
...
| [htmlAttributes](craft-events-registerelementhtmlattributesevent.md#htmlattributes)                            | [array](http://php.net/language.types.array) – List of registered HTML attributes for the element
...
List of registered HTML attributes for the element



[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterElementHtmlAttributesEvent.php#L23)
