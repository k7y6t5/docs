---
title: craft\base\ElementExporter
code:
  - php
  - twig
---
...
:   [craft\elements\exporters\Expanded](craft-elements-exporters-expanded.md), [craft\elements\exporters\Raw](craft-elements-exporters-raw.md)
...
[View source](https://github.com/craftcms/cms/blob/master/src/base/ElementExporter.php)
...
| [filename](craft-base-elementexporter.md#filename)                                                                               | [string](http://php.net/language.types.string)
...
| Property                                                 | Description
| -------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------
| [elementType](craft-base-elementexporter.md#elementtype) | [string](http://php.net/language.types.string), [craft\base\ElementInterface](craft-base-elementinterface.md)
...
[View source](https://github.com/craftcms/cms/blob/master/src/base/ElementExporter.php#L21)
...
| [export()](craft-base-elementexporterinterface.md#method-export "Defined by craft\base\ElementExporterInterface")                               | Creates the export data for elements fetched with the given element query.
...
| [getFilename()](craft-base-elementexporter.md#method-getfilename)                                                                               | Returns the filename (sans extension) that the export file should have.
...
| [setElementType()](craft-base-elementexporter.md#method-setelementtype)                                                                         | Sets the element type on the exporter.
...
[View source](https://github.com/craftcms/cms/blob/master/src/base/ElementExporter.php#L34-L39)
...
[View source](https://github.com/craftcms/cms/blob/master/src/base/ElementExporter.php#L26-L29)
