---
title: craft\console\controllers\RestoreController
code:
  - php
  - twig
---
...
:   [craft\console\controllers\RestoreController](craft-console-controllers-restorecontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/RestoreController.php)
...
| [defaultAction](craft-console-controllers-restorecontroller.md#defaultaction)                                                                        | [string](http://php.net/language.types.string) – The ID of the action that is used when the action ID is not specified in the request.
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/RestoreController.php#L26)
...
| [actionDb()](craft-console-controllers-restorecontroller.md#method-actiondb)                                                                                  | Allows you to restore a database from a backup.
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/RestoreController.php#L34-L53)
