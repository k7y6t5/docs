---
title: craft\events\SetElementTableAttributeHtmlEvent
code:
  - php
  - twig
---

# SetElementTableAttributeHtmlEvent
...
:   [craft\events\SetElementTableAttributeHtmlEvent](craft-events-setelementtableattributehtmlevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/SetElementTableAttributeHtmlEvent.php)
...
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [attribute](craft-events-setelementtableattributehtmlevent.md#attribute)                                       | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The table attribute associated with this event.
...
| [html](craft-events-setelementtableattributehtmlevent.md#html)                                                 | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The HTML to represent a table attribute.
...
The table attribute associated with this event.



[View source](https://github.com/craftcms/cms/blob/master/src/events/SetElementTableAttributeHtmlEvent.php#L23)
...
The HTML to represent a table attribute.



[View source](https://github.com/craftcms/cms/blob/master/src/events/SetElementTableAttributeHtmlEvent.php#L28)
