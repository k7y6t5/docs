---
title: craft\queue\jobs\GeneratePendingTransforms
code:
  - php
  - twig
---
...
:   [craft\queue\jobs\GeneratePendingTransforms](craft-queue-jobs-generatependingtransforms.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/queue/jobs/GeneratePendingTransforms.php)
...
| [execute()](craft-queue-jobs-generatependingtransforms.md#method-execute)                                                                 |
...
[View source](https://github.com/craftcms/cms/blob/master/src/queue/jobs/GeneratePendingTransforms.php#L24-L46)
...
| Method                                                                                          | Description
| ----------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------
| [defaultDescription()](craft-queue-jobs-generatependingtransforms.md#method-defaultdescription) | Returns a default description for [getDescription()](craft-queue-basejob.md#method-getdescription).
...
[View source](https://github.com/craftcms/cms/blob/master/src/queue/jobs/GeneratePendingTransforms.php#L51-L54)
