---
title: craft\web\assets\xregexp\XregexpAsset
code:
  - php
  - twig
---
...
:   craft\web\assets\xregexp

Inherits

:   [craft\web\assets\xregexp\XregexpAsset](craft-web-assets-xregexp-xregexpasset.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/xregexp/XregexpAsset.php)
...
| [init()](craft-web-assets-xregexp-xregexpasset.md#method-init)                                                                                    | Initializes the bundle.
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/xregexp/XregexpAsset.php#L20-L29)
