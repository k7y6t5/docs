---
title: craft\events\SetAssetFilenameEvent
code:
  - php
  - twig
---

# SetAssetFilenameEvent
...
:   [craft\events\SetAssetFilenameEvent](craft-events-setassetfilenameevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/SetAssetFilenameEvent.php)
...
| [extension](craft-events-setassetfilenameevent.md#extension)                                                   | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The asset extension
| [filename](craft-events-setassetfilenameevent.md#filename)                                                     | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The asset filename (sans extension).
...
| [originalFilename](craft-events-setassetfilenameevent.md#originalfilename)                                     | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The asset filename prior to sanitation (sans extension).
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/SetAssetFilenameEvent.php#L33)
...
The asset filename (sans extension).



[View source](https://github.com/craftcms/cms/blob/master/src/events/SetAssetFilenameEvent.php#L23)
...
The asset filename prior to sanitation (sans extension).



[View source](https://github.com/craftcms/cms/blob/master/src/events/SetAssetFilenameEvent.php#L28)
