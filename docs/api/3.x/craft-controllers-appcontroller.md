---
title: craft\controllers\AppController
code:
  - php
  - twig
---
...
:   [craft\controllers\AppController](craft-controllers-appcontroller.md) &raquo;
...
Note that all actions in the controller require an authenticated Craft session via [allowAnonymous](craft-controllers-appcontroller.md#allowanonymous).



[View source](https://github.com/craftcms/cms/blob/master/src/controllers/AppController.php)
...
| [allowAnonymous](craft-controllers-appcontroller.md#allowanonymous)                                                                              | [integer](http://php.net/language.types.integer), [boolean](http://php.net/language.types.boolean), [integer](http://php.net/language.types.integer)[], [string](http://php.net/language.types.string)[] – Whether this controller’s actions can be accessed anonymously.
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/AppController.php#L43-L45)
...
| [actionApiHeaders()](craft-controllers-appcontroller.md#method-actionapiheaders)                                                                        | Returns the latest Craftnet API headers.
| [actionCacheUpdates()](craft-controllers-appcontroller.md#method-actioncacheupdates)                                                                    | Caches new update info and then returns it.
| [actionCheckForUpdates()](craft-controllers-appcontroller.md#method-actioncheckforupdates)                                                              | Returns update info.
| [actionGetCpAlerts()](craft-controllers-appcontroller.md#method-actiongetcpalerts)                                                                      | Returns any alerts that should be displayed in the control panel.
| [actionGetPluginLicenseInfo()](craft-controllers-appcontroller.md#method-actiongetpluginlicenseinfo)                                                    | Fetches plugin license statuses.
| [actionGetUtilitiesBadgeCount()](craft-controllers-appcontroller.md#method-actiongetutilitiesbadgecount)                                                | Returns the badge count for the Utilities nav item.
| [actionMigrate()](craft-controllers-appcontroller.md#method-actionmigrate)                                                                              | Creates a DB backup (if configured to do so), runs any pending Craft, plugin, & content migrations, and syncs `project.yaml` changes in one go.
| [actionProcessApiResponseHeaders()](craft-controllers-appcontroller.md#method-actionprocessapiresponseheaders)                                          | Processes an API response’s headers.
| [actionShunCpAlert()](craft-controllers-appcontroller.md#method-actionshuncpalert)                                                                      | Shuns a control panel alert for 24 hours.
| [actionSwitchToLicensedEdition()](craft-controllers-appcontroller.md#method-actionswitchtolicensededition)                                              | Switches Craft to the edition it's licensed for.
| [actionTryEdition()](craft-controllers-appcontroller.md#method-actiontryedition)                                                                        | Tries a Craft edition on for size.
| [actionUpdatePluginLicense()](craft-controllers-appcontroller.md#method-actionupdatepluginlicense)                                                      | Updates a plugin's license key.
...
| [beforeAction()](craft-controllers-appcontroller.md#method-beforeaction)                                                                                | This method is invoked right before an action is executed.
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/AppController.php#L66-L70)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/AppController.php#L125-L141)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/AppController.php#L94-L116)
...
- [yii\web\BadRequestHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-badrequesthttpexception)\
  if the request doesn't accept a JSON response
- [yii\web\ForbiddenHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-forbiddenhttpexception)\
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/AppController.php#L308-L319)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/AppController.php#L414-L421)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/AppController.php#L286-L301)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/AppController.php#L194-L279)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/AppController.php#L79-L85)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/AppController.php#L326-L344)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/AppController.php#L393-L407)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/AppController.php#L352-L386)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/AppController.php#L428-L444)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/AppController.php#L50-L57)
