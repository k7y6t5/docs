---
title: craft\validators\SlugValidator
code:
  - php
  - twig
---
...
:   [craft\validators\SlugValidator](craft-validators-slugvalidator.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/SlugValidator.php)
...
| [language](craft-validators-slugvalidator.md#language)                                                                                                           | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The language to pull ASCII character mappings for, if [limitAutoSlugsToAscii](craft-validators-slugvalidator.md#limitautoslugstoascii) is enabled.
| [limitAutoSlugsToAscii](craft-validators-slugvalidator.md#limitautoslugstoascii)                                                                                 | [boolean](http://php.net/language.types.boolean), [null](http://php.net/language.types.null) – Whether auto-generated slugs should be limited to ASCII characters.
...
| [sourceAttribute](craft-validators-slugvalidator.md#sourceattribute)                                                                                             | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The source attribute that auto-generated slugs should be based on.
...
The language to pull ASCII character mappings for, if [limitAutoSlugsToAscii](craft-validators-slugvalidator.md#limitautoslugstoascii) is enabled.



[View source](https://github.com/craftcms/cms/blob/master/src/validators/SlugValidator.php#L38)
...
Whether auto-generated slugs should be limited to ASCII characters. Defaults to the `limitAutoSlugsToAscii` config setting if left null.



[View source](https://github.com/craftcms/cms/blob/master/src/validators/SlugValidator.php#L32)
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/SlugValidator.php#L27)
...
| [init()](craft-validators-slugvalidator.md#method-init)                                                                                                               | Initializes the object.
...
| [validateAttribute()](craft-validators-slugvalidator.md#method-validateattribute)                                                                                     | Validates a single attribute.
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/SlugValidator.php#L43-L54)
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/SlugValidator.php#L59-L93)
...
| [validateValue()](craft-validators-slugvalidator.md#method-validatevalue)                                                                         | Validates a value.
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/SlugValidator.php#L98-L113)
