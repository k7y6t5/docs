...
:   [craft\records\Tag](craft-records-tag.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/Tag.php)
...
| [element](craft-records-tag.md#element)                                                                                                                | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
| [errors](https://www.yiiframework.com/doc/api/2.0/yii-base-model#$errors-detail "Defined by yii\base\Model")                                           | [array](http://php.net/language.types.array) – Errors for all attributes or the specified attribute.
| [firstErrors](https://www.yiiframework.com/doc/api/2.0/yii-base-model#$firstErrors-detail "Defined by yii\base\Model")                                 | [array](http://php.net/language.types.array) – The first errors.
| [group](craft-records-tag.md#group)                                                                                                                    | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [getElement()](craft-records-tag.md#method-getelement)                                                                                                          | Returns the tag’s element.
...
| [getGroup()](craft-records-tag.md#method-getgroup)                                                                                                              | Returns the tag’s group.
...
| [tableName()](craft-records-tag.md#method-tablename)                                                                                                            | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/Tag.php#L40-L43)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/Tag.php#L50-L53)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/Tag.php#L30-L33)
