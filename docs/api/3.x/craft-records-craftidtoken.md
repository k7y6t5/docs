---
title: craft\records\CraftIdToken
code:
  - php
  - twig
---
...
:   [craft\records\CraftIdToken](craft-records-craftidtoken.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/CraftIdToken.php)
...
| [user](craft-records-craftidtoken.md#user)                                                                                                             | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [getUser()](craft-records-craftidtoken.md#method-getuser)                                                                                                       | Returns the OAuth Tokens’s user.
...
| [tableName()](craft-records-craftidtoken.md#method-tablename)                                                                                                   | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/CraftIdToken.php#L40-L43)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/CraftIdToken.php#L30-L33)
