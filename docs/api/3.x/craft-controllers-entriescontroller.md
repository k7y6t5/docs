---
title: craft\controllers\EntriesController
code:
  - php
  - twig
---
...
:   [craft\controllers\EntriesController](craft-controllers-entriescontroller.md) &raquo;
[craft\controllers\BaseEntriesController](craft-controllers-baseentriescontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/EntriesController.php)
...
| [actionDeleteEntry()](craft-controllers-entriescontroller.md#method-actiondeleteentry)                                                                  | Deletes an entry.
| [actionDuplicateEntry()](craft-controllers-entriescontroller.md#method-actionduplicateentry)                                                            | Duplicates an entry.
| [actionEditEntry()](craft-controllers-entriescontroller.md#method-actioneditentry)                                                                      | Called when a user brings up an entry for editing before being displayed.
| [actionSaveEntry()](craft-controllers-entriescontroller.md#method-actionsaveentry)                                                                      | Saves an entry.
| [actionSwitchEntryType()](craft-controllers-entriescontroller.md#method-actionswitchentrytype)                                                          | Switches between two entry types.
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/EntriesController.php#L439-L482)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/EntriesController.php#L428-L431)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/EntriesController.php#L56-L249)


#### Arguments

- `$section` ([string](http://php.net/language.types.string)) – The section’s handle
- `$entryId` ([integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null)) – The entry’s ID, if editing an existing entry.
- `$draftId` ([integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null)) – The entry draft’s ID, if editing an existing draft.
- `$revisionId` ([integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null)) – The entry revision’s ID, if editing an existing revision.
- `$site` ([string](http://php.net/language.types.string), [null](http://php.net/language.types.null)) – The site handle, if specified.
- `$entry` ([craft\elements\Entry](craft-elements-entry.md), [null](http://php.net/language.types.null)) – The entry being edited, if there were any validation errors.
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/EntriesController.php#L296-L419)


#### Arguments

- `$duplicate` ([boolean](http://php.net/language.types.boolean)) – Whether the entry should be duplicated
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/EntriesController.php#L256-L287)
...
| Method                                                                                                                                                              | Description
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------
| [docTitle()](craft-controllers-baseentriescontroller.md#method-doctitle "Defined by craft\controllers\BaseEntriesController")                                       | Returns the document title that should be used on an Edit Entry page.
| [editableSiteIds()](craft-controllers-baseentriescontroller.md#method-editablesiteids "Defined by craft\controllers\BaseEntriesController")                         | Returns the editable site IDs for a section.
| [enabledForSiteValue()](craft-controllers-baseentriescontroller.md#method-enabledforsitevalue "Defined by craft\controllers\BaseEntriesController")                 | Returns the posted `enabledForSite` value, taking the user’s permissions into account.
| [enforceEditEntryPermissions()](craft-controllers-baseentriescontroller.md#method-enforceeditentrypermissions "Defined by craft\controllers\BaseEntriesController") | Enforces all Edit Entry permissions.
| [pageTitle()](craft-controllers-baseentriescontroller.md#method-pagetitle "Defined by craft\controllers\BaseEntriesController")                                     | Returns the page title that should be used on an Edit Entry page.
...
:   `\craft\controllers\ElementEvent`



The event that is triggered when an entry’s template is rendered for Live Preview.
