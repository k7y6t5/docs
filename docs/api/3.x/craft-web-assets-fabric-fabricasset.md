---
title: craft\web\assets\fabric\FabricAsset
code:
  - php
  - twig
---
...
:   craft\web\assets\fabric

Inherits

:   [craft\web\assets\fabric\FabricAsset](craft-web-assets-fabric-fabricasset.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/fabric/FabricAsset.php)
...
| [init()](craft-web-assets-fabric-fabricasset.md#method-init)                                                                                      | Initializes the bundle.
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/fabric/FabricAsset.php#L20-L29)
