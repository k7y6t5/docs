---
title: craft\events\ElementEvent
code:
  - php
  - twig
---
...
:   [craft\events\DeleteElementEvent](craft-events-deleteelementevent.md), [craft\events\MoveElementEvent](craft-events-moveelementevent.md), [craft\events\PopulateElementEvent](craft-events-populateelementevent.md)
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/ElementEvent.php)
...
| [element](craft-events-elementevent.md#element)                                                                | [craft\base\ElementInterface](craft-base-elementinterface.md), [null](http://php.net/language.types.null) – The element model associated with the event.
...
| [isNew](craft-events-elementevent.md#isnew)                                                                    | [boolean](http://php.net/language.types.boolean) – Whether the element is brand new
...
The element model associated with the event.



[View source](https://github.com/craftcms/cms/blob/master/src/events/ElementEvent.php#L24)
...
Whether the element is brand new



[View source](https://github.com/craftcms/cms/blob/master/src/events/ElementEvent.php#L29)
