---
title: craft\console\controllers\ServeController
code:
  - php
  - twig
---
...
:   [craft\console\controllers\ServeController](craft-console-controllers-servecontroller.md) &raquo;
[yii\console\controllers\ServeController](https://www.yiiframework.com/doc/api/2.0/yii-console-controllers-servecontroller) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/ServeController.php)
...
| [docroot](craft-console-controllers-servecontroller.md#docroot)                                                                                                | [string](http://php.net/language.types.string) – Path or [path alias](guide:concept-aliases) to directory to serve
...
| [port](https://www.yiiframework.com/doc/api/2.0/yii-console-controllers-servecontroller#$port-detail "Defined by yii\console\controllers\ServeController")     | [integer](http://php.net/language.types.integer) – Port to serve on.
...
| [router](https://www.yiiframework.com/doc/api/2.0/yii-console-controllers-servecontroller#$router-detail "Defined by yii\console\controllers\ServeController") | [string](http://php.net/language.types.string) – Path to router script.
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/ServeController.php#L26)
...
| [actionIndex()](https://www.yiiframework.com/doc/api/2.0/yii-console-controllers-servecontroller#actionIndex()-detail "Defined by yii\console\controllers\ServeController")     | Runs PHP built-in web server.
...
| [optionAliases()](https://www.yiiframework.com/doc/api/2.0/yii-console-controllers-servecontroller#optionAliases()-detail "Defined by yii\console\controllers\ServeController") | Returns option alias names.
| [options()](https://www.yiiframework.com/doc/api/2.0/yii-console-controllers-servecontroller#options()-detail "Defined by yii\console\controllers\ServeController")             | Returns the names of valid options for the action (id) An option requires the existence of a public member variable whose name is the option name.
...
| [isAddressTaken()](https://www.yiiframework.com/doc/api/2.0/yii-console-controllers-servecontroller#isAddressTaken()-detail "Defined by yii\console\controllers\ServeController") |
