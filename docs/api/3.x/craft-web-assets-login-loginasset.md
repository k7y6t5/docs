---
title: craft\web\assets\login\LoginAsset
code:
  - php
  - twig
---
...
:   craft\web\assets\login

Inherits

:   [craft\web\assets\login\LoginAsset](craft-web-assets-login-loginasset.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/login/LoginAsset.php)
...
| [init()](craft-web-assets-login-loginasset.md#method-init)                                                                                        | Initializes the bundle.
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/login/LoginAsset.php#L21-L38)
