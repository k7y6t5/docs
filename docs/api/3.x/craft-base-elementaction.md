---
title: craft\base\ElementAction
code:
  - php
  - twig
---
...
[View source](https://github.com/craftcms/cms/blob/master/src/base/ElementAction.php)
...
| [confirmationMessage](craft-base-elementaction.md#confirmationmessage)                                                           | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The confirmation message, if any.
...
| [message](craft-base-elementaction.md#message)                                                                                   | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The message that should be displayed to the user.
...
| [triggerHtml](craft-base-elementaction.md#triggerhtml)                                                                           | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The action’s trigger HTML.
| [triggerLabel](craft-base-elementaction.md#triggerlabel)                                                                         | [string](http://php.net/language.types.string) – The action’s trigger label
...
| Property                                               | Description
| ------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------
| [elementType](craft-base-elementaction.md#elementtype) | [string](http://php.net/language.types.string), [craft\base\ElementInterface](craft-base-elementinterface.md)
...
[View source](https://github.com/craftcms/cms/blob/master/src/base/ElementAction.php#L33)
...
| [getConfirmationMessage()](craft-base-elementaction.md#method-getconfirmationmessage)                                                           | Returns a confirmation message that should be displayed before the action is performed.
...
| [getMessage()](craft-base-elementaction.md#method-getmessage)                                                                                   | Returns the message that should be displayed to the user after the action is performed.
...
| [getTriggerHtml()](craft-base-elementaction.md#method-gettriggerhtml)                                                                           | Returns the action’s trigger HTML.
| [getTriggerLabel()](craft-base-elementaction.md#method-gettriggerlabel)                                                                         | Returns the action’s trigger label.
...
| [isDestructive()](craft-base-elementaction.md#method-isdestructive)                                                                             | Returns whether this action is destructive in nature.
...
| [performAction()](craft-base-elementaction.md#method-performaction)                                                                             | Performs the action on any elements that match the given criteria.
...
| [setElementType()](craft-base-elementaction.md#method-setelementtype)                                                                           | Sets the element type on the action.
...
[View source](https://github.com/craftcms/cms/blob/master/src/base/ElementAction.php#L67-L70)
...
[View source](https://github.com/craftcms/cms/blob/master/src/base/ElementAction.php#L83-L86)
...
[View source](https://github.com/craftcms/cms/blob/master/src/base/ElementAction.php#L59-L62)
...
[View source](https://github.com/craftcms/cms/blob/master/src/base/ElementAction.php#L51-L54)
...
[View source](https://github.com/craftcms/cms/blob/master/src/base/ElementAction.php#L23-L26)
...
[View source](https://github.com/craftcms/cms/blob/master/src/base/ElementAction.php#L75-L78)
...
[View source](https://github.com/craftcms/cms/blob/master/src/base/ElementAction.php#L43-L46)
...
| [setMessage()](craft-base-elementaction.md#method-setmessage)                                                                                           | Sets the message that should be displayed to the user after the action is performed.
...
[View source](https://github.com/craftcms/cms/blob/master/src/base/ElementAction.php#L93-L96)


#### Arguments

- `$message` ([string](http://php.net/language.types.string)) – The message that should be displayed to the user after the action is performed.
