---
title: craft\records\UserPermission_UserGroup
code:
  - php
  - twig
---

# UserPermission_UserGroup
...
:   [craft\records\UserPermission_UserGroup](craft-records-userpermission_usergroup.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/UserPermission_UserGroup.php)
...
| [group](craft-records-userpermission_usergroup.md#group)                                                                                               | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [permission](craft-records-userpermission_usergroup.md#permission)                                                                                     | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [getGroup()](craft-records-userpermission_usergroup.md#method-getgroup)                                                                                         | Returns the user permission user group’s group.
...
| [getPermission()](craft-records-userpermission_usergroup.md#method-getpermission)                                                                               | Returns the user permission user group’s permission.
...
| [rules()](craft-records-userpermission_usergroup.md#method-rules)                                                                                               | Returns the validation rules for attributes.
...
| [tableName()](craft-records-userpermission_usergroup.md#method-tablename)                                                                                       | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/UserPermission_UserGroup.php#L62-L65)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/UserPermission_UserGroup.php#L51-L55)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/UserPermission_UserGroup.php#L30-L35)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/UserPermission_UserGroup.php#L41-L44)
