---
title: craft\web\assets\updater\UpdaterAsset
code:
  - php
  - twig
---
...
:   craft\web\assets\updater

Inherits

:   [craft\web\assets\updater\UpdaterAsset](craft-web-assets-updater-updaterasset.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/updater/UpdaterAsset.php)
...
| [init()](craft-web-assets-updater-updaterasset.md#method-init)                                                                            | Initializes the bundle.
...
| [registerAssetFiles()](craft-web-assets-updater-updaterasset.md#method-registerassetfiles)                                                | Registers the CSS and JS files with the given view.
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/updater/UpdaterAsset.php#L22-L39)
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/updater/UpdaterAsset.php#L44-L57)
