---
title: craft\controllers\ElementIndexSettingsController
code:
  - php
  - twig
---
...
:   [craft\controllers\ElementIndexSettingsController](craft-controllers-elementindexsettingscontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/ElementIndexSettingsController.php)
...
| [actionGetCustomizeSourcesModalData()](craft-controllers-elementindexsettingscontroller.md#method-actiongetcustomizesourcesmodaldata)                   | Returns all the info needed by the Customize Sources modal.
| [actionSaveCustomizeSourcesModalSettings()](craft-controllers-elementindexsettingscontroller.md#method-actionsavecustomizesourcesmodalsettings)         | Saves the Customize Sources modal settings.
...
| [beforeAction()](craft-controllers-elementindexsettingscontroller.md#method-beforeaction)                                                               | This method is invoked right before an action is executed.
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/ElementIndexSettingsController.php#L41-L82)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/ElementIndexSettingsController.php#L89-L124)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/ElementIndexSettingsController.php#L25-L34)
