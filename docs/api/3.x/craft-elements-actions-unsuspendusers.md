---
title: craft\elements\actions\UnsuspendUsers
code:
  - php
  - twig
---
...
:   [craft\elements\actions\UnsuspendUsers](craft-elements-actions-unsuspendusers.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/UnsuspendUsers.php)
...
| [triggerLabel](craft-elements-actions-unsuspendusers.md#triggerlabel)                                                            | [string](http://php.net/language.types.string) – The action’s trigger label
...
| [getTriggerLabel()](craft-elements-actions-unsuspendusers.md#method-gettriggerlabel)                                                            | Returns the action’s trigger label.
...
| [performAction()](craft-elements-actions-unsuspendusers.md#method-performaction)                                                                | Performs the action on any elements that match the given criteria.
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/UnsuspendUsers.php#L26-L29)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/UnsuspendUsers.php#L34-L49)
