---
title: craft\validators\TemplateValidator
code:
  - php
  - twig
---
...
:   [craft\validators\TemplateValidator](craft-validators-templatevalidator.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/TemplateValidator.php)
...
| [message](craft-validators-templatevalidator.md#message)                                                                                                         | [string](http://php.net/language.types.string) – User-defined error message used when the value is not a string.
...
| [templateMode](craft-validators-templatevalidator.md#templatemode)                                                                                               | [string](http://php.net/language.types.string) – The template mode to use when looking for the template
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/TemplateValidator.php#L30)
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/TemplateValidator.php#L25)
...
| [init()](craft-validators-templatevalidator.md#method-init)                                                                                                           | Initializes the object.
...
| [validateValue()](craft-validators-templatevalidator.md#method-validatevalue)                                                                                         | Validates a value.
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/TemplateValidator.php#L35-L42)
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/TemplateValidator.php#L47-L54)
