---
title: craft\web\assets\tests\TestsAsset
code:
  - php
  - twig
---
...
:   craft\web\assets\tests

Inherits

:   [craft\web\assets\tests\TestsAsset](craft-web-assets-tests-testsasset.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/tests/TestsAsset.php)
...
| [init()](craft-web-assets-tests-testsasset.md#method-init)                                                                                        | Initializes the bundle.
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/tests/TestsAsset.php#L22-L36)
