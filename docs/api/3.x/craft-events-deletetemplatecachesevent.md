---
title: craft\events\DeleteTemplateCachesEvent
code:
  - php
  - twig
---

# DeleteTemplateCachesEvent
...
:   [craft\events\DeleteTemplateCachesEvent](craft-events-deletetemplatecachesevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/DeleteTemplateCachesEvent.php)
...
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [cacheIds](craft-events-deletetemplatecachesevent.md#cacheids)                                                 | [integer](http://php.net/language.types.integer)[] – Array of template cache IDs that are associated with this event
...
Array of template cache IDs that are associated with this event



[View source](https://github.com/craftcms/cms/blob/master/src/events/DeleteTemplateCachesEvent.php#L23)
