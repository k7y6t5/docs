---
title: craft\web\assets\recententries\RecentEntriesAsset
code:
  - php
  - twig
---
...
:   craft\web\assets\recententries

Inherits

:   [craft\web\assets\recententries\RecentEntriesAsset](craft-web-assets-recententries-recententriesasset.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/recententries/RecentEntriesAsset.php)
...
| [init()](craft-web-assets-recententries-recententriesasset.md#method-init)                                                                | Initializes the bundle.
...
| [registerAssetFiles()](craft-web-assets-recententries-recententriesasset.md#method-registerassetfiles)                                    | Registers the CSS and JS files with the given view.
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/recententries/RecentEntriesAsset.php#L22-L35)
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/recententries/RecentEntriesAsset.php#L40-L49)
