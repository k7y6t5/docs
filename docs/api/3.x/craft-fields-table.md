...
| [getSettingsHtml()](craft-fields-table.md#method-getsettingshtml)                                                                               | Returns the component’s settings HTML.
...
[boolean](http://php.net/language.types.boolean) – Whether maxRows was set
