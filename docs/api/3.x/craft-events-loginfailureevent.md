---
title: craft\events\LoginFailureEvent
code:
  - php
  - twig
---
...
:   [craft\events\LoginFailureEvent](craft-events-loginfailureevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/LoginFailureEvent.php)
...
| -------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [authError](craft-events-loginfailureevent.md#autherror)                                                       | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The authentication error key, if the reason is known.
...
| [message](craft-events-loginfailureevent.md#message)                                                           | [string](http://php.net/language.types.string) – The error message that will be presented to the user.
...
| [user](craft-events-loginfailureevent.md#user)                                                                 | [craft\elements\User](craft-elements-user.md), [null](http://php.net/language.types.null) – The user that the login was attempted for, if there was a username/email match
...
The authentication error key, if the reason is known.

See also [craft\elements\User](craft-elements-user.md)

[View source](https://github.com/craftcms/cms/blob/master/src/events/LoginFailureEvent.php#L25)
...
The error message that will be presented to the user.



[View source](https://github.com/craftcms/cms/blob/master/src/events/LoginFailureEvent.php#L30)
...
The user that the login was attempted for, if there was a username/email match



[View source](https://github.com/craftcms/cms/blob/master/src/events/LoginFailureEvent.php#L35)
