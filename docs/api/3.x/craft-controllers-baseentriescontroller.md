---
title: craft\controllers\BaseEntriesController
code:
  - php
  - twig
---

# BaseEntriesController
...
:   [craft\controllers\EntriesController](craft-controllers-entriescontroller.md), [craft\controllers\EntryRevisionsController](craft-controllers-entryrevisionscontroller.md)
...
BaseEntriesController is a base class that any entry-related controllers, such as [craft\controllers\EntriesController](craft-controllers-entriescontroller.md) and
[craft\controllers\EntryRevisionsController](craft-controllers-entryrevisionscontroller.md), extend to share common functionality.

It extends [craft\web\Controller](craft-web-controller.md), overwriting specific methods as required.



[View source](https://github.com/craftcms/cms/blob/master/src/controllers/BaseEntriesController.php)
...
| Method                                                                                                         | Description
| -------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------
| [docTitle()](craft-controllers-baseentriescontroller.md#method-doctitle)                                       | Returns the document title that should be used on an Edit Entry page.
| [editableSiteIds()](craft-controllers-baseentriescontroller.md#method-editablesiteids)                         | Returns the editable site IDs for a section.
| [enabledForSiteValue()](craft-controllers-baseentriescontroller.md#method-enabledforsitevalue)                 | Returns the posted `enabledForSite` value, taking the user’s permissions into account.
| [enforceEditEntryPermissions()](craft-controllers-baseentriescontroller.md#method-enforceeditentrypermissions) | Enforces all Edit Entry permissions.
| [pageTitle()](craft-controllers-baseentriescontroller.md#method-pagetitle)                                     | Returns the page title that should be used on an Edit Entry page.
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/BaseEntriesController.php#L102-L115)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/BaseEntriesController.php#L35-L49)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/BaseEntriesController.php#L138-L149)



#### Returns

[boolean](http://php.net/language.types.boolean), [boolean](http://php.net/language.types.boolean)[], [null](http://php.net/language.types.null)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/BaseEntriesController.php#L57-L94)


#### Arguments

- `$entry` ([craft\elements\Entry](craft-elements-entry.md))
- `$duplicate` ([boolean](http://php.net/language.types.boolean))
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/BaseEntriesController.php#L123-L129)
