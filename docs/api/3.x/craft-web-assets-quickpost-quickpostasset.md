---
title: craft\web\assets\quickpost\QuickPostAsset
code:
  - php
  - twig
---
...
:   [craft\web\assets\quickpost\QuickPostAsset](craft-web-assets-quickpost-quickpostasset.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/quickpost/QuickPostAsset.php)
...
| [init()](craft-web-assets-quickpost-quickpostasset.md#method-init)                                                                        | Initializes the bundle.
...
| [registerAssetFiles()](craft-web-assets-quickpost-quickpostasset.md#method-registerassetfiles)                                            | Registers the CSS and JS files with the given view.
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/quickpost/QuickPostAsset.php#L22-L35)
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/quickpost/QuickPostAsset.php#L40-L50)
