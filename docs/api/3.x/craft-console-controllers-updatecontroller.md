---
title: craft\console\controllers\UpdateController
code:
  - php
  - twig
---
...
:   [craft\console\controllers\UpdateController](craft-console-controllers-updatecontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/UpdateController.php)
...
| [backup](craft-console-controllers-updatecontroller.md#backup)                                                                                       | [boolean](http://php.net/language.types.boolean) – Backup the database before updating
...
| [defaultAction](craft-console-controllers-updatecontroller.md#defaultaction)                                                                         | [string](http://php.net/language.types.string) – The ID of the action that is used when the action ID is not specified in the request.
| [force](craft-console-controllers-updatecontroller.md#force)                                                                                         | [boolean](http://php.net/language.types.boolean) – Force the update if allowUpdates is disabled
...
| [migrate](craft-console-controllers-updatecontroller.md#migrate)                                                                                     | [boolean](http://php.net/language.types.boolean) – Run new database migrations after completing the update
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/UpdateController.php#L45)
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/UpdateController.php#L35)
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/UpdateController.php#L40)
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/UpdateController.php#L50)
...
| [actionComposerInstall()](craft-console-controllers-updatecontroller.md#method-actioncomposerinstall)                                                         | Installs dependencies based on the current composer.json & composer.lock.
| [actionInfo()](craft-console-controllers-updatecontroller.md#method-actioninfo)                                                                               | Displays info about available updates.
| [actionUpdate()](craft-console-controllers-updatecontroller.md#method-actionupdate)                                                                           | Updates Craft and/or plugins.
...
| [optionAliases()](craft-console-controllers-updatecontroller.md#method-optionaliases)                                                                         | Returns option alias names.
| [options()](craft-console-controllers-updatecontroller.md#method-options)                                                                                     | Returns the names of valid options for the action (id) An option requires the existence of a public member variable whose name is the option name.
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/UpdateController.php#L183-L202)
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/UpdateController.php#L86-L125)
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/UpdateController.php#L136-L176)


#### Arguments

- `$handle` ([string](http://php.net/language.types.string)) – The update handle (`all`, `craft`, or a plugin handle). You can pass
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/UpdateController.php#L76-L81)
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/UpdateController.php#L60-L71)
