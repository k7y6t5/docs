---
title: craft\web\assets\vue\VueAsset
code:
  - php
  - twig
---
...
:   craft\web\assets\vue

Inherits

:   [craft\web\assets\vue\VueAsset](craft-web-assets-vue-vueasset.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/vue/VueAsset.php)
...
| [js](craft-web-assets-vue-vueasset.md#js)                                                                                              | [array](http://php.net/language.types.array) – List of JavaScript files that this bundle contains.
...
| [sourcePath](craft-web-assets-vue-vueasset.md#sourcepath)                                                                              | [string](http://php.net/language.types.string) – The directory that contains the source asset files for this asset bundle.
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/vue/VueAsset.php#L21-L23)
...
By setting this property, `\craft\web\assets\vue\AssetManager` will publish the source asset files
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/vue/VueAsset.php#L18)
