---
title: craft\web\assets\cp\CpAsset
code:
  - php
  - twig
---
...
:   [craft\web\assets\cp\CpAsset](craft-web-assets-cp-cpasset.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/cp/CpAsset.php)
...
| [init()](craft-web-assets-cp-cpasset.md#method-init)                                                                                      | Initializes the bundle.
...
| [registerAssetFiles()](craft-web-assets-cp-cpasset.md#method-registerassetfiles)                                                          | Registers the CSS and JS files with the given view.
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/cp/CpAsset.php#L47-L77)
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/cp/CpAsset.php#L82-L96)
