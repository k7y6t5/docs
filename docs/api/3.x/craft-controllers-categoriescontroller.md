---
title: craft\controllers\CategoriesController
code:
  - php
  - twig
---
...
:   [craft\controllers\CategoriesController](craft-controllers-categoriescontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/CategoriesController.php)
...
| [actionCategoryIndex()](craft-controllers-categoriescontroller.md#method-actioncategoryindex)                                                           | Displays the category index page.
| [actionDeleteCategory()](craft-controllers-categoriescontroller.md#method-actiondeletecategory)                                                         | Deletes a category.
| [actionDeleteCategoryGroup()](craft-controllers-categoriescontroller.md#method-actiondeletecategorygroup)                                               | Deletes a category group.
| [actionEditCategory()](craft-controllers-categoriescontroller.md#method-actioneditcategory)                                                             | Displays the category edit page.
| [actionEditCategoryGroup()](craft-controllers-categoriescontroller.md#method-actioneditcategorygroup)                                                   | Edit a category group.
| [actionGroupIndex()](craft-controllers-categoriescontroller.md#method-actiongroupindex)                                                                 | Category groups index.
| [actionPreviewCategory()](craft-controllers-categoriescontroller.md#method-actionpreviewcategory)                                                       | Previews a category.
| [actionSaveCategory()](craft-controllers-categoriescontroller.md#method-actionsavecategory)                                                             | Saves an category.
| [actionSaveGroup()](craft-controllers-categoriescontroller.md#method-actionsavegroup)                                                                   | Save a category group.
| [actionShareCategory()](craft-controllers-categoriescontroller.md#method-actionsharecategory)                                                           | Redirects the client to a URL for viewing a disabled category on the front end.
| [actionViewSharedCategory()](craft-controllers-categoriescontroller.md#method-actionviewsharedcategory)                                                 | Shows an category/draft/version based on a token.
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/CategoriesController.php#L215-L231)


#### Arguments

- `$groupHandle` ([string](http://php.net/language.types.string), [null](http://php.net/language.types.null)) – The category group’s handle.
...
- [yii\web\ForbiddenHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-forbiddenhttpexception)\
  if the user is not permitted to edit categories
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/CategoriesController.php#L534-L572)
...
- [yii\web\NotFoundHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-notfoundhttpexception)\
  if the requested category cannot be found
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/CategoriesController.php#L192-L203)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/CategoriesController.php#L243-L414)


#### Arguments

- `$groupHandle` ([string](http://php.net/language.types.string)) – The category group’s handle.
- `$categoryId` ([integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null)) – The category’s ID, if editing an existing category.
- `$siteHandle` ([string](http://php.net/language.types.string), [null](http://php.net/language.types.null)) – The site handle, if specified.
- `$category` ([craft\elements\Category](craft-elements-category.md), [null](http://php.net/language.types.null)) – The category being edited, if there were any validation errors.
...
- [yii\web\NotFoundHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-notfoundhttpexception)\
  if the requested site handle is invalid
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/CategoriesController.php#L71-L125)


#### Arguments

- `$groupId` ([integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null)) – The category group’s ID, if editing an existing group.
- `$categoryGroup` ([craft\models\CategoryGroup](craft-models-categorygroup.md), [null](http://php.net/language.types.null)) – The category group being edited, if there were any validation errors.
...
- [yii\web\NotFoundHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-notfoundhttpexception)\
  if the requested category group cannot be found
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/CategoriesController.php#L52-L61)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/CategoriesController.php#L421-L437)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/CategoriesController.php#L445-L526)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/CategoriesController.php#L132-L185)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/CategoriesController.php#L584-L616)
...
- [yii\web\NotFoundHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-notfoundhttpexception)\
  if the requested category cannot be found
- [yii\web\ServerErrorHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-servererrorhttpexception)\
  if the category group is not configured properly


### `actionViewSharedCategory()`
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/CategoriesController.php#L626-L637)
...
The event that is triggered when a category’s template is rendered for Live Preview.
