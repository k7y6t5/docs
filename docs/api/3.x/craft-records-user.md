...
:   [craft\records\User](craft-records-user.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/User.php)
...
| [element](craft-records-user.md#element)                                                                                                               | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
| [errors](https://www.yiiframework.com/doc/api/2.0/yii-base-model#$errors-detail "Defined by yii\base\Model")                                           | [array](http://php.net/language.types.array) – Errors for all attributes or the specified attribute.
| [firstErrors](https://www.yiiframework.com/doc/api/2.0/yii-base-model#$firstErrors-detail "Defined by yii\base\Model")                                 | [array](http://php.net/language.types.array) – The first errors.
| [groups](craft-records-user.md#groups)                                                                                                                 | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface)
...
| [sessions](craft-records-user.md#sessions)                                                                                                             | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [find()](craft-records-user.md#method-find)                                                                                                                     |
...
| [findTrashed()](craft-records-user.md#method-findtrashed)                                                                                                       |
| [findWithTrashed()](craft-records-user.md#method-findwithtrashed)                                                                                               |
...
| [getElement()](craft-records-user.md#method-getelement)                                                                                                         | Returns the user’s element.
...
| [getGroups()](craft-records-user.md#method-getgroups)                                                                                                           | Returns the user’s groups.
...
| [getSessions()](craft-records-user.md#method-getsessions)                                                                                                       | Returns the user’s sessions.
...
| [tableName()](craft-records-user.md#method-tablename)                                                                                                           | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/User.php#L62-L74)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/User.php#L87-L90)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/User.php#L79-L82)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/User.php#L97-L100)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/User.php#L117-L121)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/User.php#L107-L110)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/User.php#L54-L57)
