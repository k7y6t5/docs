---
title: craft\records\StructureElement
code:
  - php
  - twig
---
...
:   [craft\records\StructureElement](craft-records-structureelement.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/StructureElement.php)
...
| [element](craft-records-structureelement.md#element)                                                                                                   | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [structure](craft-records-structureelement.md#structure)                                                                                               | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [behaviors()](craft-records-structureelement.md#method-behaviors)                                                                                               | Returns a list of behaviors that this component should behave as.
...
| [find()](craft-records-structureelement.md#method-find)                                                                                                         | Creates an [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) instance for query purpose.
...
| [getElement()](craft-records-structureelement.md#method-getelement)                                                                                             | Returns the structure element’s element.
...
| [getStructure()](craft-records-structureelement.md#method-getstructure)                                                                                         | Returns the structure element’s structure.
...
| [rules()](craft-records-structureelement.md#method-rules)                                                                                                       | Returns the validation rules for attributes.
...
| [tableName()](craft-records-structureelement.md#method-tablename)                                                                                               | Declares the name of the database table associated with this AR class.
| [toArray()](https://www.yiiframework.com/doc/api/2.0/yii-base-arrayabletrait#toArray()-detail "Defined by yii\base\ArrayableTrait")                             | Converts the model into an array.
| [transactions()](craft-records-structureelement.md#method-transactions)                                                                                         | Declares which DB operations should be performed within a transaction in different scenarios.
...
Note that a behavior class must extend from `\craft\records\Behavior`. Behaviors can be attached using a name or anonymously.
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/StructureElement.php#L92-L103)
...
Creates an [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) instance for query purpose.



The returned [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) instance can be further customized by calling
methods defined in [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) before `one()` or `all()` is called to return
...
This method is also called by [yii\db\BaseActiveRecord::hasOne()](https://www.yiiframework.com/doc/api/2.0/yii-db-baseactiverecord#hasOne()-detail) and [yii\db\BaseActiveRecord::hasMany()](https://www.yiiframework.com/doc/api/2.0/yii-db-baseactiverecord#hasMany()-detail) to
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/StructureElement.php#L60-L66)



#### Returns

[craft\db\StructuredElementQuery](craft-db-structuredelementquery.md) – The newly created [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) instance.
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/StructureElement.php#L83-L86)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/StructureElement.php#L73-L76)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/StructureElement.php#L38-L45)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/StructureElement.php#L51-L54)
...
The supported DB operations are: [OP_INSERT](https://www.yiiframework.com/doc/api/2.0/yii-db-activerecord#OP_INSERT-detail), [OP_UPDATE](https://www.yiiframework.com/doc/api/2.0/yii-db-activerecord#OP_UPDATE-detail) and [OP_DELETE](https://www.yiiframework.com/doc/api/2.0/yii-db-activerecord#OP_DELETE-detail),
which correspond to the [insert()](https://www.yiiframework.com/doc/api/2.0/yii-db-activerecordinterface#insert()-detail), [update()](https://www.yiiframework.com/doc/api/2.0/yii-db-activerecordinterface#update()-detail) and [delete()](https://www.yiiframework.com/doc/api/2.0/yii-db-activerecordinterface#delete()-detail) methods, respectively.
...
The above declaration specifies that in the "admin" scenario, the insert operation ([insert()](https://www.yiiframework.com/doc/api/2.0/yii-db-activerecordinterface#insert()-detail))
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/StructureElement.php#L108-L113)



#### Returns

[array](http://php.net/language.types.array) – The declarations of transactional operations. The array keys are scenarios names,
