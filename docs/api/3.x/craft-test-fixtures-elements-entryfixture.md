---
title: craft\test\fixtures\elements\EntryFixture
code:
  - php
  - twig
---
...
:   [craft\test\fixtures\elements\EntryFixture](craft-test-fixtures-elements-entryfixture.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/test/fixtures/elements/EntryFixture.php)
...
| [element](craft-test-fixtures-elements-entryfixture.md#element)                                                                                  | [craft\elements\Entry](craft-elements-entry.md), [null](http://php.net/language.types.null)
...
| [modelClass](craft-test-fixtures-elements-entryfixture.md#modelclass)                                                                            | [string](http://php.net/language.types.string) – The AR model class associated with this fixture.
| [sectionIds](craft-test-fixtures-elements-entryfixture.md#sectionids)                                                                            | [array](http://php.net/language.types.array)
...
| [typeIds](craft-test-fixtures-elements-entryfixture.md#typeids)                                                                                  | [array](http://php.net/language.types.array)
...
[View source](https://github.com/craftcms/cms/blob/master/src/test/fixtures/elements/EntryFixture.php#L28)
...
[View source](https://github.com/craftcms/cms/blob/master/src/test/fixtures/elements/EntryFixture.php#L33)
...
[View source](https://github.com/craftcms/cms/blob/master/src/test/fixtures/elements/EntryFixture.php#L38)
...
| [getElement()](craft-test-fixtures-elements-entryfixture.md#method-getelement)                                                                                |
...
| [init()](craft-test-fixtures-elements-entryfixture.md#method-init)                                                                                            | Initializes the object.
...
[View source](https://github.com/craftcms/cms/blob/master/src/test/fixtures/elements/EntryFixture.php#L61-L87)


#### Arguments

- `$data` ([array](http://php.net/language.types.array), [null](http://php.net/language.types.null))
...
[View source](https://github.com/craftcms/cms/blob/master/src/test/fixtures/elements/EntryFixture.php#L43-L55)
...
| [isPrimaryKey()](craft-test-fixtures-elements-entryfixture.md#method-isprimarykey)                                                        | See if an element's handle is a primary key.
...
[View source](https://github.com/craftcms/cms/blob/master/src/test/fixtures/elements/EntryFixture.php#L91-L94)
