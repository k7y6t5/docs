---
title: craft\events\DeleteSiteEvent
code:
  - php
  - twig
---
...
:   [craft\events\DeleteSiteEvent](craft-events-deletesiteevent.md) &raquo;
[craft\events\SiteEvent](craft-events-siteevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/DeleteSiteEvent.php)
...
| [isNew](craft-events-siteevent.md#isnew "Defined by craft\events\SiteEvent")                                   | [boolean](http://php.net/language.types.boolean) – Whether the site is brand new
...
| [oldPrimarySiteId](craft-events-siteevent.md#oldprimarysiteid "Defined by craft\events\SiteEvent")             | [integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null) – The old primary site ID
...
| [site](craft-events-siteevent.md#site "Defined by craft\events\SiteEvent")                                     | [craft\models\Site](craft-models-site.md), [null](http://php.net/language.types.null) – The site model associated with the event.
| [transferContentTo](craft-events-deletesiteevent.md#transfercontentto)                                         | [integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null) – The site ID that should take over the deleted site’s contents
...
The site ID that should take over the deleted site’s contents



[View source](https://github.com/craftcms/cms/blob/master/src/events/DeleteSiteEvent.php#L21)
