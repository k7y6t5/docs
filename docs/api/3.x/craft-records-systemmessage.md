---
title: craft\records\SystemMessage
code:
  - php
  - twig
---
...
:   [craft\records\SystemMessage](craft-records-systemmessage.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/SystemMessage.php)
...
| [rules()](craft-records-systemmessage.md#method-rules)                                                                                                          | Returns the validation rules for attributes.
...
| [tableName()](craft-records-systemmessage.md#method-tablename)                                                                                                  | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/SystemMessage.php#L30-L39)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/SystemMessage.php#L45-L48)
