---
title: craft\events\ReplaceAssetEvent
code:
  - php
  - twig
---
...
:   [craft\events\ReplaceAssetEvent](craft-events-replaceassetevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/ReplaceAssetEvent.php)
...
| [filename](craft-events-replaceassetevent.md#filename)                                                         | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The file name that will be used
...
| [replaceWith](craft-events-replaceassetevent.md#replacewith)                                                   | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – File on server that is being used to replace
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/ReplaceAssetEvent.php#L26)
...
File on server that is being used to replace



[View source](https://github.com/craftcms/cms/blob/master/src/events/ReplaceAssetEvent.php#L21)
