---
title: craft\test\fixtures\elements\CategoryFixture
code:
  - php
  - twig
---
...
:   [craft\test\fixtures\elements\CategoryFixture](craft-test-fixtures-elements-categoryfixture.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/test/fixtures/elements/CategoryFixture.php)
...
| [modelClass](craft-test-fixtures-elements-categoryfixture.md#modelclass)                                                                         | [string](http://php.net/language.types.string) – The AR model class associated with this fixture.
...
[View source](https://github.com/craftcms/cms/blob/master/src/test/fixtures/elements/CategoryFixture.php#L28)
...
| Property                                                                                                                   | Description
| -------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------
| [groupIds](craft-test-fixtures-elements-categoryfixture.md#groupids)                                                       | [array](http://php.net/language.types.array)
...
[View source](https://github.com/craftcms/cms/blob/master/src/test/fixtures/elements/CategoryFixture.php#L33)
...
| [init()](craft-test-fixtures-elements-categoryfixture.md#method-init)                                                                                         | Initializes the object.
...
[View source](https://github.com/craftcms/cms/blob/master/src/test/fixtures/elements/CategoryFixture.php#L38-L45)
...
| [isPrimaryKey()](craft-test-fixtures-elements-categoryfixture.md#method-isprimarykey)                                                     | See if an element's handle is a primary key.
...
[View source](https://github.com/craftcms/cms/blob/master/src/test/fixtures/elements/CategoryFixture.php#L50-L53)
