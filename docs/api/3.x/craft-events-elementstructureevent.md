---
title: craft\events\ElementStructureEvent
code:
  - php
  - twig
---
...
:   [craft\events\ElementStructureEvent](craft-events-elementstructureevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/ElementStructureEvent.php)
...
| [structureId](craft-events-elementstructureevent.md#structureid)                                                         | [integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null) – The structure ID
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/ElementStructureEvent.php#L21)
