---
title: craft\records\UserPermission
code:
  - php
  - twig
---
...
:   [craft\records\UserPermission](craft-records-userpermission.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/UserPermission.php)
...
| [rules()](craft-records-userpermission.md#method-rules)                                                                                                         | Returns the validation rules for attributes.
...
| [tableName()](craft-records-userpermission.md#method-tablename)                                                                                                 | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/UserPermission.php#L26-L33)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/UserPermission.php#L39-L42)
