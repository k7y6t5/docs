---
title: craft\events\CancelableEvent
code:
  - php
  - twig
---
...
:   [craft\events\AssetEvent](craft-events-assetevent.md), [craft\events\AssetTransformImageEvent](craft-events-assettransformimageevent.md), [craft\events\DeleteSiteEvent](craft-events-deletesiteevent.md), [craft\events\ElementActionEvent](craft-events-elementactionevent.md), [craft\events\GenerateTransformEvent](craft-events-generatetransformevent.md), [craft\events\ReplaceAssetEvent](craft-events-replaceassetevent.md), [craft\events\SiteEvent](craft-events-siteevent.md), [craft\events\TemplateEvent](craft-events-templateevent.md), [craft\events\UserAssignGroupEvent](craft-events-userassigngroupevent.md), [craft\events\UserEvent](craft-events-userevent.md), [craft\events\UserGroupsAssignEvent](craft-events-usergroupsassignevent.md)
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/CancelableEvent.php)
...
| [isValid](craft-events-cancelableevent.md#isvalid)                                                             | [boolean](http://php.net/language.types.boolean) – Whether to continue performing the action that called this event
...
Whether to continue performing the action that called this event



[View source](https://github.com/craftcms/cms/blob/master/src/events/CancelableEvent.php#L23)
