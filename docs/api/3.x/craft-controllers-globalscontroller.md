---
title: craft\controllers\GlobalsController
code:
  - php
  - twig
---
...
:   [craft\controllers\GlobalsController](craft-controllers-globalscontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/GlobalsController.php)
...
| [actionDeleteSet()](craft-controllers-globalscontroller.md#method-actiondeleteset)                                                                      | Deletes a global set.
| [actionEditContent()](craft-controllers-globalscontroller.md#method-actioneditcontent)                                                                  | Edits a global set's content.
| [actionIndex()](craft-controllers-globalscontroller.md#method-actionindex)                                                                              | Index
| [actionSaveContent()](craft-controllers-globalscontroller.md#method-actionsavecontent)                                                                  | Saves a global set's content.
| [actionSaveSet()](craft-controllers-globalscontroller.md#method-actionsaveset)                                                                          | Saves a global set.
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/GlobalsController.php#L100-L111)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/GlobalsController.php#L123-L217)


#### Arguments

- `$globalSetHandle` ([string](http://php.net/language.types.string)) – The global set’s handle.
- `$siteHandle` ([string](http://php.net/language.types.string), [null](http://php.net/language.types.null)) – The site handle, if specified.
- `$globalSet` ([craft\elements\GlobalSet](craft-elements-globalset.md), [null](http://php.net/language.types.null)) – The global set being edited, if there were any validation errors.
...
- [yii\web\ForbiddenHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-forbiddenhttpexception)\
  if the user is not permitted to edit the global set
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/GlobalsController.php#L35-L44)
...
- [yii\web\ForbiddenHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-forbiddenhttpexception)\
  if the user isn't authorized to edit any global sets
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/GlobalsController.php#L225-L267)
...
- [yii\web\NotFoundHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-notfoundhttpexception)\
  if the requested global set cannot be found
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/GlobalsController.php#L52-L93)
