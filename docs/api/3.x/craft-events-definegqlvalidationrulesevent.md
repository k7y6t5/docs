---
title: craft\events\DefineGqlValidationRulesEvent
code:
  - php
  - twig
---

# DefineGqlValidationRulesEvent
...
:   [craft\events\DefineGqlValidationRulesEvent](craft-events-definegqlvalidationrulesevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/DefineGqlValidationRulesEvent.php)
...
| [debug](craft-events-definegqlvalidationrulesevent.md#debug)                                                   | [array](http://php.net/language.types.array) – Whether debug rules should be allowed
...
| [validationRules](craft-events-definegqlvalidationrulesevent.md#validationrules)                               | [array](http://php.net/language.types.array) – List of GraphQL validation rules to use.
...
Whether debug rules should be allowed



[View source](https://github.com/craftcms/cms/blob/master/src/events/DefineGqlValidationRulesEvent.php#L28)
...
List of GraphQL validation rules to use.



[View source](https://github.com/craftcms/cms/blob/master/src/events/DefineGqlValidationRulesEvent.php#L23)
