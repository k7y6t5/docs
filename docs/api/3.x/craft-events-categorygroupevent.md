---
title: craft\events\CategoryGroupEvent
code:
  - php
  - twig
---
...
:   [craft\events\CategoryGroupEvent](craft-events-categorygroupevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/CategoryGroupEvent.php)
...
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [categoryGroup](craft-events-categorygroupevent.md#categorygroup)                                              | [craft\models\CategoryGroup](craft-models-categorygroup.md), [null](http://php.net/language.types.null) – The category group model associated with the event.
...
| [isNew](craft-events-categorygroupevent.md#isnew)                                                              | [boolean](http://php.net/language.types.boolean) – Whether the category group is brand new
...
The category group model associated with the event.



[View source](https://github.com/craftcms/cms/blob/master/src/events/CategoryGroupEvent.php#L24)
...
Whether the category group is brand new



[View source](https://github.com/craftcms/cms/blob/master/src/events/CategoryGroupEvent.php#L29)
