---
title: craft\events\RegisterCpSettingsEvent
code:
  - php
  - twig
---
...
:   [craft\events\RegisterCpSettingsEvent](craft-events-registercpsettingsevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterCpSettingsEvent.php)
...
| [settings](craft-events-registercpsettingsevent.md#settings)                                                   | [array](http://php.net/language.types.array) – The registered control panel settings
...
The registered control panel settings



[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterCpSettingsEvent.php#L23)
