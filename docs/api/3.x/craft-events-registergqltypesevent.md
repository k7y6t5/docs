---
title: craft\events\RegisterGqlTypesEvent
code:
  - php
  - twig
---
...
:   [craft\events\RegisterGqlTypesEvent](craft-events-registergqltypesevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterGqlTypesEvent.php)
...
| [types](craft-events-registergqltypesevent.md#types)                                                           | [array](http://php.net/language.types.array) – List of GraphQL Type definition classes
...
List of GraphQL Type definition classes



[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterGqlTypesEvent.php#L23)
