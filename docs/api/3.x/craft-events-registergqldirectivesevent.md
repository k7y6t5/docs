---
title: craft\events\RegisterGqlDirectivesEvent
code:
  - php
  - twig
---

# RegisterGqlDirectivesEvent
...
:   [craft\events\RegisterGqlDirectivesEvent](craft-events-registergqldirectivesevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterGqlDirectivesEvent.php)
...
| [directives](craft-events-registergqldirectivesevent.md#directives)                                            | [array](http://php.net/language.types.array) – List of GraphQL Directive classes
...
List of GraphQL Directive classes



[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterGqlDirectivesEvent.php#L23)
