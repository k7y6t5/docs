---
title: craft\events\RegisterElementSortOptionsEvent
code:
  - php
  - twig
---

# RegisterElementSortOptionsEvent
...
:   [craft\events\RegisterElementSortOptionsEvent](craft-events-registerelementsortoptionsevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterElementSortOptionsEvent.php)
...
| [sortOptions](craft-events-registerelementsortoptionsevent.md#sortoptions)                                     | [array](http://php.net/language.types.array) – List of registered sort options for the element type.
...
List of registered sort options for the element type.



[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterElementSortOptionsEvent.php#L23)
