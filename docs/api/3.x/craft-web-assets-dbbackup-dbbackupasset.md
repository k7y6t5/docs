---
title: craft\web\assets\dbbackup\DbBackupAsset
code:
  - php
  - twig
---
...
:   craft\web\assets\dbbackup

Inherits

:   [craft\web\assets\dbbackup\DbBackupAsset](craft-web-assets-dbbackup-dbbackupasset.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/dbbackup/DbBackupAsset.php)
...
| [init()](craft-web-assets-dbbackup-dbbackupasset.md#method-init)                                                                                  | Initializes the bundle.
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/dbbackup/DbBackupAsset.php#L21-L34)
