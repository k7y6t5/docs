---
title: craft\elements\actions\EditImage
code:
  - php
  - twig
---
...
:   [craft\elements\actions\EditImage](craft-elements-actions-editimage.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/EditImage.php)
...
| [label](craft-elements-actions-editimage.md#label)                                                                               | [string](http://php.net/language.types.string) – The trigger label
...
| [triggerHtml](craft-elements-actions-editimage.md#triggerhtml)                                                                   | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The action’s trigger HTML.
| [triggerLabel](craft-elements-actions-editimage.md#triggerlabel)                                                                 | [string](http://php.net/language.types.string) – The action’s trigger label
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/EditImage.php#L25)
...
| [getTriggerHtml()](craft-elements-actions-editimage.md#method-gettriggerhtml)                                                                   | Returns the action’s trigger HTML.
| [getTriggerLabel()](craft-elements-actions-editimage.md#method-gettriggerlabel)                                                                 | Returns the action’s trigger label.
...
| [init()](craft-elements-actions-editimage.md#method-init)                                                                                       | Initializes the object.
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/EditImage.php#L48-L82)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/EditImage.php#L40-L43)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/EditImage.php#L30-L35)
