---
title: craft\events\AssetPreviewEvent
code:
  - php
  - twig
---
...
:   [craft\events\AssetPreviewEvent](craft-events-assetpreviewevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/AssetPreviewEvent.php)
...
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [asset](craft-events-assetpreviewevent.md#asset)                                                               | [craft\elements\Asset](craft-elements-asset.md) – The asset Element associated with the event.
...
| [previewHandler](craft-events-assetpreviewevent.md#previewhandler)                                             | [craft\base\AssetPreviewHandlerInterface](craft-base-assetpreviewhandlerinterface.md)
...
The asset Element associated with the event.



[View source](https://github.com/craftcms/cms/blob/master/src/events/AssetPreviewEvent.php#L26)
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/AssetPreviewEvent.php#L33)
