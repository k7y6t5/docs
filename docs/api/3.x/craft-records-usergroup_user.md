---
title: craft\records\UserGroup_User
code:
  - php
  - twig
---
...
:   [craft\records\UserGroup_User](craft-records-usergroup_user.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/UserGroup_User.php)
...
| [group](craft-records-usergroup_user.md#group)                                                                                                         | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [user](craft-records-usergroup_user.md#user)                                                                                                           | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [getGroup()](craft-records-usergroup_user.md#method-getgroup)                                                                                                   | Returns the user group user’s group.
...
| [getUser()](craft-records-usergroup_user.md#method-getuser)                                                                                                     | Returns the user group user’s user.
...
| [rules()](craft-records-usergroup_user.md#method-rules)                                                                                                         | Returns the validation rules for attributes.
...
| [tableName()](craft-records-usergroup_user.md#method-tablename)                                                                                                 | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/UserGroup_User.php#L51-L54)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/UserGroup_User.php#L61-L64)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/UserGroup_User.php#L30-L35)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/UserGroup_User.php#L41-L44)
