---
title: craft\controllers\PreviewController
code:
  - php
  - twig
---
...
:   [craft\controllers\PreviewController](craft-controllers-previewcontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/PreviewController.php)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/PreviewController.php#L29-L31)
...
| [actionCreateToken()](craft-controllers-previewcontroller.md#method-actioncreatetoken)                                                                  | Creates a token for previewing/sharing an element.
| [actionPreview()](craft-controllers-previewcontroller.md#method-actionpreview)                                                                          | Substitutes an element for the element being previewed for the remainder of the request, and reroutes the request.
...
| [beforeAction()](craft-controllers-previewcontroller.md#method-beforeaction)                                                                            | This method is invoked right before an action is executed.
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/PreviewController.php#L54-L89)
...
- [yii\web\ServerErrorHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-servererrorhttpexception)\
  if the token couldn't be created
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/PreviewController.php#L103-L141)


#### Arguments

- `$elementType` ([string](http://php.net/language.types.string))
- `$sourceId` ([integer](http://php.net/language.types.integer))
- `$siteId` ([integer](http://php.net/language.types.integer))
- `$draftId` ([integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null))
- `$revisionId` ([integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null))
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/PreviewController.php#L36-L44)
