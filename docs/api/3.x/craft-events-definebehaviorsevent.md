---
title: craft\events\DefineBehaviorsEvent
code:
  - php
  - twig
---

# DefineBehaviorsEvent
...
:   [craft\events\DefineBehaviorsEvent](craft-events-definebehaviorsevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/DefineBehaviorsEvent.php)
...
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [behaviors](craft-events-definebehaviorsevent.md#behaviors)                                                    | [array](http://php.net/language.types.array) – The component definitions
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/DefineBehaviorsEvent.php#L23)
