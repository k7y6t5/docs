---
title: craft\events\ReorderSitesEvent
code:
  - php
  - twig
---
...
:   [craft\events\ReorderSitesEvent](craft-events-reordersitesevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/ReorderSitesEvent.php)
...
| [siteIds](craft-events-reordersitesevent.md#siteids)                                                           | [integer](http://php.net/language.types.integer)[], [null](http://php.net/language.types.null) – The site IDs in their new order
...
The site IDs in their new order



[View source](https://github.com/craftcms/cms/blob/master/src/events/ReorderSitesEvent.php#L23)
