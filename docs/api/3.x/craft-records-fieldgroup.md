---
title: craft\records\FieldGroup
code:
  - php
  - twig
---
...
:   [craft\records\FieldGroup](craft-records-fieldgroup.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/FieldGroup.php)
...
| [fields](craft-records-fieldgroup.md#fields)                                                                                                           | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [getFields()](craft-records-fieldgroup.md#method-getfields)                                                                                                     | Returns the field group’s fields.
...
| [tableName()](craft-records-fieldgroup.md#method-tablename)                                                                                                     | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/FieldGroup.php#L39-L42)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/FieldGroup.php#L29-L32)
