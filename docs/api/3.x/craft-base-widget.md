...
| [iconPath()](craft-base-widget.md#method-iconpath)                                                                                              | Returns the path to the widget’s SVG icon.
...
[View source](https://github.com/craftcms/cms/blob/master/src/base/Widget.php#L25-L28)
