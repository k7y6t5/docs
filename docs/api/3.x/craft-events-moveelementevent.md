---
title: craft\events\MoveElementEvent
code:
  - php
  - twig
---
...
:   [craft\events\MoveElementEvent](craft-events-moveelementevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/MoveElementEvent.php)
...
| [structureId](craft-events-moveelementevent.md#structureid)                                                    | [integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null) – The ID of the structure the element is being moved within.
...
The ID of the structure the element is being moved within.



[View source](https://github.com/craftcms/cms/blob/master/src/events/MoveElementEvent.php#L21)
