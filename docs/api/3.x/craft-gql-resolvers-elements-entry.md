---
title: craft\gql\resolvers\elements\Entry
code:
  - php
  - twig
---
...
:   [craft\gql\resolvers\elements\Entry](craft-gql-resolvers-elements-entry.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/gql/resolvers/elements/Entry.php)
...
| [prepareQuery()](craft-gql-resolvers-elements-entry.md#method-preparequery)                                             | Prepare an element Query based on the source, arguments and the field name on the source.
...
[View source](https://github.com/craftcms/cms/blob/master/src/gql/resolvers/elements/Entry.php#L27-L56)
