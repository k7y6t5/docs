---
title: craft\events\RegisterElementActionsEvent
code:
  - php
  - twig
---

# RegisterElementActionsEvent
...
:   [craft\events\RegisterElementActionsEvent](craft-events-registerelementactionsevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterElementActionsEvent.php)
...
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [actions](craft-events-registerelementactionsevent.md#actions)                                                 | [array](http://php.net/language.types.array) – List of registered actions for the element type.
...
| [source](craft-events-registerelementactionsevent.md#source)                                                   | [string](http://php.net/language.types.string) – The selected source’s key
...
List of registered actions for the element type.



[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterElementActionsEvent.php#L28)
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterElementActionsEvent.php#L23)
