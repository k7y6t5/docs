---
title: craft\gql\queries\GlobalSet
code:
  - php
  - twig
---
...
:   [craft\gql\queries\GlobalSet](craft-gql-queries-globalset.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/gql/queries/GlobalSet.php)
...
| [getQueries()](craft-gql-queries-globalset.md#method-getqueries)                                                            | Returns the queries defined by the class as an array.
...
[View source](https://github.com/craftcms/cms/blob/master/src/gql/queries/GlobalSet.php#L28-L48)
