---
title: craft\events\ElementContentEvent
code:
  - php
  - twig
---
...
:   [craft\events\ElementContentEvent](craft-events-elementcontentevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/ElementContentEvent.php)
...
| [element](craft-events-elementcontentevent.md#element)                                                         | [craft\base\ElementInterface](craft-base-elementinterface.md), [null](http://php.net/language.types.null) – The element model associated with the event.
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/ElementContentEvent.php#L24)
