---
title: craft\events\UserGroupsAssignEvent
code:
  - php
  - twig
---

# UserGroupsAssignEvent
...
:   [craft\events\UserGroupsAssignEvent](craft-events-usergroupsassignevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/UserGroupsAssignEvent.php)
...
| [groupIds](craft-events-usergroupsassignevent.md#groupids)                                                     | [integer](http://php.net/language.types.integer)[] – The user group IDs being assigned to the user
...
| [userId](craft-events-usergroupsassignevent.md#userid)                                                         | [integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null) – The user ID associated with this event
...
The user group IDs being assigned to the user



[View source](https://github.com/craftcms/cms/blob/master/src/events/UserGroupsAssignEvent.php#L26)
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/UserGroupsAssignEvent.php#L21)
