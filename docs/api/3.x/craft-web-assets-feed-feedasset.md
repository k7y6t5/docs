---
title: craft\web\assets\feed\FeedAsset
code:
  - php
  - twig
---
...
:   craft\web\assets\feed

Inherits

:   [craft\web\assets\feed\FeedAsset](craft-web-assets-feed-feedasset.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/feed/FeedAsset.php)
...
| [init()](craft-web-assets-feed-feedasset.md#method-init)                                                                                          | Initializes the bundle.
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/feed/FeedAsset.php#L21-L34)
