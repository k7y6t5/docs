---
title: craft\web\assets\edituser\EditUserAsset
code:
  - php
  - twig
---
...
:   craft\web\assets\edituser

Inherits

:   [craft\web\assets\edituser\EditUserAsset](craft-web-assets-edituser-edituserasset.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/edituser/EditUserAsset.php)
...
| [init()](craft-web-assets-edituser-edituserasset.md#method-init)                                                                          | Initializes the bundle.
...
| [registerAssetFiles()](craft-web-assets-edituser-edituserasset.md#method-registerassetfiles)                                              | Registers the CSS and JS files with the given view.
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/edituser/EditUserAsset.php#L22-L41)
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/edituser/EditUserAsset.php#L46-L56)
