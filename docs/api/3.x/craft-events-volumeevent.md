---
title: craft\events\VolumeEvent
code:
  - php
  - twig
---
...
:   [craft\events\VolumeEvent](craft-events-volumeevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/VolumeEvent.php)
...
| [isNew](craft-events-volumeevent.md#isnew)                                                                     | [boolean](http://php.net/language.types.boolean) – Whether the volume is brand new
...
| [volume](craft-events-volumeevent.md#volume)                                                                   | [craft\base\VolumeInterface](craft-base-volumeinterface.md), [null](http://php.net/language.types.null) – The volume associated with the event.
...
Whether the volume is brand new



[View source](https://github.com/craftcms/cms/blob/master/src/events/VolumeEvent.php#L29)
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/VolumeEvent.php#L24)
