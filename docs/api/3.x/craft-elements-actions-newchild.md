---
title: craft\elements\actions\NewChild
code:
  - php
  - twig
---
...
:   [craft\elements\actions\NewChild](craft-elements-actions-newchild.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/NewChild.php)
...
| [label](craft-elements-actions-newchild.md#label)                                                                                | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The trigger label
| [maxLevels](craft-elements-actions-newchild.md#maxlevels)                                                                        | [integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null) – The maximum number of levels that the structure is allowed to have
...
| [newChildUrl](craft-elements-actions-newchild.md#newchildurl)                                                                    | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The URL that the user should be taken to after clicking on this element action
...
| [triggerHtml](craft-elements-actions-newchild.md#triggerhtml)                                                                    | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The action’s trigger HTML.
| [triggerLabel](craft-elements-actions-newchild.md#triggerlabel)                                                                  | [string](http://php.net/language.types.string) – The action’s trigger label
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/NewChild.php#L25)
...
The maximum number of levels that the structure is allowed to have



[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/NewChild.php#L30)
...
The URL that the user should be taken to after clicking on this element action



[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/NewChild.php#L35)
...
| [getConfirmationMessage()](craft-base-elementaction.md#method-getconfirmationmessage "Defined by craft\base\ElementAction")                     | Returns a confirmation message that should be displayed before the action is performed.
...
| [getTriggerHtml()](craft-elements-actions-newchild.md#method-gettriggerhtml)                                                                    | Returns the action’s trigger HTML.
| [getTriggerLabel()](craft-elements-actions-newchild.md#method-gettriggerlabel)                                                                  | Returns the action’s trigger label.
...
| [init()](craft-elements-actions-newchild.md#method-init)                                                                                        | Initializes the object.
...
| [performAction()](craft-base-elementaction.md#method-performaction "Defined by craft\base\ElementAction")                                       | Performs the action on any elements that match the given criteria.
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/NewChild.php#L58-L88)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/NewChild.php#L50-L53)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/NewChild.php#L40-L45)
