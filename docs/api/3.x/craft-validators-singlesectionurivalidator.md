---
title: craft\validators\SingleSectionUriValidator
code:
  - php
  - twig
---

# SingleSectionUriValidator
...
:   [craft\validators\SingleSectionUriValidator](craft-validators-singlesectionurivalidator.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/SingleSectionUriValidator.php)
...
| [disallowTriggers](craft-validators-uriformatvalidator.md#disallowtriggers "Defined by craft\validators\UriFormatValidator")                                     | [boolean](http://php.net/language.types.boolean) – Whether to ensure that the URI format doesn’t begin with the actionTrigger or cpTrigger.
...
| [requireSlug](craft-validators-uriformatvalidator.md#requireslug "Defined by craft\validators\UriFormatValidator")                                               | [boolean](http://php.net/language.types.boolean) – Whether we should ensure that "{slug}" is used within the URI format.
...
| [validateAttribute()](craft-validators-singlesectionurivalidator.md#method-validateattribute)                                                                         | Validates a single attribute.
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/SingleSectionUriValidator.php#L27-L87)
