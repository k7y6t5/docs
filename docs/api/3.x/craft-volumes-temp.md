...
:   [craft\volumes\Temp](craft-volumes-temp.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/volumes/Temp.php)
...
| [hasUrls](craft-volumes-temp.md#hasurls)                                                                                         | [boolean](http://php.net/language.types.boolean), [null](http://php.net/language.types.null) – Whether the volume has a public URL
...
| [path](craft-volumes-local.md#path "Defined by craft\volumes\Local")                                                             | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – Path to the root of this sources local folder.
| [rootPath](craft-volumes-local.md#rootpath "Defined by craft\volumes\Local")                                                     | [string](http://php.net/language.types.string) – The root path for the volume
...
| [settingsHtml](craft-volumes-temp.md#settingshtml)                                                                               | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null)
...
[View source](https://github.com/craftcms/cms/blob/master/src/volumes/Temp.php#L23)
...
| [afterSave()](craft-volumes-local.md#method-aftersave "Defined by craft\volumes\Local")                                                         | Performs actions after a component is saved.
...
| [displayName()](craft-volumes-temp.md#method-displayname)                                                                                       | Returns the display name of this class.
...
| [getRootPath()](craft-volumes-local.md#method-getrootpath "Defined by craft\volumes\Local")                                                     | Returns the root path for the volume.
...
| [getSettingsHtml()](craft-volumes-temp.md#method-getsettingshtml)                                                                               | Returns the component’s settings HTML.
...
| [init()](craft-volumes-temp.md#method-init)                                                                                                     | Initializes the object.
...
| [renameDir()](craft-volumes-local.md#method-renamedir "Defined by craft\volumes\Local")                                                         | Renames a directory.
...
[View source](https://github.com/craftcms/cms/blob/master/src/volumes/Temp.php#L28-L31)
...
[View source](https://github.com/craftcms/cms/blob/master/src/volumes/Temp.php#L54-L57)
...
[View source](https://github.com/craftcms/cms/blob/master/src/volumes/Temp.php#L36-L49)
...
| [createAdapter()](craft-volumes-local.md#method-createadapter "Defined by craft\volumes\Local")                                                         | Creates and returns a Flysystem adapter instance based on the stored settings.
| [defineRules()](craft-volumes-local.md#method-definerules "Defined by craft\volumes\Local")                                                             | Returns the validation rules for attributes.
