---
title: craft\events\RegisterElementSearchableAttributesEvent
code:
  - php
  - twig
---

# RegisterElementSearchableAttributesEvent
...
:   [craft\events\RegisterElementSearchableAttributesEvent](craft-events-registerelementsearchableattributesevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterElementSearchableAttributesEvent.php)
...
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [attributes](craft-events-registerelementsearchableattributesevent.md#attributes)                              | [array](http://php.net/language.types.array) – List of registered searchable attributes for the element type.
...
List of registered searchable attributes for the element type.



[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterElementSearchableAttributesEvent.php#L23)
