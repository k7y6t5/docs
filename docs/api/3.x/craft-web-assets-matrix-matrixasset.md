---
title: craft\web\assets\matrix\MatrixAsset
code:
  - php
  - twig
---
...
:   craft\web\assets\matrix

Inherits

:   [craft\web\assets\matrix\MatrixAsset](craft-web-assets-matrix-matrixasset.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/matrix/MatrixAsset.php)
...
| [init()](craft-web-assets-matrix-matrixasset.md#method-init)                                                                              | Initializes the bundle.
...
| [registerAssetFiles()](craft-web-assets-matrix-matrixasset.md#method-registerassetfiles)                                                  | Registers the CSS and JS files with the given view.
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/matrix/MatrixAsset.php#L22-L35)
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/matrix/MatrixAsset.php#L40-L57)
