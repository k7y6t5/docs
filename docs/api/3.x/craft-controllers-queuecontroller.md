---
title: craft\controllers\QueueController
code:
  - php
  - twig
---
...
:   [craft\controllers\QueueController](craft-controllers-queuecontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/QueueController.php)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/QueueController.php#L36)
...
| [actionGetJobDetails()](craft-controllers-queuecontroller.md#method-actiongetjobdetails)                                                                | Returns the details for a particular job. This includes the `job` column containing a lot of raw data.
| [actionGetJobInfo()](craft-controllers-queuecontroller.md#method-actiongetjobinfo)                                                                      | Returns info about all the jobs in the queue.
| [actionRelease()](craft-controllers-queuecontroller.md#method-actionrelease)                                                                            | Releases a job from the queue.
| [actionReleaseAll()](craft-controllers-queuecontroller.md#method-actionreleaseall)                                                                      | Releases ALL jobs
| [actionRetry()](craft-controllers-queuecontroller.md#method-actionretry)                                                                                | Re-adds a failed job to the queue, and runs any waiting jobs.
| [actionRetryAll()](craft-controllers-queuecontroller.md#method-actionretryall)                                                                          | Retries ALL jobs
| [actionRun()](craft-controllers-queuecontroller.md#method-actionrun)                                                                                    | Runs any waiting jobs.
...
| [beforeAction()](craft-controllers-queuecontroller.md#method-beforeaction)                                                                              | This method is invoked right before an action is executed.
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/QueueController.php#L197-L225)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/QueueController.php#L175-L187)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/QueueController.php#L115-L127)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/QueueController.php#L138-L149)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/QueueController.php#L97-L107)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/QueueController.php#L159-L168)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/QueueController.php#L61-L88)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/QueueController.php#L42-L54)
...
- [yii\web\ServerErrorHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-servererrorhttpexception)\
  if the `queue` component doesn’t implement [craft\queue\QueueInterface](craft-queue-queueinterface.md)
