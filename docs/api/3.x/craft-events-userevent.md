...
:   [craft\events\UserEvent](craft-events-userevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/UserEvent.php)
...
| [user](craft-events-userevent.md#user)                                                                         | [craft\elements\User](craft-elements-user.md), [null](http://php.net/language.types.null) – The user model associated with the event.
...
The user model associated with the event.



[View source](https://github.com/craftcms/cms/blob/master/src/events/UserEvent.php#L23)
