---
title: craft\events\RebuildConfigEvent
code:
  - php
  - twig
---
...
:   [craft\events\RebuildConfigEvent](craft-events-rebuildconfigevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/RebuildConfigEvent.php)
...
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [config](craft-events-rebuildconfigevent.md#config)                                                            | [array](http://php.net/language.types.array) – The rebuilt project config
...
The rebuilt project config



[View source](https://github.com/craftcms/cms/blob/master/src/events/RebuildConfigEvent.php#L23)
