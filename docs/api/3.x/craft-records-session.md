...
:   [craft\records\Session](craft-records-session.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/Session.php)
...
| [user](craft-records-session.md#user)                                                                                                                  | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [getUser()](craft-records-session.md#method-getuser)                                                                                                            | Returns the session’s user.
...
| [rules()](craft-records-session.md#method-rules)                                                                                                                | Returns the validation rules for attributes.
...
| [tableName()](craft-records-session.md#method-tablename)                                                                                                        | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/Session.php#L51-L54)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/Session.php#L29-L35)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/Session.php#L41-L44)
