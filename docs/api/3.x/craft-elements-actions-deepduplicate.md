---
title: craft\elements\actions\DeepDuplicate
code:
  - php
  - twig
---
...
:   [craft\elements\actions\DeepDuplicate](craft-elements-actions-deepduplicate.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/DeepDuplicate.php)
...
| [deep](craft-elements-actions-deepduplicate.md#deep)                                                                             | [boolean](http://php.net/language.types.boolean) – Whether to also duplicate the selected elements’ descendants
...
| [successMessage](craft-elements-actions-duplicate.md#successmessage "Defined by craft\elements\actions\Duplicate")               | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The message that should be shown after the elements get deleted
...
| [triggerLabel](craft-base-elementaction.md#triggerlabel "Defined by craft\base\ElementAction")                                   | [string](http://php.net/language.types.string) – The action’s trigger label
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/DeepDuplicate.php#L21)
...
| [getTriggerLabel()](craft-base-elementaction.md#method-gettriggerlabel "Defined by craft\base\ElementAction")                                   | Returns the action’s trigger label.
