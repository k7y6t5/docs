...
:   [craft\events\ElementStructureEvent](craft-events-elementstructureevent.md), [craft\events\FieldElementEvent](craft-events-fieldelementevent.md)
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/ModelEvent.php)
...
| [isNew](craft-events-modelevent.md#isnew)                                                                                | [boolean](http://php.net/language.types.boolean) – Whether the model is brand new
...
Whether the model is brand new



[View source](https://github.com/craftcms/cms/blob/master/src/events/ModelEvent.php#L21)
