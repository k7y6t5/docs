---
title: craft\elements\MatrixBlock
code:
  - php
  - twig
---
...
:   [craft\elements\MatrixBlock](craft-elements-matrixblock.md) &raquo;
...
:   [ArrayAccess](http://php.net/class.arrayaccess), [IteratorAggregate](http://php.net/class.iteratoraggregate), [craft\base\BlockElementInterface](craft-base-blockelementinterface.md), [craft\base\ComponentInterface](craft-base-componentinterface.md), [craft\base\ElementInterface](craft-base-elementinterface.md), [yii\base\Arrayable](https://www.yiiframework.com/doc/api/2.0/yii-base-arrayable), [yii\base\Configurable](https://www.yiiframework.com/doc/api/2.0/yii-base-configurable), [yii\base\StaticInstanceInterface](https://www.yiiframework.com/doc/api/2.0/yii-base-staticinstanceinterface)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php)
...
| [collapsed](craft-elements-matrixblock.md#collapsed)                                                                             | [boolean](http://php.net/language.types.boolean) – Collapsed
...
| [contentTable](craft-elements-matrixblock.md#contenttable)                                                                       | [string](http://php.net/language.types.string)
...
| [deletedWithOwner](craft-elements-matrixblock.md#deletedwithowner)                                                               | [boolean](http://php.net/language.types.boolean) – Whether the block was deleted along with its owner
...
| [fieldColumnPrefix](craft-elements-matrixblock.md#fieldcolumnprefix)                                                             | [string](http://php.net/language.types.string)
| [fieldContext](craft-elements-matrixblock.md#fieldcontext)                                                                       | [string](http://php.net/language.types.string)
| [fieldId](craft-elements-matrixblock.md#fieldid)                                                                                 | [integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null) – Field ID
| [fieldLayout](craft-elements-matrixblock.md#fieldlayout)                                                                         | [craft\models\FieldLayout](craft-models-fieldlayout.md), [null](http://php.net/language.types.null)
...
| [gqlTypeName](craft-elements-matrixblock.md#gqltypename)                                                                         | [string](http://php.net/language.types.string)
...
| [owner](craft-elements-matrixblock.md#owner)                                                                                     | [craft\base\ElementInterface](craft-base-elementinterface.md)
| [ownerId](craft-elements-matrixblock.md#ownerid)                                                                                 | [integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null) – Owner ID
| [ownerSiteId](craft-elements-matrixblock.md#ownersiteid)                                                                         | [integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null) – Owner site ID
...
| [sortOrder](craft-elements-matrixblock.md#sortorder)                                                                             | [integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null) – Sort order
...
| [supportedSites](craft-elements-matrixblock.md#supportedsites)                                                                   | [integer](http://php.net/language.types.integer)[], [array](http://php.net/language.types.array)
...
| [type](craft-elements-matrixblock.md#type)                                                                                       | [craft\models\MatrixBlockType](craft-models-matrixblocktype.md)
| [typeId](craft-elements-matrixblock.md#typeid)                                                                                   | [integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null) – Type ID
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L192)
...
Whether the block was deleted along with its owner

See also [beforeDelete()](craft-elements-matrixblock.md#method-beforedelete)

[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L198)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L159)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L164)
...
::: danger DEPRECATED
Deprecated in 3.2.0. Use [siteId](craft-base-elementtrait.md#siteid) instead.
:::
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L170)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L180)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L175)
...
| [afterDelete()](craft-elements-matrixblock.md#method-afterdelete)                                                                               | Performs actions after an element is deleted.
...
| [afterSave()](craft-elements-matrixblock.md#method-aftersave)                                                                                   | Performs actions after an element is saved.
...
| [attributes()](craft-elements-matrixblock.md#method-attributes)                                                                                 | Returns the list of attribute names.
| [beforeDelete()](craft-elements-matrixblock.md#method-beforedelete)                                                                             | Performs actions before an element is deleted.
...
| [displayName()](craft-elements-matrixblock.md#method-displayname)                                                                               | Returns the display name of this class.
| [eagerLoadingMap()](craft-elements-matrixblock.md#method-eagerloadingmap)                                                                       | Returns an array that maps source-to-target element IDs based on the given sub-property handle.
...
| [extraFields()](craft-elements-matrixblock.md#method-extrafields)                                                                               | Returns the list of fields that can be expanded further and returned by [toArray()](https://www.yiiframework.com/doc/api/2.0/yii-base-arrayabletrait#toArray()-detail).
| [fields()](https://www.yiiframework.com/doc/api/2.0/yii-base-arrayabletrait#fields()-detail "Defined by yii\base\ArrayableTrait")               | Returns the list of fields that should be returned by default by [toArray()](https://www.yiiframework.com/doc/api/2.0/yii-base-arrayabletrait#toArray()-detail) when no specific fields are specified.
| [find()](craft-elements-matrixblock.md#method-find)                                                                                             | Creates an [craft\elements\db\ElementQueryInterface](craft-elements-db-elementqueryinterface.md) instance for query purpose.
...
| [getContentTable()](craft-elements-matrixblock.md#method-getcontenttable)                                                                       | Returns the name of the table this element’s content is stored in.
...
| [getEagerLoadedElements()](craft-elements-matrixblock.md#method-geteagerloadedelements)                                                         | Returns the eager-loaded elements for a given handle.
...
| [getFieldColumnPrefix()](craft-elements-matrixblock.md#method-getfieldcolumnprefix)                                                             | Returns the field column prefix this element’s content uses.
| [getFieldContext()](craft-elements-matrixblock.md#method-getfieldcontext)                                                                       | Returns the field context this element's content uses.
| [getFieldLayout()](craft-elements-matrixblock.md#method-getfieldlayout)                                                                         | Returns the field layout used by this element.
...
| [getGqlTypeName()](craft-elements-matrixblock.md#method-getgqltypename)                                                                         | Returns the GraphQL type name for this element type.
...
| [getOwner()](craft-elements-matrixblock.md#method-getowner)                                                                                     | Returns the owner element.
...
| [getSupportedSites()](craft-elements-matrixblock.md#method-getsupportedsites)                                                                   | Returns the sites this element is associated with.
...
| [getType()](craft-elements-matrixblock.md#method-gettype)                                                                                       | Returns the block type.
...
| [gqlTypeNameByContext()](craft-elements-matrixblock.md#method-gqltypenamebycontext)                                                             | Returns the GraphQL type name by an element's context.
| [hasContent()](craft-elements-matrixblock.md#method-hascontent)                                                                                 | Returns whether elements of this type will be storing any data in the `content` table (titles or custom fields).
| [hasEagerLoadedElements()](craft-elements-matrixblock.md#method-haseagerloadedelements)                                                         | Returns whether elements have been eager-loaded with a given handle.
...
| [hasStatuses()](craft-elements-matrixblock.md#method-hasstatuses)                                                                               | Returns whether elements of this type have statuses.
...
| [isLocalized()](craft-elements-matrixblock.md#method-islocalized)                                                                               | Returns whether elements of this type store content on a per-site basis.
...
| [lowerDisplayName()](craft-elements-matrixblock.md#method-lowerdisplayname)                                                                     | Returns the lowercase version of [displayName()](craft-elements-matrixblock.md#method-displayname).
...
| [pluralDisplayName()](craft-elements-matrixblock.md#method-pluraldisplayname)                                                                   | Returns the plural version of [displayName()](craft-elements-matrixblock.md#method-displayname).
| [pluralLowerDisplayName()](craft-elements-matrixblock.md#method-plurallowerdisplayname)                                                         | Returns the plural, lowercase version of [displayName()](craft-elements-matrixblock.md#method-displayname).
| [refHandle()](craft-elements-matrixblock.md#method-refhandle)                                                                                   | Returns the handle that should be used to refer to this element type from reference tags.
...
| [setEagerLoadedElements()](craft-elements-matrixblock.md#method-seteagerloadedelements)                                                         | Sets some eager-loaded elements on a given handle.
...
| [setOwner()](craft-elements-matrixblock.md#method-setowner)                                                                                     | Sets the owner
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L448-L458)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L401-L424)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L213-L218)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L429-L443)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L39-L42)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L112-L144)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L223-L229)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L104-L107)



#### Returns

[craft\elements\db\MatrixBlockQuery](craft-elements-db-matrixblockquery.md) – The newly created [craft\elements\db\MatrixBlockQuery](craft-elements-db-matrixblockquery.md) instance.
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L317-L320)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L358-L368)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L325-L328)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L335-L338)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L262-L265)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L389-L392)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L289-L302)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L244-L257)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L273-L286)
...
- [yii\base\InvalidConfigException](https://www.yiiframework.com/doc/api/2.0/yii-base-invalidconfigexception)\
  if [typeId](craft-elements-matrixblock.md#typeid) is missing or invalid
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L150-L154)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L79-L82)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L343-L353)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L95-L98)
...
If this returns `true`, the element’s [getSupportedSites()](craft-elements-matrixblock.md#method-getsupportedsites) method will
be responsible for defining which sites its content should be stored in.




[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L87-L90)
...
Returns the lowercase version of [displayName()](craft-elements-matrixblock.md#method-displayname).
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L47-L50)
...
Returns the plural version of [displayName()](craft-elements-matrixblock.md#method-displayname).
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L55-L58)
...
Returns the plural, lowercase version of [displayName()](craft-elements-matrixblock.md#method-displayname).
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L63-L66)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L71-L74)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L373-L382)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L309-L312)


#### Arguments

- `$owner` ([craft\base\ElementInterface](craft-base-elementinterface.md), [null](http://php.net/language.types.null))
...
| [defineRules()](craft-elements-matrixblock.md#method-definerules)                                                                                       | Returns the validation rules for attributes.
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/MatrixBlock.php#L234-L239)
