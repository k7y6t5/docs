---
title: craft\events\GlobalSetContentEvent
code:
  - php
  - twig
---

# GlobalSetContentEvent
...
:   [craft\events\GlobalSetContentEvent](craft-events-globalsetcontentevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/GlobalSetContentEvent.php)
...
| [globalSet](craft-events-globalsetcontentevent.md#globalset)                                                   | [craft\elements\GlobalSet](craft-elements-globalset.md), [null](http://php.net/language.types.null) – The global set model associated with the event.
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/GlobalSetContentEvent.php#L25)
