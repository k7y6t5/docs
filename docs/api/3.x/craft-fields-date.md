...
:   [craft\fields\Date](craft-fields-date.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Date.php)
...
| [contentColumnType](craft-fields-date.md#contentcolumntype)                                                                      | [string](http://php.net/language.types.string) – The column type.
| [contentGqlType](craft-fields-date.md#contentgqltype)                                                                            | `\GraphQL\Type\Definition\Type`, [array](http://php.net/language.types.array)
...
| [minuteIncrement](craft-fields-date.md#minuteincrement)                                                                          | [integer](http://php.net/language.types.integer) – The number of minutes that the timepicker options should increment by
...
| [settingsHtml](craft-fields-date.md#settingshtml)                                                                                | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null)
| [showDate](craft-fields-date.md#showdate)                                                                                        | [boolean](http://php.net/language.types.boolean) – Whether a datepicker should be shown as part of the input
| [showTime](craft-fields-date.md#showtime)                                                                                        | [boolean](http://php.net/language.types.boolean) – Whether a timepicker should be shown as part of the input
...
The number of minutes that the timepicker options should increment by



[View source](https://github.com/craftcms/cms/blob/master/src/fields/Date.php#L61)
...
Whether a datepicker should be shown as part of the input



[View source](https://github.com/craftcms/cms/blob/master/src/fields/Date.php#L51)
...
Whether a timepicker should be shown as part of the input



[View source](https://github.com/craftcms/cms/blob/master/src/fields/Date.php#L56)
...
| [__construct()](craft-fields-date.md#method-construct)                                                                                          | Constructor.
...
| [displayName()](craft-fields-date.md#method-displayname)                                                                                        | Returns the display name of this class.
...
| [getContentColumnType()](craft-fields-date.md#method-getcontentcolumntype)                                                                      | Returns the column type that this field should get within the content table.
| [getContentGqlType()](craft-fields-date.md#method-getcontentgqltype)                                                                            | Returns the GraphQL type to be used for this field type.
...
| [getInputHtml()](craft-fields-date.md#method-getinputhtml)                                                                                      | Returns the field’s input HTML.
...
| [getSearchKeywords()](craft-fields-date.md#method-getsearchkeywords)                                                                            | Returns the search keywords that should be associated with this field.
...
| [getSettingsHtml()](craft-fields-date.md#method-getsettingshtml)                                                                                | Returns the component’s settings HTML.
...
| [getTableAttributeHtml()](craft-fields-date.md#method-gettableattributehtml)                                                                    | Returns the HTML that should be shown for this field in Table View.
...
| [init()](craft-fields-date.md#method-init)                                                                                                      | Initializes the object.
...
| [modifyElementsQuery()](craft-fields-date.md#method-modifyelementsquery)                                                                        | Modifies an element query.
| [normalizeValue()](craft-fields-date.md#method-normalizevalue)                                                                                  | Normalizes the field’s value for use.
...
| [valueType()](craft-fields-date.md#method-valuetype)                                                                                            | Returns the PHPDoc type this field’s values will have.
...
- Call [init()](craft-fields-date.md#method-init).
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Date.php#L66-L89)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Date.php#L35-L38)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Date.php#L118-L121)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Date.php#L250-L253)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Date.php#L166-L194)


#### Arguments

- `$value` (`mixed`) – The field’s value. This will either be the [normalized value](craft-fields-date.md#method-normalizevalue),
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Date.php#L199-L202)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Date.php#L126-L161)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Date.php#L207-L222)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Date.php#L94-L102)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Date.php#L239-L245)
...
`entry.myFieldHandle` is called from a template, or right before [getInputHtml()](craft-fields-date.md#method-getinputhtml) is called. Whatever
this method returns is what `entry.myFieldHandle` will likewise return, and what [getInputHtml()](craft-fields-date.md#method-getinputhtml)’s and
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Date.php#L227-L234)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Date.php#L43-L46)
...
| Method                                                                                                                                                  | Description
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [defineRules()](craft-fields-date.md#method-definerules)                                                                                                | Returns the validation rules for attributes.
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Date.php#L107-L113)
