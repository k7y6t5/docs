---
title: craft\events\WidgetEvent
code:
  - php
  - twig
---
...
:   [craft\events\WidgetEvent](craft-events-widgetevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/WidgetEvent.php)
...
| [isNew](craft-events-widgetevent.md#isnew)                                                                     | [boolean](http://php.net/language.types.boolean) – Whether the widget is brand new
...
| [widget](craft-events-widgetevent.md#widget)                                                                   | [craft\base\WidgetInterface](craft-base-widgetinterface.md), [null](http://php.net/language.types.null) – The widget associated with this event.
...
Whether the widget is brand new



[View source](https://github.com/craftcms/cms/blob/master/src/events/WidgetEvent.php#L29)
...
:   [craft\base\WidgetInterface](craft-base-widgetinterface.md), [null](http://php.net/language.types.null)



The widget associated with this event.



[View source](https://github.com/craftcms/cms/blob/master/src/events/WidgetEvent.php#L24)
