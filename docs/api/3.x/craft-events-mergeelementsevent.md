---
title: craft\events\MergeElementsEvent
code:
  - php
  - twig
---
...
:   [craft\events\MergeElementsEvent](craft-events-mergeelementsevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/MergeElementsEvent.php)
...
| [mergedElementId](craft-events-mergeelementsevent.md#mergedelementid)                                          | [integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null) – The ID of the element that just got merged into the other.
...
| [prevailingElementId](craft-events-mergeelementsevent.md#prevailingelementid)                                  | [integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null) – The ID of the element that prevailed in the merge.
...
The ID of the element that just got merged into the other.



[View source](https://github.com/craftcms/cms/blob/master/src/events/MergeElementsEvent.php#L23)
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/MergeElementsEvent.php#L28)
