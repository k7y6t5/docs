---
title: craft\elements\actions\Restore
code:
  - php
  - twig
---
...
:   [craft\elements\actions\Restore](craft-elements-actions-restore.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/Restore.php)
...
| [failMessage](craft-elements-actions-restore.md#failmessage)                                                                     | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The message that should be shown if no elements get restored
...
| [partialSuccessMessage](craft-elements-actions-restore.md#partialsuccessmessage)                                                 | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The message that should be shown after some elements get restored
...
| [successMessage](craft-elements-actions-restore.md#successmessage)                                                               | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The message that should be shown after the elements get restored
| [triggerHtml](craft-elements-actions-restore.md#triggerhtml)                                                                     | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The action’s trigger HTML.
| [triggerLabel](craft-elements-actions-restore.md#triggerlabel)                                                                   | [string](http://php.net/language.types.string) – The action’s trigger label
...
The message that should be shown if no elements get restored



[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/Restore.php#L35)
...
The message that should be shown after some elements get restored



[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/Restore.php#L30)
...
The message that should be shown after the elements get restored



[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/Restore.php#L25)
...
| [getTriggerHtml()](craft-elements-actions-restore.md#method-gettriggerhtml)                                                                     | Returns the action’s trigger HTML.
| [getTriggerLabel()](craft-elements-actions-restore.md#method-gettriggerlabel)                                                                   | Returns the action’s trigger label.
...
| [performAction()](craft-elements-actions-restore.md#method-performaction)                                                                       | Performs the action on any elements that match the given criteria.
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/Restore.php#L48-L51)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/Restore.php#L40-L43)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/Restore.php#L56-L81)
