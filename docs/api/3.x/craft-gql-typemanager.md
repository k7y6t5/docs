...
:   [craft\gql\TypeManager](craft-gql-typemanager.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/gql/TypeManager.php)
...
| [flush()](craft-gql-typemanager.md#method-flush)                                                                                                | Flush all prepared field definitions.
...
| [prepareFieldDefinitions()](craft-gql-typemanager.md#method-preparefielddefinitions)                                                            | Prepare field definitions for a GraphQL type by giving plugins a chance to modify them.
...
[View source](https://github.com/craftcms/cms/blob/master/src/gql/TypeManager.php#L82-L85)
...
[View source](https://github.com/craftcms/cms/blob/master/src/gql/TypeManager.php#L69-L77)


#### Arguments

- `$fields` ([array](http://php.net/language.types.array))
- `$typeName` ([string](http://php.net/language.types.string))
...
:   `\craft\gql\DefineGqlTypeFields`



The event that is triggered when GraphQL type fields are being prepared.
