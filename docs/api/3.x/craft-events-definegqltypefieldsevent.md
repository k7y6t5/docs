---
title: craft\events\DefineGqlTypeFieldsEvent
code:
  - php
  - twig
---

# DefineGqlTypeFieldsEvent
...
:   [craft\events\DefineGqlTypeFieldsEvent](craft-events-definegqltypefieldsevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/DefineGqlTypeFieldsEvent.php)
...
| [fields](craft-events-definegqltypefieldsevent.md#fields)                                                      | [array](http://php.net/language.types.array) – List of fields being defined for a GraphQL Type.
...
| [typeName](craft-events-definegqltypefieldsevent.md#typename)                                                  | [string](http://php.net/language.types.string) – The name of the GraphQL Type being defined.
...
List of fields being defined for a GraphQL Type.



[View source](https://github.com/craftcms/cms/blob/master/src/events/DefineGqlTypeFieldsEvent.php#L23)
...
The name of the GraphQL Type being defined.



[View source](https://github.com/craftcms/cms/blob/master/src/events/DefineGqlTypeFieldsEvent.php#L28)
