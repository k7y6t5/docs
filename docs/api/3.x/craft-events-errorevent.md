...
:   [craft\events\ErrorEvent](craft-events-errorevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/ErrorEvent.php)
...
| [exception](craft-events-errorevent.md#exception)                                                              | [Exception](http://php.net/class.exception) – The uncaught exception that was thrown
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/ErrorEvent.php#L23)
