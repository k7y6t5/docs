...
:   [craft\widgets\NewUsers](craft-widgets-newusers.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/NewUsers.php)
...
| [bodyHtml](craft-widgets-newusers.md#bodyhtml)                                                                                   | [string](http://php.net/language.types.string), [false](http://php.net/language.types.boolean) – The widget’s body HTML, or `false` if the widget should not be visible.
...
| [dateRange](craft-widgets-newusers.md#daterange)                                                                                 | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The date range
...
| [settingsHtml](craft-widgets-newusers.md#settingshtml)                                                                           | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null)
...
| [title](craft-widgets-newusers.md#title)                                                                                         | [string](http://php.net/language.types.string) – The widget’s title.
| [userGroupId](craft-widgets-newusers.md#usergroupid)                                                                             | [integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null) – The ID of the user group
...
the first place, use [isSelectable()](craft-widgets-newusers.md#method-isselectable).)
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/NewUsers.php#L56)
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/NewUsers.php#L51)
...
| [displayName()](craft-widgets-newusers.md#method-displayname)                                                                                   | Returns the display name of this class.
...
| [getBodyHtml()](craft-widgets-newusers.md#method-getbodyhtml)                                                                                   | Returns the widget's body HTML.
...
| [getSettingsHtml()](craft-widgets-newusers.md#method-getsettingshtml)                                                                           | Returns the component’s settings HTML.
| [getSubtitle()](craft-base-widget.md#method-getsubtitle "Defined by craft\base\Widget")                                                         | Returns the widget’s subtitle.
| [getTitle()](craft-widgets-newusers.md#method-gettitle)                                                                                         | Returns the widget’s title.
...
| [icon()](craft-widgets-newusers.md#method-icon)                                                                                                 | Returns the path to the widget’s SVG icon, or the actual SVG contents.
...
| [isSelectable()](craft-widgets-newusers.md#method-isselectable)                                                                                 | Returns whether the component should be selectable in component Type selects.
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/NewUsers.php#L26-L29)
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/NewUsers.php#L78-L92)
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/NewUsers.php#L97-L103)
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/NewUsers.php#L62-L73)
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/NewUsers.php#L43-L46)
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/NewUsers.php#L34-L38)
