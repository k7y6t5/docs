...
:   [craft\fields\PlainText](craft-fields-plaintext.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/PlainText.php)
...
| [byteLimit](craft-fields-plaintext.md#bytelimit)                                                                                 | [integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null) – The maximum number of bytes allowed in the field
| [charLimit](craft-fields-plaintext.md#charlimit)                                                                                 | [integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null) – The maximum number of characters allowed in the field
| [code](craft-fields-plaintext.md#code)                                                                                           | [boolean](http://php.net/language.types.boolean) – Whether the input should use monospace font
...
| [columnType](craft-fields-plaintext.md#columntype)                                                                               | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The type of database column the field should have in the content table
| [contentColumnType](craft-fields-plaintext.md#contentcolumntype)                                                                 | [string](http://php.net/language.types.string) – The column type.
...
| [elementValidationRules](craft-fields-plaintext.md#elementvalidationrules)                                                       | [array](http://php.net/language.types.array)
...
| [initialRows](craft-fields-plaintext.md#initialrows)                                                                             | [integer](http://php.net/language.types.integer) – The minimum number of rows the input should have, if multi-line
...
| [multiline](craft-fields-plaintext.md#multiline)                                                                                 | [boolean](http://php.net/language.types.boolean) – Whether the input should allow line breaks
...
| [placeholder](craft-fields-plaintext.md#placeholder)                                                                             | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The input’s placeholder text
...
| [settingsHtml](craft-fields-plaintext.md#settingshtml)                                                                           | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null)
...
The maximum number of bytes allowed in the field



[View source](https://github.com/craftcms/cms/blob/master/src/fields/PlainText.php#L71)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/PlainText.php#L65)
...
Whether the input should use monospace font



[View source](https://github.com/craftcms/cms/blob/master/src/fields/PlainText.php#L50)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/PlainText.php#L76)
...
The minimum number of rows the input should have, if multi-line



[View source](https://github.com/craftcms/cms/blob/master/src/fields/PlainText.php#L60)
...
Whether the input should allow line breaks



[View source](https://github.com/craftcms/cms/blob/master/src/fields/PlainText.php#L55)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/PlainText.php#L45)
...
| [__construct()](craft-fields-plaintext.md#method-construct)                                                                                     | Constructor.
...
| [displayName()](craft-fields-plaintext.md#method-displayname)                                                                                   | Returns the display name of this class.
...
| [getContentColumnType()](craft-fields-plaintext.md#method-getcontentcolumntype)                                                                 | Returns the column type that this field should get within the content table.
...
| [getElementValidationRules()](craft-fields-plaintext.md#method-getelementvalidationrules)                                                       | Returns the validation rules for an element with this field.
...
| [getInputHtml()](craft-fields-plaintext.md#method-getinputhtml)                                                                                 | Returns the field’s input HTML.
...
| [getSearchKeywords()](craft-fields-plaintext.md#method-getsearchkeywords)                                                                       | Returns the search keywords that should be associated with this field.
...
| [getSettingsHtml()](craft-fields-plaintext.md#method-getsettingshtml)                                                                           | Returns the component’s settings HTML.
...
| [normalizeValue()](craft-fields-plaintext.md#method-normalizevalue)                                                                             | Normalizes the field’s value for use.
...
| [serializeValue()](craft-fields-plaintext.md#method-serializevalue)                                                                             | Prepares the field’s value to be stored somewhere, like the content table or JSON-encoded in an entry revision table.
...
| [validateFieldLimit()](craft-fields-plaintext.md#method-validatefieldlimit)                                                                     | Validates that the Character Limit isn't set to something higher than the Column Type will hold.
| [validateMultiple()](https://www.yiiframework.com/doc/api/2.0/yii-base-model#validateMultiple()-detail "Defined by yii\base\Model")             | Validates multiple models.
| [valueType()](craft-fields-plaintext.md#method-valuetype)                                                                                       | Returns the PHPDoc type this field’s values will have.
...
- Call [init()](craft-base-field.md#method-init).
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/PlainText.php#L81-L108)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/PlainText.php#L29-L32)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/PlainText.php#L153-L168)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/PlainText.php#L199-L208)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/PlainText.php#L186-L194)


#### Arguments

- `$value` (`mixed`) – The field’s value. This will either be the [normalized value](craft-fields-plaintext.md#method-normalizevalue),
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/PlainText.php#L224-L229)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/PlainText.php#L142-L148)
...
`entry.myFieldHandle` is called from a template, or right before [getInputHtml()](craft-fields-plaintext.md#method-getinputhtml) is called. Whatever
this method returns is what `entry.myFieldHandle` will likewise return, and what [getInputHtml()](craft-fields-plaintext.md#method-getinputhtml)’s and
[serializeValue()](craft-fields-plaintext.md#method-serializevalue)’s $value arguments will be set to.
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/PlainText.php#L173-L181)
...
Whatever this returns should be something [normalizeValue()](craft-fields-plaintext.md#method-normalizevalue) can handle.




[View source](https://github.com/craftcms/cms/blob/master/src/fields/PlainText.php#L213-L219)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/PlainText.php#L126-L137)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/PlainText.php#L37-L40)
...
| Method                                                                                                                                                  | Description
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [defineRules()](craft-fields-plaintext.md#method-definerules)                                                                                           | Returns the validation rules for attributes.
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/PlainText.php#L113-L119)
