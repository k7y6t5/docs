---
title: craft\web\assets\queuemanager\QueueManagerAsset
code:
  - php
  - twig
---
...
:   craft\web\assets\queuemanager

Inherits

:   [craft\web\assets\queuemanager\QueueManagerAsset](craft-web-assets-queuemanager-queuemanagerasset.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/queuemanager/QueueManagerAsset.php)
...
| [init()](craft-web-assets-queuemanager-queuemanagerasset.md#method-init)                                                                  | Initializes the bundle.
...
| [registerAssetFiles()](craft-web-assets-queuemanager-queuemanagerasset.md#method-registerassetfiles)                                      | Registers the CSS and JS files with the given view.
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/queuemanager/QueueManagerAsset.php#L29-L43)
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/queuemanager/QueueManagerAsset.php#L48-L75)
