---
title: craft\console\controllers\ProjectConfigController
code:
  - php
  - twig
---
...
:   [craft\console\controllers\ProjectConfigController](craft-console-controllers-projectconfigcontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/ProjectConfigController.php)
...
| [force](craft-console-controllers-projectconfigcontroller.md#force)                                                                                  | [boolean](http://php.net/language.types.boolean) – Whether every entry change should be force-synced.
...
Whether every entry change should be force-synced.



[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/ProjectConfigController.php#L28)
...
| [actionRebuild()](craft-console-controllers-projectconfigcontroller.md#method-actionrebuild)                                                                  | Rebuilds the project config.
| [actionSync()](craft-console-controllers-projectconfigcontroller.md#method-actionsync)                                                                        | Syncs the project config.
...
| [options()](craft-console-controllers-projectconfigcontroller.md#method-options)                                                                              | Returns the names of valid options for the action (id) An option requires the existence of a public member variable whose name is the option name.
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/ProjectConfigController.php#L106-L127)
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/ProjectConfigController.php#L35-L98)
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/ProjectConfigController.php#L197-L206)
