---
title: craft\records\VolumeFolder
code:
  - php
  - twig
---
...
:   [craft\records\VolumeFolder](craft-records-volumefolder.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/VolumeFolder.php)
...
| [parent](craft-records-volumefolder.md#parent)                                                                                                         | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [volume](craft-records-volumefolder.md#volume)                                                                                                         | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [getParent()](craft-records-volumefolder.md#method-getparent)                                                                                                   | Returns the asset folder’s parent.
...
| [getVolume()](craft-records-volumefolder.md#method-getvolume)                                                                                                   | Returns the asset folder’s source.
...
| [rules()](craft-records-volumefolder.md#method-rules)                                                                                                           | Returns the validation rules for attributes.
...
| [tableName()](craft-records-volumefolder.md#method-tablename)                                                                                                   | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/VolumeFolder.php#L54-L57)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/VolumeFolder.php#L64-L67)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/VolumeFolder.php#L32-L38)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/VolumeFolder.php#L44-L47)
