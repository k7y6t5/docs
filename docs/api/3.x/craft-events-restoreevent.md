---
title: craft\events\RestoreEvent
code:
  - php
  - twig
---
...
:   [craft\events\RestoreEvent](craft-events-restoreevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/RestoreEvent.php)
...
| [file](craft-events-restoreevent.md#file)                                                                      | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The file path to the backup to restore.
...
The file path to the backup to restore.



[View source](https://github.com/craftcms/cms/blob/master/src/events/RestoreEvent.php#L23)
