---
title: craft\events\RegisterUserPermissionsEvent
code:
  - php
  - twig
---
...
:   [craft\events\RegisterUserPermissionsEvent](craft-events-registeruserpermissionsevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterUserPermissionsEvent.php)
...
| [permissions](craft-events-registeruserpermissionsevent.md#permissions)                                        | [array](http://php.net/language.types.array) – List of registered user permissions.
...
List of registered user permissions.



[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterUserPermissionsEvent.php#L23)
