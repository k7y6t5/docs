---
title: craft\models\SystemMessage
code:
  - php
  - twig
---
...
:   [craft\models\SystemMessage](craft-models-systemmessage.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/models/SystemMessage.php)
...
| [body](craft-models-systemmessage.md#body)                                                                                       | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – Body template
| [errors](https://www.yiiframework.com/doc/api/2.0/yii-base-model#$errors-detail "Defined by yii\base\Model")                     | [array](http://php.net/language.types.array) – Errors for all attributes or the specified attribute.
| [firstErrors](https://www.yiiframework.com/doc/api/2.0/yii-base-model#$firstErrors-detail "Defined by yii\base\Model")           | [array](http://php.net/language.types.array) – The first errors.
| [heading](craft-models-systemmessage.md#heading)                                                                                 | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – Heading to be shown on the settings page for this message
| [iterator](https://www.yiiframework.com/doc/api/2.0/yii-base-model#$iterator-detail "Defined by yii\base\Model")                 | [ArrayIterator](http://php.net/class.arrayiterator) – An iterator for traversing the items in the list.
| [key](craft-models-systemmessage.md#key)                                                                                         | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – Unique key for the message
| [scenario](https://www.yiiframework.com/doc/api/2.0/yii-base-model#$scenario-detail "Defined by yii\base\Model")                 | [string](http://php.net/language.types.string) – The scenario that this model is in.
| [subject](craft-models-systemmessage.md#subject)                                                                                 | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – Subject template
...
[View source](https://github.com/craftcms/cms/blob/master/src/models/SystemMessage.php#L38)
...
Heading to be shown on the settings page for this message



[View source](https://github.com/craftcms/cms/blob/master/src/models/SystemMessage.php#L28)
...
[View source](https://github.com/craftcms/cms/blob/master/src/models/SystemMessage.php#L23)
...
[View source](https://github.com/craftcms/cms/blob/master/src/models/SystemMessage.php#L33)
