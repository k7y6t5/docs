---
title: craft\events\RegisterCpAlertsEvent
code:
  - php
  - twig
---

# RegisterCpAlertsEvent
...
:   [craft\events\RegisterCpAlertsEvent](craft-events-registercpalertsevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterCpAlertsEvent.php)
...
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [alerts](craft-events-registercpalertsevent.md#alerts)                                                         | [array](http://php.net/language.types.array) – The registered control panel alerts
...
The registered control panel alerts



[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterCpAlertsEvent.php#L23)
