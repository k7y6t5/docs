...
[View source](https://github.com/craftcms/cms/blob/master/src/events/SiteEvent.php)
...
| [isNew](craft-events-siteevent.md#isnew)                                                                       | [boolean](http://php.net/language.types.boolean) – Whether the site is brand new
...
| [oldPrimarySiteId](craft-events-siteevent.md#oldprimarysiteid)                                                 | [integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null) – The old primary site ID
...
| [site](craft-events-siteevent.md#site)                                                                         | [craft\models\Site](craft-models-site.md), [null](http://php.net/language.types.null) – The site model associated with the event.
...
Whether the site is brand new



[View source](https://github.com/craftcms/cms/blob/master/src/events/SiteEvent.php#L26)
...
The old primary site ID



[View source](https://github.com/craftcms/cms/blob/master/src/events/SiteEvent.php#L31)
...
The site model associated with the event.



[View source](https://github.com/craftcms/cms/blob/master/src/events/SiteEvent.php#L21)
