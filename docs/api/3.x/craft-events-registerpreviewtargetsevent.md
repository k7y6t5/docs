---
title: craft\events\RegisterPreviewTargetsEvent
code:
  - php
  - twig
---

# RegisterPreviewTargetsEvent
...
:   [craft\events\RegisterPreviewTargetsEvent](craft-events-registerpreviewtargetsevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterPreviewTargetsEvent.php)
...
| [previewTargets](craft-events-registerpreviewtargetsevent.md#previewtargets)                                   | [array](http://php.net/language.types.array) – The additional locations that should be available for previewing the element.
...
The additional locations that should be available for previewing the element.



[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterPreviewTargetsEvent.php#L23)
