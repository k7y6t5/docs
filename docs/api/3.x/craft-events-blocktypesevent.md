---
title: craft\events\BlockTypesEvent
code:
  - php
  - twig
---
...
:   [craft\events\BlockTypesEvent](craft-events-blocktypesevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/BlockTypesEvent.php)
...
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [blockTypes](craft-events-blocktypesevent.md#blocktypes)                                                       | [craft\models\MatrixBlockType](craft-models-matrixblocktype.md)[] – The block types that will be available for the current field
...
| [element](craft-events-blocktypesevent.md#element)                                                             | [craft\base\ElementInterface](craft-base-elementinterface.md), [null](http://php.net/language.types.null) – The element that the field is generating an input for.
...
| [value](craft-events-blocktypesevent.md#value)                                                                 | [craft\elements\MatrixBlock](craft-elements-matrixblock.md)[] – The current value of the field.
...
The block types that will be available for the current field



[View source](https://github.com/craftcms/cms/blob/master/src/events/BlockTypesEvent.php#L26)
...
The element that the field is generating an input for.



[View source](https://github.com/craftcms/cms/blob/master/src/events/BlockTypesEvent.php#L31)
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/BlockTypesEvent.php#L36)
