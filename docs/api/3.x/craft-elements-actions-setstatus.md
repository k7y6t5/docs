---
title: craft\elements\actions\SetStatus
code:
  - php
  - twig
---
...
:   [craft\elements\actions\SetStatus](craft-elements-actions-setstatus.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/SetStatus.php)
...
| [allowDisabledForSite](craft-elements-actions-setstatus.md#allowdisabledforsite)                                                 | [boolean](http://php.net/language.types.boolean) – Whether to show the “Disabled for Site” status option.
...
| [status](craft-elements-actions-setstatus.md#status)                                                                             | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The status elements should be set to
| [triggerHtml](craft-elements-actions-setstatus.md#triggerhtml)                                                                   | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The action’s trigger HTML.
| [triggerLabel](craft-elements-actions-setstatus.md#triggerlabel)                                                                 | [string](http://php.net/language.types.string) – The action’s trigger label
...
Whether to show the “Disabled for Site” status option.



[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/SetStatus.php#L46)
...
The status elements should be set to



[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/SetStatus.php#L51)
...
| [getTriggerHtml()](craft-elements-actions-setstatus.md#method-gettriggerhtml)                                                                   | Returns the action’s trigger HTML.
| [getTriggerLabel()](craft-elements-actions-setstatus.md#method-gettriggerlabel)                                                                 | Returns the action’s trigger label.
...
| [performAction()](craft-elements-actions-setstatus.md#method-performaction)                                                                     | Performs the action on any elements that match the given criteria.
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/SetStatus.php#L75-L78)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/SetStatus.php#L56-L59)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/SetStatus.php#L83-L152)
...
| Method                                                                                                                                                  | Description
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [defineRules()](craft-elements-actions-setstatus.md#method-definerules)                                                                                 | Returns the validation rules for attributes.
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/SetStatus.php#L64-L70)
