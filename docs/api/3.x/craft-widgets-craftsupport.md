---
title: craft\widgets\CraftSupport
code:
  - php
  - twig
---
...
:   [craft\widgets\CraftSupport](craft-widgets-craftsupport.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/CraftSupport.php)
...
| [bodyHtml](craft-widgets-craftsupport.md#bodyhtml)                                                                               | [string](http://php.net/language.types.string), [false](http://php.net/language.types.boolean) – The widget’s body HTML, or `false` if the widget should not be visible.
...
| [title](craft-widgets-craftsupport.md#title)                                                                                     | [string](http://php.net/language.types.string) – The widget’s title.
...
the first place, use [isSelectable()](craft-widgets-craftsupport.md#method-isselectable).)
...
| [displayName()](craft-widgets-craftsupport.md#method-displayname)                                                                               | Returns the display name of this class.
...
| [getBodyHtml()](craft-widgets-craftsupport.md#method-getbodyhtml)                                                                               | Returns the widget's body HTML.
...
| [getTitle()](craft-widgets-craftsupport.md#method-gettitle)                                                                                     | Returns the widget’s title.
...
| [icon()](craft-widgets-craftsupport.md#method-icon)                                                                                             | Returns the path to the widget’s SVG icon, or the actual SVG contents.
...
| [isSelectable()](craft-widgets-craftsupport.md#method-isselectable)                                                                             | Returns whether the component should be selectable in component Type selects.
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/CraftSupport.php#L28-L31)
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/CraftSupport.php#L69-L125)
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/CraftSupport.php#L61-L64)
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/CraftSupport.php#L53-L56)
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/CraftSupport.php#L36-L40)
...
| Method                                                                                                                                                  | Description
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [allowMultipleInstances()](craft-widgets-craftsupport.md#method-allowmultipleinstances)                                                                 | Returns whether the widget can be selected more than once.
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/CraftSupport.php#L45-L48)
