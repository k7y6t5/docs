---
title: craft\events\ElementCriteriaEvent
code:
  - php
  - twig
---

# ElementCriteriaEvent
...
:   [craft\events\ElementCriteriaEvent](craft-events-elementcriteriaevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/ElementCriteriaEvent.php)
...
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [criteria](craft-events-elementcriteriaevent.md#criteria)                                                      | [array](http://php.net/language.types.array) – The criteria that should be used to query for elements.
...
The criteria that should be used to query for elements.



[View source](https://github.com/craftcms/cms/blob/master/src/events/ElementCriteriaEvent.php#L23)
