---
title: craft\events\SetElementRouteEvent
code:
  - php
  - twig
---

# SetElementRouteEvent
...
:   [craft\events\SetElementRouteEvent](craft-events-setelementrouteevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/SetElementRouteEvent.php)
...
| [route](craft-events-setelementrouteevent.md#route)                                                            | `mixed` – The route that should be used for the element, or false if no special action should be taken
...
The route that should be used for the element, or false if no special action should be taken



[View source](https://github.com/craftcms/cms/blob/master/src/events/SetElementRouteEvent.php#L23)
