---
title: craft\events\AssetTransformEvent
code:
  - php
  - twig
---
...
:   [craft\events\AssetTransformEvent](craft-events-assettransformevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/AssetTransformEvent.php)
...
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [assetTransform](craft-events-assettransformevent.md#assettransform)                                           | [craft\models\AssetTransform](craft-models-assettransform.md), [null](http://php.net/language.types.null) – The asset transform model associated with the event.
...
| [isNew](craft-events-assettransformevent.md#isnew)                                                             | [boolean](http://php.net/language.types.boolean) – Whether the asset transform is brand new
...
The asset transform model associated with the event.



[View source](https://github.com/craftcms/cms/blob/master/src/events/AssetTransformEvent.php#L24)
...
Whether the asset transform is brand new



[View source](https://github.com/craftcms/cms/blob/master/src/events/AssetTransformEvent.php#L29)
