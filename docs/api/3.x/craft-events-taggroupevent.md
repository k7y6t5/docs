---
title: craft\events\TagGroupEvent
code:
  - php
  - twig
---
...
:   [craft\events\TagGroupEvent](craft-events-taggroupevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/TagGroupEvent.php)
...
| [isNew](craft-events-taggroupevent.md#isnew)                                                                   | [boolean](http://php.net/language.types.boolean) – Whether the tag group is brand new
...
| [tagGroup](craft-events-taggroupevent.md#taggroup)                                                             | [craft\models\TagGroup](craft-models-taggroup.md), [null](http://php.net/language.types.null) – The tag group model associated with the event.
...
Whether the tag group is brand new



[View source](https://github.com/craftcms/cms/blob/master/src/events/TagGroupEvent.php#L29)
...
The tag group model associated with the event.



[View source](https://github.com/craftcms/cms/blob/master/src/events/TagGroupEvent.php#L24)
