...
:   [craft\fields\Color](craft-fields-color.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Color.php)
...
| [contentColumnType](craft-fields-color.md#contentcolumntype)                                                                     | [string](http://php.net/language.types.string) – The column type.
...
| [defaultColor](craft-fields-color.md#defaultcolor)                                                                               | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The default color hex
...
| [elementValidationRules](craft-fields-color.md#elementvalidationrules)                                                           | [array](http://php.net/language.types.array)
...
| [settingsHtml](craft-fields-color.md#settingshtml)                                                                               | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null)
...
The default color hex



[View source](https://github.com/craftcms/cms/blob/master/src/fields/Color.php#L46)
...
| [displayName()](craft-fields-color.md#method-displayname)                                                                                       | Returns the display name of this class.
...
| [getContentColumnType()](craft-fields-color.md#method-getcontentcolumntype)                                                                     | Returns the column type that this field should get within the content table.
...
| [getElementValidationRules()](craft-fields-color.md#method-getelementvalidationrules)                                                           | Returns the validation rules for an element with this field.
...
| [getInputHtml()](craft-fields-color.md#method-getinputhtml)                                                                                     | Returns the field’s input HTML.
...
| [getSettingsHtml()](craft-fields-color.md#method-getsettingshtml)                                                                               | Returns the component’s settings HTML.
...
| [getStaticHtml()](craft-fields-color.md#method-getstatichtml)                                                                                   | Returns a static (non-editable) version of the field’s input HTML.
| [getTableAttributeHtml()](craft-fields-color.md#method-gettableattributehtml)                                                                   | Returns the HTML that should be shown for this field in Table View.
...
| [normalizeValue()](craft-fields-color.md#method-normalizevalue)                                                                                 | Normalizes the field’s value for use.
...
| [valueType()](craft-fields-color.md#method-valuetype)                                                                                           | Returns the PHPDoc type this field’s values will have.
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Color.php#L30-L33)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Color.php#L51-L54)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Color.php#L105-L110)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Color.php#L115-L123)


#### Arguments

- `$value` (`mixed`) – The field’s value. This will either be the [normalized value](craft-fields-color.md#method-normalizevalue),
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Color.php#L57-L68)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Color.php#L128-L140)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Color.php#L145-L154)
...
`entry.myFieldHandle` is called from a template, or right before [getInputHtml()](craft-fields-color.md#method-getinputhtml) is called. Whatever
this method returns is what `entry.myFieldHandle` will likewise return, and what [getInputHtml()](craft-fields-color.md#method-getinputhtml)’s and
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Color.php#L83-L100)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Color.php#L38-L41)
...
| Method                                                                                                                                                  | Description
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [defineRules()](craft-fields-color.md#method-definerules)                                                                                               | Returns the validation rules for attributes.
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Color.php#L73-L78)
