---
title: craft\fields\Lightswitch
code:
  - php
  - twig
---
...
:   [craft\fields\Lightswitch](craft-fields-lightswitch.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Lightswitch.php)
...
| [contentColumnType](craft-fields-lightswitch.md#contentcolumntype)                                                               | [string](http://php.net/language.types.string) – The column type.
| [contentGqlType](craft-fields-lightswitch.md#contentgqltype)                                                                     | `\GraphQL\Type\Definition\Type`, [array](http://php.net/language.types.array)
...
| [default](craft-fields-lightswitch.md#default)                                                                                   | [boolean](http://php.net/language.types.boolean) – Whether the lightswitch should be enabled by default
...
| [settingsHtml](craft-fields-lightswitch.md#settingshtml)                                                                         | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null)
...
Whether the lightswitch should be enabled by default



[View source](https://github.com/craftcms/cms/blob/master/src/fields/Lightswitch.php#L48)
...
| [displayName()](craft-fields-lightswitch.md#method-displayname)                                                                                 | Returns the display name of this class.
...
| [getContentColumnType()](craft-fields-lightswitch.md#method-getcontentcolumntype)                                                               | Returns the column type that this field should get within the content table.
| [getContentGqlType()](craft-fields-lightswitch.md#method-getcontentgqltype)                                                                     | Returns the GraphQL type to be used for this field type.
...
| [getInputHtml()](craft-fields-lightswitch.md#method-getinputhtml)                                                                               | Returns the field’s input HTML.
...
| [getSettingsHtml()](craft-fields-lightswitch.md#method-getsettingshtml)                                                                         | Returns the component’s settings HTML.
...
| [getTableAttributeHtml()](craft-fields-lightswitch.md#method-gettableattributehtml)                                                             | Returns the HTML that should be shown for this field in Table View.
...
| [modifyElementsQuery()](craft-fields-lightswitch.md#method-modifyelementsquery)                                                                 | Modifies an element query.
| [normalizeValue()](craft-fields-lightswitch.md#method-normalizevalue)                                                                           | Normalizes the field’s value for use.
...
| [valueType()](craft-fields-lightswitch.md#method-valuetype)                                                                                     | Returns the PHPDoc type this field’s values will have.
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Lightswitch.php#L32-L35)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Lightswitch.php#L53-L56)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Lightswitch.php#L133-L136)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Lightswitch.php#L77-L88)


#### Arguments

- `$value` (`mixed`) – The field’s value. This will either be the [normalized value](craft-fields-lightswitch.md#method-normalizevalue),
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Lightswitch.php#L61-L72)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Lightswitch.php#L93-L100)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Lightswitch.php#L118-L128)
...
`entry.myFieldHandle` is called from a template, or right before [getInputHtml()](craft-fields-lightswitch.md#method-getinputhtml) is called. Whatever
this method returns is what `entry.myFieldHandle` will likewise return, and what [getInputHtml()](craft-fields-lightswitch.md#method-getinputhtml)’s and
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Lightswitch.php#L105-L113)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Lightswitch.php#L40-L43)
