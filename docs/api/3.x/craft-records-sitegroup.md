...
:   [craft\records\SiteGroup](craft-records-sitegroup.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/SiteGroup.php)
...
| [sites](craft-records-sitegroup.md#sites)                                                                                                              | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [getSites()](craft-records-sitegroup.md#method-getsites)                                                                                                        | Returns the site group’s sites.
...
| [tableName()](craft-records-sitegroup.md#method-tablename)                                                                                                      | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/SiteGroup.php#L42-L45)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/SiteGroup.php#L32-L35)
