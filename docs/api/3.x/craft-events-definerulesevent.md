---
title: craft\events\DefineRulesEvent
code:
  - php
  - twig
---
...
:   [craft\events\DefineRulesEvent](craft-events-definerulesevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/DefineRulesEvent.php)
...
| [rules](craft-events-definerulesevent.md#rules)                                                                | [array](http://php.net/language.types.array) – The model rules
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/DefineRulesEvent.php#L23)
