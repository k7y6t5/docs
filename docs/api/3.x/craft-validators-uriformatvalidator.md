---
title: craft\validators\UriFormatValidator
code:
  - php
  - twig
---
...
:   [craft\validators\UriFormatValidator](craft-validators-uriformatvalidator.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/UriFormatValidator.php)
...
| [disallowTriggers](craft-validators-uriformatvalidator.md#disallowtriggers)                                                                                      | [boolean](http://php.net/language.types.boolean) – Whether to ensure that the URI format doesn’t begin with the actionTrigger or cpTrigger.
...
| [requireSlug](craft-validators-uriformatvalidator.md#requireslug)                                                                                                | [boolean](http://php.net/language.types.boolean) – Whether we should ensure that "{slug}" is used within the URI format.
...
Whether to ensure that the URI format doesn’t begin with the actionTrigger or cpTrigger.



[View source](https://github.com/craftcms/cms/blob/master/src/validators/UriFormatValidator.php#L31)
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/UriFormatValidator.php#L25)
...
| [validateAttribute()](craft-validators-uriformatvalidator.md#method-validateattribute)                                                                                | Validates a single attribute.
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/UriFormatValidator.php#L36-L66)
