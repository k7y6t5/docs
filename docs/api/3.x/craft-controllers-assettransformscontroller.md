---
title: craft\controllers\AssetTransformsController
code:
  - php
  - twig
---

# AssetTransformsController
...
:   [craft\controllers\AssetTransformsController](craft-controllers-assettransformscontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/AssetTransformsController.php)
...
| [actionDeleteTransform()](craft-controllers-assettransformscontroller.md#method-actiondeletetransform)                                                  | Deletes an asset transform.
| [actionEditTransform()](craft-controllers-assettransformscontroller.md#method-actionedittransform)                                                      | Edit an asset transform.
| [actionSaveTransform()](craft-controllers-assettransformscontroller.md#method-actionsavetransform)                                                      | Saves an asset transform.
| [actionTransformIndex()](craft-controllers-assettransformscontroller.md#method-actiontransformindex)                                                    | Shows the asset transform list.
...
| [init()](craft-controllers-assettransformscontroller.md#method-init)                                                                                    | Initializes the object.
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/AssetTransformsController.php#L165-L175)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/AssetTransformsController.php#L62-L89)


#### Arguments

- `$transformHandle` ([string](http://php.net/language.types.string), [null](http://php.net/language.types.null)) – The transform’s handle, if any.
- `$transform` ([craft\models\AssetTransform](craft-models-assettransform.md), [null](http://php.net/language.types.null)) – The transform being edited, if there were any validation errors.
...
- [yii\web\NotFoundHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-notfoundhttpexception)\
  if the requested transform cannot be found
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/AssetTransformsController.php#L96-L158)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/AssetTransformsController.php#L44-L52)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/AssetTransformsController.php#L31-L37)
