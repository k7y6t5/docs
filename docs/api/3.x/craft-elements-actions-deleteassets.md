---
title: craft\elements\actions\DeleteAssets
code:
  - php
  - twig
---
...
:   [craft\elements\actions\DeleteAssets](craft-elements-actions-deleteassets.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/DeleteAssets.php)
...
| [confirmationMessage](craft-elements-actions-deleteassets.md#confirmationmessage)                                                | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The confirmation message, if any.
...
| [triggerLabel](craft-elements-actions-deleteassets.md#triggerlabel)                                                              | [string](http://php.net/language.types.string) – The action’s trigger label
...
| [getConfirmationMessage()](craft-elements-actions-deleteassets.md#method-getconfirmationmessage)                                                | Returns a confirmation message that should be displayed before the action is performed.
...
| [getTriggerLabel()](craft-elements-actions-deleteassets.md#method-gettriggerlabel)                                                              | Returns the action’s trigger label.
...
| [isDestructive()](craft-elements-actions-deleteassets.md#method-isdestructive)                                                                  | Returns whether this action is destructive in nature.
...
| [performAction()](craft-elements-actions-deleteassets.md#method-performaction)                                                                  | Performs the action on any elements that match the given criteria.
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/DeleteAssets.php#L44-L47)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/DeleteAssets.php#L28-L31)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/DeleteAssets.php#L36-L39)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/DeleteAssets.php#L52-L75)
