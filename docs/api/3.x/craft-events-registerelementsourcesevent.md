---
title: craft\events\RegisterElementSourcesEvent
code:
  - php
  - twig
---

# RegisterElementSourcesEvent
...
:   [craft\events\RegisterElementSourcesEvent](craft-events-registerelementsourcesevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterElementSourcesEvent.php)
...
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [context](craft-events-registerelementsourcesevent.md#context)                                                 | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The context ('index' or 'modal').
...
| [sources](craft-events-registerelementsourcesevent.md#sources)                                                 | [array](http://php.net/language.types.array) – List of registered sources for the element type.
...
The context ('index' or 'modal').



[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterElementSourcesEvent.php#L23)
...
List of registered sources for the element type.



[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterElementSourcesEvent.php#L28)
