---
title: craft\controllers\LivePreviewController
code:
  - php
  - twig
---
...
:   [craft\controllers\LivePreviewController](craft-controllers-livepreviewcontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/LivePreviewController.php)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/LivePreviewController.php#L29)
...
| [actionCreateToken()](craft-controllers-livepreviewcontroller.md#method-actioncreatetoken)                                                              | Creates a token for Live Preview requests.
| [actionPreview()](craft-controllers-livepreviewcontroller.md#method-actionpreview)                                                                      | Renders a page for Live Preview.
...
| [beforeAction()](craft-controllers-livepreviewcontroller.md#method-beforeaction)                                                                        | This method is invoked right before an action is executed.
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/LivePreviewController.php#L52-L76)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/LivePreviewController.php#L89-L117)


#### Arguments

- `$previewAction` ([string](http://php.net/language.types.string))
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/LivePreviewController.php#L34-L42)
