---
title: craft\controllers\UtilitiesController
code:
  - php
  - twig
---
...
:   [craft\controllers\UtilitiesController](craft-controllers-utilitiescontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/UtilitiesController.php)
...
| [actionApplyNewMigrations()](craft-controllers-utilitiescontroller.md#method-actionapplynewmigrations)                                                  | Applies new migrations
| [actionAssetIndexPerformAction()](craft-controllers-utilitiescontroller.md#method-actionassetindexperformaction)                                        | Performs an Asset Index action
| [actionClearCachesPerformAction()](craft-controllers-utilitiescontroller.md#method-actionclearcachesperformaction)                                      | Performs a Clear Caches action
| [actionDbBackupPerformAction()](craft-controllers-utilitiescontroller.md#method-actiondbbackupperformaction)                                            | Performs a DB Backup action
| [actionDeleteAllDeprecationErrors()](craft-controllers-utilitiescontroller.md#method-actiondeletealldeprecationerrors)                                  | Deletes all deprecation errors.
| [actionDeleteDeprecationError()](craft-controllers-utilitiescontroller.md#method-actiondeletedeprecationerror)                                          | Deletes a deprecation error.
| [actionDownloadBackupFile()](craft-controllers-utilitiescontroller.md#method-actiondownloadbackupfile)                                                  | Returns a database backup zip file to the browser.
| [actionFindAndReplacePerformAction()](craft-controllers-utilitiescontroller.md#method-actionfindandreplaceperformaction)                                | Performs a Find And Replace action
| [actionGetDeprecationErrorTracesModal()](craft-controllers-utilitiescontroller.md#method-actiongetdeprecationerrortracesmodal)                          | View stack trace for a deprecator log entry.
| [actionIndex()](craft-controllers-utilitiescontroller.md#method-actionindex)                                                                            | Index
| [actionShowUtility()](craft-controllers-utilitiescontroller.md#method-actionshowutility)                                                                | Show a utility page.
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/UtilitiesController.php#L410-L424)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/UtilitiesController.php#L158-L264)
...
- [yii\web\ForbiddenHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-forbiddenhttpexception)\
  if the user doesn't have access to the Asset Indexes utility
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/UtilitiesController.php#L272-L309)
...
- [yii\web\ForbiddenHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-forbiddenhttpexception)\
  if the user doesn't have access to the Clear Caches utility
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/UtilitiesController.php#L318-L355)
...
- [yii\web\ForbiddenHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-forbiddenhttpexception)\
  if the user doesn't have access to the DB Backup utility
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/UtilitiesController.php#L119-L130)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/UtilitiesController.php#L138-L150)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/UtilitiesController.php#L364-L378)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/UtilitiesController.php#L386-L402)
...
- [yii\web\ForbiddenHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-forbiddenhttpexception)\
  if the user doesn't have access to the Find an Replace utility
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/UtilitiesController.php#L97-L111)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/UtilitiesController.php#L38-L55)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/UtilitiesController.php#L66-L89)
...
- [yii\web\NotFoundHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-notfoundhttpexception)\
  if $id is invalid
- [yii\web\ForbiddenHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-forbiddenhttpexception)\
  if the user doesn't have access to the requested utility
- [yii\base\Exception](https://www.yiiframework.com/doc/api/2.0/yii-base-exception)\
  in case of failure
