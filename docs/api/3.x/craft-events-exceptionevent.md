---
title: craft\events\ExceptionEvent
code:
  - php
  - twig
---
...
:   [craft\events\ExceptionEvent](craft-events-exceptionevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/ExceptionEvent.php)
...
| [exception](craft-events-exceptionevent.md#exception)                                                          | [Exception](http://php.net/class.exception) – The uncaught exception that was thrown
...
The uncaught exception that was thrown



[View source](https://github.com/craftcms/cms/blob/master/src/events/ExceptionEvent.php#L23)
