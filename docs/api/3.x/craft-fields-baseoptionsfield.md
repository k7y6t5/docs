---
title: craft\fields\BaseOptionsField
code:
  - php
  - twig
---
...
:   [craft\fields\Checkboxes](craft-fields-checkboxes.md), [craft\fields\Dropdown](craft-fields-dropdown.md), [craft\fields\MultiSelect](craft-fields-multiselect.md), [craft\fields\RadioButtons](craft-fields-radiobuttons.md)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/BaseOptionsField.php)
...
| [contentColumnType](craft-fields-baseoptionsfield.md#contentcolumntype)                                                          | [string](http://php.net/language.types.string) – The column type.
| [contentGqlType](craft-fields-baseoptionsfield.md#contentgqltype)                                                                | `\GraphQL\Type\Definition\Type`, [array](http://php.net/language.types.array)
...
| [elementValidationRules](craft-fields-baseoptionsfield.md#elementvalidationrules)                                                | [array](http://php.net/language.types.array)
...
| [isMultiOptionsField](craft-fields-baseoptionsfield.md#ismultioptionsfield)                                                      | [boolean](http://php.net/language.types.boolean)
...
| [isTranslatable](craft-base-fieldinterface.md#istranslatable "Defined by craft\base\FieldInterface")                             | [boolean](http://php.net/language.types.boolean)
...
| [options](craft-fields-baseoptionsfield.md#options)                                                                              | [array](http://php.net/language.types.array), [null](http://php.net/language.types.null) – The available options
...
| [settingsHtml](craft-fields-baseoptionsfield.md#settingshtml)                                                                    | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/BaseOptionsField.php#L37)
...
| Property                                                | Description
| ------------------------------------------------------- | -------------------------------------------------------------------------------------------------------
| [multi](craft-fields-baseoptionsfield.md#multi)         | [boolean](http://php.net/language.types.boolean) – Whether the field should support multiple selections
| [optgroups](craft-fields-baseoptionsfield.md#optgroups) | [boolean](http://php.net/language.types.boolean) – Whether the field should support optgroups
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/BaseOptionsField.php#L42)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/BaseOptionsField.php#L47)
...
| [afterElementSave()](craft-base-fieldinterface.md#method-afterelementsave "Defined by craft\base\FieldInterface")                               | Performs actions after the element has been saved.
...
| [getContentColumnType()](craft-fields-baseoptionsfield.md#method-getcontentcolumntype)                                                          | Returns the column type that this field should get within the content table.
| [getContentGqlType()](craft-fields-baseoptionsfield.md#method-getcontentgqltype)                                                                | Returns the GraphQL type to be used for this field type.
...
| [getElementValidationRules()](craft-fields-baseoptionsfield.md#method-getelementvalidationrules)                                                | Returns the validation rules for an element with this field.
...
| [getInputHtml()](craft-base-fieldinterface.md#method-getinputhtml "Defined by craft\base\FieldInterface")                                       | Returns the field’s input HTML.
| [getIsMultiOptionsField()](craft-fields-baseoptionsfield.md#method-getismultioptionsfield)                                                      | Returns whether the field type supports storing multiple selected options.
...
| [getIsTranslatable()](craft-base-fieldinterface.md#method-getistranslatable "Defined by craft\base\FieldInterface")                             | Returns whether the field should be shown as translatable in the UI.
| [getIterator()](https://www.yiiframework.com/doc/api/2.0/yii-base-model#getIterator()-detail "Defined by yii\base\Model")                       | Returns an iterator for traversing the attributes in the model.
| [getScenario()](https://www.yiiframework.com/doc/api/2.0/yii-base-model#getScenario()-detail "Defined by yii\base\Model")                       | Returns the scenario that this model is used in.
| [getSearchKeywords()](craft-base-fieldinterface.md#method-getsearchkeywords "Defined by craft\base\FieldInterface")                             | Returns the search keywords that should be associated with this field.
...
| [getSettingsHtml()](craft-fields-baseoptionsfield.md#method-getsettingshtml)                                                                    | Returns the component’s settings HTML.
...
| [getStaticHtml()](craft-base-fieldinterface.md#method-getstatichtml "Defined by craft\base\FieldInterface")                                     | Returns a static (non-editable) version of the field’s input HTML.
| [getTableAttributeHtml()](craft-fields-baseoptionsfield.md#method-gettableattributehtml)                                                        | Returns the HTML that should be shown for this field in Table View.
...
| [hasContentColumn()](craft-base-fieldinterface.md#method-hascontentcolumn "Defined by craft\base\FieldInterface")                               | Returns whether this field has a column in the content table.
...
| [init()](craft-fields-baseoptionsfield.md#method-init)                                                                                          | Initializes the object.
...
| [isValueEmpty()](craft-fields-baseoptionsfield.md#method-isvalueempty)                                                                          | Returns whether the given value should be considered “empty” to a validator.
| [load()](https://www.yiiframework.com/doc/api/2.0/yii-base-model#load()-detail "Defined by yii\base\Model")                                     | Populates the model with input data.
| [loadMultiple()](https://www.yiiframework.com/doc/api/2.0/yii-base-model#loadMultiple()-detail "Defined by yii\base\Model")                     | Populates a set of models with the data from end user.
| [modifyElementIndexQuery()](craft-base-fieldinterface.md#method-modifyelementindexquery "Defined by craft\base\FieldInterface")                 | Modifies an element index query.
| [modifyElementsQuery()](craft-fields-baseoptionsfield.md#method-modifyelementsquery)                                                            | Modifies an element query.
| [normalizeValue()](craft-fields-baseoptionsfield.md#method-normalizevalue)                                                                      | Normalizes the field’s value for use.
...
| [serializeValue()](craft-fields-baseoptionsfield.md#method-serializevalue)                                                                      | Prepares the field’s value to be stored somewhere, like the content table or JSON-encoded in an entry revision table.
...
| [settingsAttributes()](craft-fields-baseoptionsfield.md#method-settingsattributes)                                                              | Returns the list of settings attribute names.
| [supportedTranslationMethods()](craft-base-fieldinterface.md#method-supportedtranslationmethods "Defined by craft\base\FieldInterface")         | Returns which translation methods the field supports.
...
| [validateOptions()](craft-fields-baseoptionsfield.md#method-validateoptions)                                                                    | Validates the field options.
| [valueType()](craft-base-fieldinterface.md#method-valuetype "Defined by craft\base\FieldInterface")                                             | Returns the PHPDoc type this field’s values will have.
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/BaseOptionsField.php#L154-L172)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/BaseOptionsField.php#L411-L419)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/BaseOptionsField.php#L346-L361)
...
See also [multi](craft-fields-baseoptionsfield.md#multi)
[View source](https://github.com/craftcms/cms/blob/master/src/fields/BaseOptionsField.php#L402-L405)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/BaseOptionsField.php#L177-L232)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/BaseOptionsField.php#L379-L394)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/BaseOptionsField.php#L52-L81)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/BaseOptionsField.php#L366-L374)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/BaseOptionsField.php#L323-L341)
...
[serializeValue()](craft-fields-baseoptionsfield.md#method-serializevalue)’s $value arguments will be set to.
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/BaseOptionsField.php#L237-L300)
...
Whatever this returns should be something [normalizeValue()](craft-fields-baseoptionsfield.md#method-normalizevalue) can handle.




[View source](https://github.com/craftcms/cms/blob/master/src/fields/BaseOptionsField.php#L305-L317)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/BaseOptionsField.php#L86-L92)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/BaseOptionsField.php#L109-L149)
...
| Method                                                                                                                                                  | Description
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [defaultValue()](craft-fields-baseoptionsfield.md#method-defaultvalue)                                                                                  | Returns the default field value.
| [defineRules()](craft-fields-baseoptionsfield.md#method-definerules)                                                                                    | Returns the validation rules for attributes.
...
| [optionLabel()](craft-fields-baseoptionsfield.md#method-optionlabel)                                                                                    | Returns an option's label by its value.
| [options()](craft-fields-baseoptionsfield.md#method-options)                                                                                            | Returns the available options (and optgroups) for the field.
| [optionsSettingLabel()](craft-fields-baseoptionsfield.md#method-optionssettinglabel)                                                                    | Returns the label for the Options setting.
...
| [translatedOptions()](craft-fields-baseoptionsfield.md#method-translatedoptions)                                                                        | Returns the field options, with labels run through Craft::t().
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/BaseOptionsField.php#L504-L525)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/BaseOptionsField.php#L97-L102)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/BaseOptionsField.php#L488-L497)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/BaseOptionsField.php#L451-L454)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/BaseOptionsField.php#L426)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/BaseOptionsField.php#L461-L479)
