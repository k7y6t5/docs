---
title: craft\gql\resolvers\elements\Tag
code:
  - php
  - twig
---
...
:   [craft\gql\resolvers\elements\Tag](craft-gql-resolvers-elements-tag.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/gql/resolvers/elements/Tag.php)
...
| [prepareQuery()](craft-gql-resolvers-elements-tag.md#method-preparequery)                                               | Prepare an element Query based on the source, arguments and the field name on the source.
...
[View source](https://github.com/craftcms/cms/blob/master/src/gql/resolvers/elements/Tag.php#L27-L55)
