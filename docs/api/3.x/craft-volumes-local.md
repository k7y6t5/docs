...
:   [craft\volumes\Local](craft-volumes-local.md) &raquo;
...
:   [ArrayAccess](http://php.net/class.arrayaccess), [IteratorAggregate](http://php.net/class.iteratoraggregate), [craft\base\ComponentInterface](craft-base-componentinterface.md), [craft\base\LocalVolumeInterface](craft-base-localvolumeinterface.md), [craft\base\SavableComponentInterface](craft-base-savablecomponentinterface.md), [craft\base\VolumeInterface](craft-base-volumeinterface.md), [yii\base\Arrayable](https://www.yiiframework.com/doc/api/2.0/yii-base-arrayable), [yii\base\Configurable](https://www.yiiframework.com/doc/api/2.0/yii-base-configurable), [yii\base\StaticInstanceInterface](https://www.yiiframework.com/doc/api/2.0/yii-base-staticinstanceinterface)
...
[View source](https://github.com/craftcms/cms/blob/master/src/volumes/Local.php)
...
| [path](craft-volumes-local.md#path)                                                                                              | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – Path to the root of this sources local folder.
| [rootPath](craft-volumes-local.md#rootpath)                                                                                      | [string](http://php.net/language.types.string) – The root path for the volume
...
| [settingsHtml](craft-volumes-local.md#settingshtml)                                                                              | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null)
...
[View source](https://github.com/craftcms/cms/blob/master/src/volumes/Local.php#L40)
...
| Property                                                                                                                       | Description
| ------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------
| [foldersHaveTrailingSlashes](craft-base-flysystemvolume.md#foldershavetrailingslashes "Defined by craft\base\FlysystemVolume") | [boolean](http://php.net/language.types.boolean) – Whether the Flysystem adapter expects folder names to have trailing slashes
...
| [afterSave()](craft-volumes-local.md#method-aftersave)                                                                                          | Performs actions after a component is saved.
...
| [copyFile()](craft-base-flysystemvolume.md#method-copyfile "Defined by craft\base\FlysystemVolume")                                             | Copies a file.
| [createDir()](craft-base-flysystemvolume.md#method-createdir "Defined by craft\base\FlysystemVolume")                                           | Creates a directory.
| [createFileByStream()](craft-base-flysystemvolume.md#method-createfilebystream "Defined by craft\base\FlysystemVolume")                         | Creates a file.
...
| [deleteDir()](craft-base-flysystemvolume.md#method-deletedir "Defined by craft\base\FlysystemVolume")                                           | Deletes a directory.
| [deleteFile()](craft-base-flysystemvolume.md#method-deletefile "Defined by craft\base\FlysystemVolume")                                         | Deletes a file.
| [detachBehavior()](https://www.yiiframework.com/doc/api/2.0/yii-base-component#detachBehavior()-detail "Defined by yii\base\Component")         | Detaches a behavior from the component.
| [detachBehaviors()](https://www.yiiframework.com/doc/api/2.0/yii-base-component#detachBehaviors()-detail "Defined by yii\base\Component")       | Detaches all behaviors from the component.
| [displayName()](craft-volumes-local.md#method-displayname)                                                                                      | Returns the display name of this class.
...
| [fileExists()](craft-base-flysystemvolume.md#method-fileexists "Defined by craft\base\FlysystemVolume")                                         | Returns whether a file exists.
| [folderExists()](craft-base-flysystemvolume.md#method-folderexists "Defined by craft\base\FlysystemVolume")                                     | Returns whether a folder exists at the given path.
...
| [getFileList()](craft-base-flysystemvolume.md#method-getfilelist "Defined by craft\base\FlysystemVolume")                                       | List files.
| [getFileMetadata()](craft-base-flysystemvolume.md#method-getfilemetadata "Defined by craft\base\FlysystemVolume")                               | Return the metadata about a file.
| [getFileStream()](craft-base-flysystemvolume.md#method-getfilestream "Defined by craft\base\FlysystemVolume")                                   | Gets a stream ready for reading by a file's URI.
...
| [getRootPath()](craft-volumes-local.md#method-getrootpath)                                                                                      | Returns the root path for the volume.
...
| [getSettingsHtml()](craft-volumes-local.md#method-getsettingshtml)                                                                              | Returns the component’s settings HTML.
...
| [init()](craft-volumes-local.md#method-init)                                                                                                    | Initializes the object.
...
| [renameDir()](craft-volumes-local.md#method-renamedir)                                                                                          | Renames a directory.
| [renameFile()](craft-base-flysystemvolume.md#method-renamefile "Defined by craft\base\FlysystemVolume")                                         | Renames a file.
...
| [saveFileLocally()](craft-base-flysystemvolume.md#method-savefilelocally "Defined by craft\base\FlysystemVolume")                               | Save a file from the source's uriPath to a local target path.
...
| [updateFileByStream()](craft-base-flysystemvolume.md#method-updatefilebystream "Defined by craft\base\FlysystemVolume")                         | Updates a file.
...
[View source](https://github.com/craftcms/cms/blob/master/src/volumes/Local.php#L79-L89)
...
[View source](https://github.com/craftcms/cms/blob/master/src/volumes/Local.php#L32-L35)
...
[View source](https://github.com/craftcms/cms/blob/master/src/volumes/Local.php#L94-L97)
...
[View source](https://github.com/craftcms/cms/blob/master/src/volumes/Local.php#L67-L73)
...
[View source](https://github.com/craftcms/cms/blob/master/src/volumes/Local.php#L45-L52)
...
[View source](https://github.com/craftcms/cms/blob/master/src/volumes/Local.php#L102-L116)
...
| Method                                                                                                                                                  | Description
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [adapter()](craft-base-flysystemvolume.md#method-adapter "Defined by craft\base\FlysystemVolume")                                                       | Returns the Flysystem adapter instance.
| [addFileMetadataToConfig()](craft-base-flysystemvolume.md#method-addfilemetadatatoconfig "Defined by craft\base\FlysystemVolume")                       | Adds file metadata to the config array.
| [createAdapter()](craft-volumes-local.md#method-createadapter)                                                                                          | Creates and returns a Flysystem adapter instance based on the stored settings.
| [defineRules()](craft-volumes-local.md#method-definerules)                                                                                              | Returns the validation rules for attributes.
| [extractFieldsFor()](https://www.yiiframework.com/doc/api/2.0/yii-base-arrayabletrait#extractFieldsFor()-detail "Defined by yii\base\ArrayableTrait")   | Extract nested fields from a fields collection for a given root field Nested fields are separated with dots (.). e.g: "item.id" The previous example would extract "id".
| [extractRootFields()](https://www.yiiframework.com/doc/api/2.0/yii-base-arrayabletrait#extractRootFields()-detail "Defined by yii\base\ArrayableTrait") | Extracts the root field names from nested fields.
| [filesystem()](craft-base-flysystemvolume.md#method-filesystem "Defined by craft\base\FlysystemVolume")                                                 | Returns Flysystem filesystem configured with the Flysystem adapter.
| [invalidateCdnPath()](craft-base-flysystemvolume.md#method-invalidatecdnpath "Defined by craft\base\FlysystemVolume")                                   | Invalidate a CDN path on the Volume.
| [resolveFields()](https://www.yiiframework.com/doc/api/2.0/yii-base-arrayabletrait#resolveFields()-detail "Defined by yii\base\ArrayableTrait")         | Determines which fields can be returned by [toArray()](https://www.yiiframework.com/doc/api/2.0/yii-base-arrayabletrait#toArray()-detail).
| [visibility()](craft-base-flysystemvolume.md#method-visibility "Defined by craft\base\FlysystemVolume")                                                 | Returns the visibility setting for the Volume.
...
[View source](https://github.com/craftcms/cms/blob/master/src/volumes/Local.php#L122-L134)



#### Returns

`\League\Flysystem\Adapter\Local` – The Flysystem adapter.
...
[View source](https://github.com/craftcms/cms/blob/master/src/volumes/Local.php#L57-L62)
