---
title: craft\widgets\RecentEntries
code:
  - php
  - twig
---
...
:   [craft\widgets\RecentEntries](craft-widgets-recententries.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/RecentEntries.php)
...
| [bodyHtml](craft-widgets-recententries.md#bodyhtml)                                                                              | [string](http://php.net/language.types.string), [false](http://php.net/language.types.boolean) – The widget’s body HTML, or `false` if the widget should not be visible.
...
| [limit](craft-widgets-recententries.md#limit)                                                                                    | [integer](http://php.net/language.types.integer) – The total number of entries that the widget should show
| [scenario](https://www.yiiframework.com/doc/api/2.0/yii-base-model#$scenario-detail "Defined by yii\base\Model")                 | [string](http://php.net/language.types.string) – The scenario that this model is in.
| [section](craft-widgets-recententries.md#section)                                                                                | [string](http://php.net/language.types.string), [integer](http://php.net/language.types.integer)[] – The section IDs that the widget should pull entries from
...
| [settingsHtml](craft-widgets-recententries.md#settingshtml)                                                                      | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null)
| [siteId](craft-widgets-recententries.md#siteid)                                                                                  | [string](http://php.net/language.types.string) – The site ID that the widget should pull entries from
...
| [title](craft-widgets-recententries.md#title)                                                                                    | [string](http://php.net/language.types.string) – The widget’s title.
...
The total number of entries that the widget should show



[View source](https://github.com/craftcms/cms/blob/master/src/widgets/RecentEntries.php#L54)
...
:   [string](http://php.net/language.types.string), [integer](http://php.net/language.types.integer)[]



The section IDs that the widget should pull entries from



[View source](https://github.com/craftcms/cms/blob/master/src/widgets/RecentEntries.php#L44)
...
The site ID that the widget should pull entries from



[View source](https://github.com/craftcms/cms/blob/master/src/widgets/RecentEntries.php#L49)
...
| [displayName()](craft-widgets-recententries.md#method-displayname)                                                                              | Returns the display name of this class.
...
| [getBodyHtml()](craft-widgets-recententries.md#method-getbodyhtml)                                                                              | Returns the widget's body HTML.
...
| [getSettingsHtml()](craft-widgets-recententries.md#method-getsettingshtml)                                                                      | Returns the component’s settings HTML.
| [getSubtitle()](craft-base-widget.md#method-getsubtitle "Defined by craft\base\Widget")                                                         | Returns the widget’s subtitle.
| [getTitle()](craft-widgets-recententries.md#method-gettitle)                                                                                    | Returns the widget’s title.
...
| [icon()](craft-widgets-recententries.md#method-icon)                                                                                            | Returns the path to the widget’s SVG icon, or the actual SVG contents.
| [iconPath()](craft-base-widget.md#method-iconpath "Defined by craft\base\Widget")                                                               | Returns the path to the widget’s SVG icon.
| [init()](craft-widgets-recententries.md#method-init)                                                                                            | Initializes the object.
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/RecentEntries.php#L28-L31)
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/RecentEntries.php#L129-L149)
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/RecentEntries.php#L81-L87)
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/RecentEntries.php#L92-L124)
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/RecentEntries.php#L36-L39)
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/RecentEntries.php#L59-L66)
...
| [defineRules()](craft-widgets-recententries.md#method-definerules)                                                                                      | Returns the validation rules for attributes.
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/RecentEntries.php#L71-L76)
