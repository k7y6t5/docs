---
title: craft\controllers\BaseElementsController
code:
  - php
  - twig
---
...
:   [craft\controllers\ElementIndexSettingsController](craft-controllers-elementindexsettingscontroller.md), [craft\controllers\ElementIndexesController](craft-controllers-elementindexescontroller.md), [craft\controllers\ElementsController](craft-controllers-elementscontroller.md)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/BaseElementsController.php)
...
| [init()](craft-controllers-baseelementscontroller.md#method-init)                                                                                       | Initializes the application component.
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/BaseElementsController.php#L30-L34)
...
| Method                                                                          | Description
| ------------------------------------------------------------------------------- | ------------------------------------------------------------
| [context()](craft-controllers-baseelementscontroller.md#method-context)         | Returns the context that this controller is being called in.
| [elementType()](craft-controllers-baseelementscontroller.md#method-elementtype) | Returns the posted element type class.
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/BaseElementsController.php#L63-L66)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/BaseElementsController.php#L42-L56)
...
- [yii\web\BadRequestHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-badrequesthttpexception)\
  if the requested element type is invalid
