---
title: craft\events\GlobalSetEvent
code:
  - php
  - twig
---
...
:   [craft\events\GlobalSetEvent](craft-events-globalsetevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/GlobalSetEvent.php)
...
| [globalSet](craft-events-globalsetevent.md#globalset)                                                          | [craft\elements\GlobalSet](craft-elements-globalset.md), [null](http://php.net/language.types.null) – The global set model associated with the event.
...
| [isNew](craft-events-globalsetevent.md#isnew)                                                                  | [boolean](http://php.net/language.types.boolean) – Whether the global set is brand new
...
The global set model associated with the event.



[View source](https://github.com/craftcms/cms/blob/master/src/events/GlobalSetEvent.php#L24)
...
Whether the global set is brand new



[View source](https://github.com/craftcms/cms/blob/master/src/events/GlobalSetEvent.php#L29)
