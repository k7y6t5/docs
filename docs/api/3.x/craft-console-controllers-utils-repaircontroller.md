---
title: craft\console\controllers\utils\RepairController
code:
  - php
  - twig
---
...
:   [craft\console\controllers\utils\RepairController](craft-console-controllers-utils-repaircontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/utils/RepairController.php)
...
| [dryRun](craft-console-controllers-utils-repaircontroller.md#dryrun)                                                                                 | [boolean](http://php.net/language.types.boolean) – Whether to only do a dry run of the repair process
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/utils/RepairController.php#L36)
...
| [actionCategoryGroupStructure()](craft-console-controllers-utils-repaircontroller.md#method-actioncategorygroupstructure)                                     | Repairs structure data for a category group
| [actionProjectConfig()](craft-console-controllers-utils-repaircontroller.md#method-actionprojectconfig)                                                       | Repairs double-packed associative arrays in the project config.
| [actionSectionStructure()](craft-console-controllers-utils-repaircontroller.md#method-actionsectionstructure)                                                 | Repairs structure data for a section
...
| [options()](craft-console-controllers-utils-repaircontroller.md#method-options)                                                                               | Returns the names of valid options for the action (id) An option requires the existence of a public member variable whose name is the option name.
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/utils/RepairController.php#L77-L87)


#### Arguments

- `$handle` ([string](http://php.net/language.types.string)) – The category group handle
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/utils/RepairController.php#L236-L247)
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/utils/RepairController.php#L54-L69)


#### Arguments

- `$handle` ([string](http://php.net/language.types.string)) – The section handle
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/utils/RepairController.php#L41-L46)
...
| [repairStructure()](craft-console-controllers-utils-repaircontroller.md#method-repairstructure)                                                                 | Repairs the structure for elements that match the given element query.
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/utils/RepairController.php#L96-L229)


#### Arguments

- `$structureId` ([integer](http://php.net/language.types.integer))
- `$query` ([craft\elements\db\ElementQuery](craft-elements-db-elementquery.md))
