---
title: craft\records\MatrixBlockType
code:
  - php
  - twig
---
...
:   [craft\records\MatrixBlockType](craft-records-matrixblocktype.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/MatrixBlockType.php)
...
| [field](craft-records-matrixblocktype.md#field)                                                                                                        | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
| [fieldLayout](craft-records-matrixblocktype.md#fieldlayout)                                                                                            | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [validateUniques](craft-records-matrixblocktype.md#validateuniques)                                                                                    | [boolean](http://php.net/language.types.boolean) – Whether the Name and Handle attributes should validated to ensure they’re unique.
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/MatrixBlockType.php#L34)
...
| [getField()](craft-records-matrixblocktype.md#method-getfield)                                                                                                  | Returns the matrix block type’s field.
| [getFieldLayout()](craft-records-matrixblocktype.md#method-getfieldlayout)                                                                                      | Returns the matrix block type’s fieldLayout.
...
| [rules()](craft-records-matrixblocktype.md#method-rules)                                                                                                        | Returns the validation rules for attributes.
...
| [tableName()](craft-records-matrixblocktype.md#method-tablename)                                                                                                | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/MatrixBlockType.php#L74-L77)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/MatrixBlockType.php#L84-L87)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/MatrixBlockType.php#L39-L58)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/MatrixBlockType.php#L64-L67)
