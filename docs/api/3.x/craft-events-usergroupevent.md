---
title: craft\events\UserGroupEvent
code:
  - php
  - twig
---
...
:   [craft\events\UserGroupEvent](craft-events-usergroupevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/UserGroupEvent.php)
...
| [isNew](craft-events-usergroupevent.md#isnew)                                                                  | [boolean](http://php.net/language.types.boolean) – Whether the user group is brand new
...
| [userGroup](craft-events-usergroupevent.md#usergroup)                                                          | [craft\models\UserGroup](craft-models-usergroup.md), [null](http://php.net/language.types.null) – The user group associated with this event
...
Whether the user group is brand new



[View source](https://github.com/craftcms/cms/blob/master/src/events/UserGroupEvent.php#L29)
...
The user group associated with this event



[View source](https://github.com/craftcms/cms/blob/master/src/events/UserGroupEvent.php#L24)
