---
title: craft\records\UserPermission_User
code:
  - php
  - twig
---
...
:   [craft\records\UserPermission_User](craft-records-userpermission_user.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/UserPermission_User.php)
...
| [permission](craft-records-userpermission_user.md#permission)                                                                                          | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [user](craft-records-userpermission_user.md#user)                                                                                                      | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [getPermission()](craft-records-userpermission_user.md#method-getpermission)                                                                                    | Returns the user permission user’s permission.
...
| [getUser()](craft-records-userpermission_user.md#method-getuser)                                                                                                | Returns the user permission user’s user.
...
| [rules()](craft-records-userpermission_user.md#method-rules)                                                                                                    | Returns the validation rules for attributes.
...
| [tableName()](craft-records-userpermission_user.md#method-tablename)                                                                                            | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/UserPermission_User.php#L51-L55)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/UserPermission_User.php#L62-L65)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/UserPermission_User.php#L30-L35)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/UserPermission_User.php#L41-L44)
