---
title: craft\events\RegisterElementDefaultTableAttributesEvent
code:
  - php
  - twig
---

# RegisterElementDefaultTableAttributesEvent
...
:   [craft\events\RegisterElementDefaultTableAttributesEvent](craft-events-registerelementdefaulttableattributesevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterElementDefaultTableAttributesEvent.php)
...
| [source](craft-events-registerelementdefaulttableattributesevent.md#source)                                    | [string](http://php.net/language.types.string) – The selected source’s key
| [tableAttributes](craft-events-registerelementdefaulttableattributesevent.md#tableattributes)                  | [string](http://php.net/language.types.string)[] – List of registered default table attributes for the element type.
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterElementDefaultTableAttributesEvent.php#L23)
...
List of registered default table attributes for the element type.



[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterElementDefaultTableAttributesEvent.php#L28)
