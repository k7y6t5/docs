---
title: craft\web\assets\sites\SitesAsset
code:
  - php
  - twig
---
...
:   craft\web\assets\sites

Inherits

:   [craft\web\assets\sites\SitesAsset](craft-web-assets-sites-sitesasset.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/sites/SitesAsset.php)
...
| [init()](craft-web-assets-sites-sitesasset.md#method-init)                                                                                        | Initializes the bundle.
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/sites/SitesAsset.php#L21-L34)
