---
title: craft\events\SearchEvent
code:
  - php
  - twig
---
...
:   [craft\events\SearchEvent](craft-events-searchevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/SearchEvent.php)
...
| [elementIds](craft-events-searchevent.md#elementids)                                                           | [integer](http://php.net/language.types.integer)[] – The list of element IDs to filter by the search query, or the filtered list of element IDs, depending on if this is a beforeSearch or `afterSearch` event
...
| [query](craft-events-searchevent.md#query)                                                                     | [craft\search\SearchQuery](craft-search-searchquery.md), [null](http://php.net/language.types.null) – The search query
...
| [siteId](craft-events-searchevent.md#siteid)                                                                   | [integer](http://php.net/language.types.integer), [integer](http://php.net/language.types.integer)[], [null](http://php.net/language.types.null) – The site ID(s) to filter by
...
The list of element IDs to filter by the search query, or the
filtered list of element IDs, depending on if this is a beforeSearch or
`afterSearch` event



[View source](https://github.com/craftcms/cms/blob/master/src/events/SearchEvent.php#L26)
...
:   [craft\search\SearchQuery](craft-search-searchquery.md), [null](http://php.net/language.types.null)
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/SearchEvent.php#L31)
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/SearchEvent.php#L36)
