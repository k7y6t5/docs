---
title: craft\web\assets\systemmessages\SystemMessagesAsset
code:
  - php
  - twig
---
...
:   craft\web\assets\systemmessages

Inherits

:   [craft\web\assets\systemmessages\SystemMessagesAsset](craft-web-assets-systemmessages-systemmessagesasset.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/systemmessages/SystemMessagesAsset.php)
...
| [init()](craft-web-assets-systemmessages-systemmessagesasset.md#method-init)                                                              | Initializes the bundle.
...
| [registerAssetFiles()](craft-web-assets-systemmessages-systemmessagesasset.md#method-registerassetfiles)                                  | Registers the CSS and JS files with the given view.
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/systemmessages/SystemMessagesAsset.php#L22-L39)
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/systemmessages/SystemMessagesAsset.php#L44-L54)
