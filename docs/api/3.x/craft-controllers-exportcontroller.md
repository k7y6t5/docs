---
title: craft\controllers\ExportController
code:
  - php
  - twig
---
...
:   [craft\controllers\ExportController](craft-controllers-exportcontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/ExportController.php)
...
| [defaultAction](craft-controllers-exportcontroller.md#defaultaction)                                                                             | [string](http://php.net/language.types.string) – The ID of the action that is used when the action ID is not specified in the request.
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/ExportController.php#L30)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/ExportController.php#L35)
...
| [actionExport()](craft-controllers-exportcontroller.md#method-actionexport)                                                                             | Exports element data.
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/ExportController.php#L48-L93)
...
- `$exporter` ([string](http://php.net/language.types.string))
- `$format` ([string](http://php.net/language.types.string))
