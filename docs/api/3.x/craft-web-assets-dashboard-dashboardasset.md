---
title: craft\web\assets\dashboard\DashboardAsset
code:
  - php
  - twig
---
...
:   craft\web\assets\dashboard

Inherits

:   [craft\web\assets\dashboard\DashboardAsset](craft-web-assets-dashboard-dashboardasset.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/dashboard/DashboardAsset.php)
...
| [init()](craft-web-assets-dashboard-dashboardasset.md#method-init)                                                                        | Initializes the bundle.
...
| [registerAssetFiles()](craft-web-assets-dashboard-dashboardasset.md#method-registerassetfiles)                                            | Registers the CSS and JS files with the given view.
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/dashboard/DashboardAsset.php#L22-L39)
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/dashboard/DashboardAsset.php#L44-L57)
