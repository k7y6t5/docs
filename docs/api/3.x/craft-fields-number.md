...
:   [craft\fields\Number](craft-fields-number.md) &raquo;
...
:   [ArrayAccess](http://php.net/class.arrayaccess), [IteratorAggregate](http://php.net/class.iteratoraggregate), [craft\base\ComponentInterface](craft-base-componentinterface.md), [craft\base\FieldInterface](craft-base-fieldinterface.md), [craft\base\PreviewableFieldInterface](craft-base-previewablefieldinterface.md), [craft\base\SavableComponentInterface](craft-base-savablecomponentinterface.md), [craft\base\SortableFieldInterface](craft-base-sortablefieldinterface.md), [yii\base\Arrayable](https://www.yiiframework.com/doc/api/2.0/yii-base-arrayable), [yii\base\Configurable](https://www.yiiframework.com/doc/api/2.0/yii-base-configurable), [yii\base\StaticInstanceInterface](https://www.yiiframework.com/doc/api/2.0/yii-base-staticinstanceinterface)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Number.php)
...
| [contentColumnType](craft-fields-number.md#contentcolumntype)                                                                    | [string](http://php.net/language.types.string) – The column type.
| [contentGqlType](craft-fields-number.md#contentgqltype)                                                                          | `\GraphQL\Type\Definition\Type`, [array](http://php.net/language.types.array)
...
| [decimals](craft-fields-number.md#decimals)                                                                                      | [integer](http://php.net/language.types.integer) – The number of digits allowed after the decimal point
| [defaultValue](craft-fields-number.md#defaultvalue)                                                                              | [integer](http://php.net/language.types.integer), [float](http://php.net/language.types.float), [null](http://php.net/language.types.null) – The default value for new elements
...
| [elementValidationRules](craft-fields-number.md#elementvalidationrules)                                                          | [array](http://php.net/language.types.array)
...
| [max](craft-fields-number.md#max)                                                                                                | [integer](http://php.net/language.types.integer), [float](http://php.net/language.types.float), [null](http://php.net/language.types.null) – The maximum allowed number
| [min](craft-fields-number.md#min)                                                                                                | [integer](http://php.net/language.types.integer), [float](http://php.net/language.types.float) – The minimum allowed number
...
| [prefix](craft-fields-number.md#prefix)                                                                                          | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – Text that should be displayed before the input
...
| [settingsHtml](craft-fields-number.md#settingshtml)                                                                              | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null)
| [size](craft-fields-number.md#size)                                                                                              | [integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null) – The size of the field
...
| [suffix](craft-fields-number.md#suffix)                                                                                          | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – Text that should be displayed after the input
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Number.php#L62)
...
The default value for new elements



[View source](https://github.com/craftcms/cms/blob/master/src/fields/Number.php#L47)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Number.php#L57)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Number.php#L52)
...
Text that should be displayed before the input



[View source](https://github.com/craftcms/cms/blob/master/src/fields/Number.php#L72)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Number.php#L67)
...
Text that should be displayed after the input



[View source](https://github.com/craftcms/cms/blob/master/src/fields/Number.php#L77)
...
| [__construct()](craft-fields-number.md#method-construct)                                                                                        | Constructor.
...
| [displayName()](craft-fields-number.md#method-displayname)                                                                                      | Returns the display name of this class.
...
| [getContentColumnType()](craft-fields-number.md#method-getcontentcolumntype)                                                                    | Returns the column type that this field should get within the content table.
| [getContentGqlType()](craft-fields-number.md#method-getcontentgqltype)                                                                          | Returns the GraphQL type to be used for this field type.
...
| [getElementValidationRules()](craft-fields-number.md#method-getelementvalidationrules)                                                          | Returns the validation rules for an element with this field.
...
| [getInputHtml()](craft-fields-number.md#method-getinputhtml)                                                                                    | Returns the field’s input HTML.
...
| [getSettingsHtml()](craft-fields-number.md#method-getsettingshtml)                                                                              | Returns the component’s settings HTML.
...
| [getTableAttributeHtml()](craft-fields-number.md#method-gettableattributehtml)                                                                  | Returns the HTML that should be shown for this field in Table View.
...
| [init()](craft-fields-number.md#method-init)                                                                                                    | Initializes the object.
...
| [normalizeValue()](craft-fields-number.md#method-normalizevalue)                                                                                | Normalizes the field’s value for use.
...
| [valueType()](craft-fields-number.md#method-valuetype)                                                                                          | Returns the PHPDoc type this field’s values will have.
...
- Call [init()](craft-fields-number.md#method-init).
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Number.php#L83-L93)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Number.php#L31-L34)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Number.php#L164-L167)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Number.php#L248-L251)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Number.php#L226-L231)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Number.php#L205-L221)


#### Arguments

- `$value` (`mixed`) – The field’s value. This will either be the [normalized value](craft-fields-number.md#method-normalizevalue),
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Number.php#L153-L159)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Number.php#L236-L243)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Number.php#L98-L126)
...
`entry.myFieldHandle` is called from a template, or right before [getInputHtml()](craft-fields-number.md#method-getinputhtml) is called. Whatever
this method returns is what `entry.myFieldHandle` will likewise return, and what [getInputHtml()](craft-fields-number.md#method-getinputhtml)’s and
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Number.php#L172-L200)
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Number.php#L39-L42)
...
| Method                                                                                                                                                  | Description
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [defineRules()](craft-fields-number.md#method-definerules)                                                                                              | Returns the validation rules for attributes.
...
[View source](https://github.com/craftcms/cms/blob/master/src/fields/Number.php#L131-L148)
