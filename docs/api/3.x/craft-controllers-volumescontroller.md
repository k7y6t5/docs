---
title: craft\controllers\VolumesController
code:
  - php
  - twig
---
...
:   [craft\controllers\VolumesController](craft-controllers-volumescontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/VolumesController.php)
...
| [actionDeleteVolume()](craft-controllers-volumescontroller.md#method-actiondeletevolume)                                                                | Deletes an asset volume.
| [actionEditVolume()](craft-controllers-volumescontroller.md#method-actioneditvolume)                                                                    | Edit an asset volume.
| [actionReorderVolumes()](craft-controllers-volumescontroller.md#method-actionreordervolumes)                                                            | Reorders asset volumes.
| [actionSaveVolume()](craft-controllers-volumescontroller.md#method-actionsavevolume)                                                                    | Saves an asset volume.
| [actionVolumeIndex()](craft-controllers-volumescontroller.md#method-actionvolumeindex)                                                                  | Shows the asset volume list.
...
| [init()](craft-controllers-volumescontroller.md#method-init)                                                                                            | Initializes the object.
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/VolumesController.php#L247-L257)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/VolumesController.php#L67-L164)


#### Arguments

- `$volumeId` ([integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null)) – The volume’s ID, if editing an existing volume.
- `$volume` ([craft\base\VolumeInterface](craft-base-volumeinterface.md), [null](http://php.net/language.types.null)) – The volume being edited, if there were any validation errors.
...
- [yii\web\NotFoundHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-notfoundhttpexception)\
  if the requested volume cannot be found
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/VolumesController.php#L231-L240)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/VolumesController.php#L171-L224)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/VolumesController.php#L50-L56)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/VolumesController.php#L37-L43)
