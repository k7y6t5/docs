---
title: craft\elements\db\TagQuery
code:
  - php
  - twig
---
...
:   [craft\elements\db\TagQuery](craft-elements-db-tagquery.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/db/TagQuery.php)
...
| [groupId](craft-elements-db-tagquery.md#groupid)                                                                                       | [integer](http://php.net/language.types.integer), [integer](http://php.net/language.types.integer)[], [null](http://php.net/language.types.null) – The tag group ID(s) that the resulting tags must be in.
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/db/TagQuery.php#L63)
...
| Property                                                       | Description
| -------------------------------------------------------------- | -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [defaultOrderBy](craft-elements-db-tagquery.md#defaultorderby) | [array](http://php.net/language.types.array) – The default [orderBy()](https://www.yiiframework.com/doc/api/2.0/yii-db-querytrait#orderBy()-detail) value to use if [orderBy()](https://www.yiiframework.com/doc/api/2.0/yii-db-querytrait#orderBy()-detail) is empty but not null.
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/db/TagQuery.php#L40)
...
| [__set()](craft-elements-db-tagquery.md#method-set)                                                                                         | Sets the value of a component property.
...
| [group()](craft-elements-db-tagquery.md#method-group)                                                                                       | Narrows the query results based on the tag groups the tags belong to.
...
| [groupId()](craft-elements-db-tagquery.md#method-groupid)                                                                                   | Narrows the query results based on the tag groups the tags belong to, per the groups’ IDs.
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/db/TagQuery.php#L68-L75)
...
| a [TagGroup](craft-models-taggroup.md) object | in a group represented by the object.




[View source](https://github.com/craftcms/cms/blob/master/src/elements/db/TagQuery.php#L110-L125)


#### Arguments

- `$value` ([string](http://php.net/language.types.string), [string](http://php.net/language.types.string)[], [craft\models\TagGroup](craft-models-taggroup.md), [null](http://php.net/language.types.null)) – The property value
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/db/TagQuery.php#L159-L163)
...
| [beforePrepare()](craft-elements-db-tagquery.md#method-beforeprepare)                                                                                     | This method is called at the beginning of preparing an element query for the query builder.
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/db/TagQuery.php#L168-L186)
