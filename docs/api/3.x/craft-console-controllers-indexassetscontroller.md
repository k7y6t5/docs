---
title: craft\console\controllers\IndexAssetsController
code:
  - php
  - twig
---

# IndexAssetsController
...
:   [craft\console\controllers\IndexAssetsController](craft-console-controllers-indexassetscontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/IndexAssetsController.php)
...
| [cacheRemoteImages](craft-console-controllers-indexassetscontroller.md#cacheremoteimages)                                                            | [boolean](http://php.net/language.types.boolean) – Whether remote-stored images should be locally cached in the process.
...
| [createMissingAssets](craft-console-controllers-indexassetscontroller.md#createmissingassets)                                                        | [boolean](http://php.net/language.types.boolean) – Whether to auto-create new asset records when missing.
| [defaultAction](craft-console-controllers-indexassetscontroller.md#defaultaction)                                                                    | [string](http://php.net/language.types.string) – The ID of the action that is used when the action ID is not specified in the request.
| [deleteMissingAssets](craft-console-controllers-indexassetscontroller.md#deletemissingassets)                                                        | [boolean](http://php.net/language.types.boolean) – Whether to delete all the asset records that have their files missing.
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/IndexAssetsController.php#L38)
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/IndexAssetsController.php#L43)
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/IndexAssetsController.php#L33)
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/IndexAssetsController.php#L48)
...
| [actionAll()](craft-console-controllers-indexassetscontroller.md#method-actionall)                                                                            | Re-indexes assets across all volumes.
| [actionOne()](craft-console-controllers-indexassetscontroller.md#method-actionone)                                                                            | Re-indexes assets from the given volume handle ($startAt = 0).
...
| [options()](craft-console-controllers-indexassetscontroller.md#method-options)                                                                                | Returns the names of valid options for the action (id) An option requires the existence of a public member variable whose name is the option name.
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/IndexAssetsController.php#L67-L77)
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/IndexAssetsController.php#L87-L105)


#### Arguments

- `$handle` ([string](http://php.net/language.types.string)) – The handle of the volume to index
- `$startAt` ([integer](http://php.net/language.types.integer))
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/IndexAssetsController.php#L53-L60)
