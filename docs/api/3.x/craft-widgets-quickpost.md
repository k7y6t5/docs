...
:   [craft\widgets\QuickPost](craft-widgets-quickpost.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/QuickPost.php)
...
| [bodyHtml](craft-widgets-quickpost.md#bodyhtml)                                                                                  | [string](http://php.net/language.types.string), [false](http://php.net/language.types.boolean) – The widget’s body HTML, or `false` if the widget should not be visible.
...
| [entryType](craft-widgets-quickpost.md#entrytype)                                                                                | [integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null) – The ID of the entry type that the widget should create
| [errors](https://www.yiiframework.com/doc/api/2.0/yii-base-model#$errors-detail "Defined by yii\base\Model")                     | [array](http://php.net/language.types.array) – Errors for all attributes or the specified attribute.
| [fields](craft-widgets-quickpost.md#fields)                                                                                      | [integer](http://php.net/language.types.integer)[], [null](http://php.net/language.types.null) – The IDs of the fields that the widget should show
...
| [section](craft-widgets-quickpost.md#section)                                                                                    | [integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null) – The ID of the section that the widget should post to
...
| [settingsHtml](craft-widgets-quickpost.md#settingshtml)                                                                          | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null)
...
| [title](craft-widgets-quickpost.md#title)                                                                                        | [string](http://php.net/language.types.string) – The widget’s title.
...
The ID of the entry type that the widget should create



[View source](https://github.com/craftcms/cms/blob/master/src/widgets/QuickPost.php#L49)
...
The IDs of the fields that the widget should show



[View source](https://github.com/craftcms/cms/blob/master/src/widgets/QuickPost.php#L54)
...
The ID of the section that the widget should post to



[View source](https://github.com/craftcms/cms/blob/master/src/widgets/QuickPost.php#L44)
...
| [__construct()](craft-widgets-quickpost.md#method-construct)                                                                                    | Constructor.
...
| [displayName()](craft-widgets-quickpost.md#method-displayname)                                                                                  | Returns the display name of this class.
...
| [getBodyHtml()](craft-widgets-quickpost.md#method-getbodyhtml)                                                                                  | Returns the widget's body HTML.
...
| [getSettingsHtml()](craft-widgets-quickpost.md#method-getsettingshtml)                                                                          | Returns the component’s settings HTML.
| [getSubtitle()](craft-base-widget.md#method-getsubtitle "Defined by craft\base\Widget")                                                         | Returns the widget’s subtitle.
| [getTitle()](craft-widgets-quickpost.md#method-gettitle)                                                                                        | Returns the widget’s title.
...
| [icon()](craft-widgets-quickpost.md#method-icon)                                                                                                | Returns the path to the widget’s SVG icon, or the actual SVG contents.
...
- Call [init()](craft-base-model.md#method-init).
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/QuickPost.php#L64-L79)
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/QuickPost.php#L28-L31)
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/QuickPost.php#L132-L180)
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/QuickPost.php#L95-L113)
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/QuickPost.php#L118-L127)
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/QuickPost.php#L36-L39)
...
| [defineRules()](craft-widgets-quickpost.md#method-definerules)                                                                                          | Returns the validation rules for attributes.
...
[View source](https://github.com/craftcms/cms/blob/master/src/widgets/QuickPost.php#L84-L90)
