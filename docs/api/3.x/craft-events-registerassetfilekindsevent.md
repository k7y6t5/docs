---
title: craft\events\RegisterAssetFileKindsEvent
code:
  - php
  - twig
---

# RegisterAssetFileKindsEvent
...
:   [craft\events\RegisterAssetFileKindsEvent](craft-events-registerassetfilekindsevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterAssetFileKindsEvent.php)
...
| [fileKinds](craft-events-registerassetfilekindsevent.md#filekinds)                                             | [array](http://php.net/language.types.array) – The registered asset file kinds
...
The registered asset file kinds



[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterAssetFileKindsEvent.php#L23)
