---
title: craft\events\AuthenticateUserEvent
code:
  - php
  - twig
---
...
:   [craft\events\AuthenticateUserEvent](craft-events-authenticateuserevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/AuthenticateUserEvent.php)
...
| [password](craft-events-authenticateuserevent.md#password)                                                     | [string](http://php.net/language.types.string) – The password that was submitted
| [performAuthentication](craft-events-authenticateuserevent.md#performauthentication)                           | [boolean](http://php.net/language.types.boolean) – Whether authentication should continue
...
The password that was submitted



[View source](https://github.com/craftcms/cms/blob/master/src/events/AuthenticateUserEvent.php#L23)
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/AuthenticateUserEvent.php#L28)
