---
title: craft\console\controllers\GraphqlController
code:
  - php
  - twig
---
...
:   [craft\console\controllers\GraphqlController](craft-console-controllers-graphqlcontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/GraphqlController.php)
...
| [token](craft-console-controllers-graphqlcontroller.md#token)                                                                                        | [string](http://php.net/language.types.string) – The token to look up to determine the appropriate GraphQL schema
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/GraphqlController.php#L33)
...
| [actionDumpSchema()](craft-console-controllers-graphqlcontroller.md#method-actiondumpschema)                                                                  | Dump out a given GraphQL schema to a file.
| [actionPrintSchema()](craft-console-controllers-graphqlcontroller.md#method-actionprintschema)                                                                | Print out a given GraphQL schema.
...
| [options()](craft-console-controllers-graphqlcontroller.md#method-options)                                                                                    | Returns the names of valid options for the action (id) An option requires the existence of a public member variable whose name is the option name.
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/GraphqlController.php#L73-L91)
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/GraphqlController.php#L51-L66)
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/GraphqlController.php#L38-L44)
...
| [getGqlSchema()](craft-console-controllers-graphqlcontroller.md#method-getgqlschema)                                                                            |
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/GraphqlController.php#L98-L137)
