---
title: craft\controllers\UserSettingsController
code:
  - php
  - twig
---
...
:   [craft\controllers\UserSettingsController](craft-controllers-usersettingscontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/UserSettingsController.php)
...
| [actionDeleteGroup()](craft-controllers-usersettingscontroller.md#method-actiondeletegroup)                                                             | Deletes a user group.
| [actionSaveGroup()](craft-controllers-usersettingscontroller.md#method-actionsavegroup)                                                                 | Saves a user group.
| [actionSaveUserSettings()](craft-controllers-usersettingscontroller.md#method-actionsaveusersettings)                                                   | Saves the system user settings.
...
| [beforeAction()](craft-controllers-usersettingscontroller.md#method-beforeaction)                                                                       | This method is invoked right before an action is executed.
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/UserSettingsController.php#L104-L114)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/UserSettingsController.php#L47-L97)
...
- [yii\web\NotFoundHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-notfoundhttpexception)\
  if the requested user group cannot be found
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/UserSettingsController.php#L121-L140)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/UserSettingsController.php#L29-L39)
