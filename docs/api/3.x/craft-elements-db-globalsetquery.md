---
title: craft\elements\db\GlobalSetQuery
code:
  - php
  - twig
---
...
:   [craft\elements\db\GlobalSetQuery](craft-elements-db-globalsetquery.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/db/GlobalSetQuery.php)
...
| [editable](craft-elements-db-globalsetquery.md#editable)                                                                               | [boolean](http://php.net/language.types.boolean) – Whether to only return global sets that the user has permission to edit.
...
| [handle](craft-elements-db-globalsetquery.md#handle)                                                                                   | [string](http://php.net/language.types.string), [string](http://php.net/language.types.string)[], [null](http://php.net/language.types.null) – The handle(s) that the resulting global sets must have.
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/db/GlobalSetQuery.php#L45)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/db/GlobalSetQuery.php#L51)
...
| Property                                                             | Description
| -------------------------------------------------------------------- | -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [defaultOrderBy](craft-elements-db-globalsetquery.md#defaultorderby) | [array](http://php.net/language.types.array) – The default [orderBy()](https://www.yiiframework.com/doc/api/2.0/yii-db-querytrait#orderBy()-detail) value to use if [orderBy()](https://www.yiiframework.com/doc/api/2.0/yii-db-querytrait#orderBy()-detail) is empty but not null.
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/db/GlobalSetQuery.php#L36)
...
| [__set()](craft-elements-db-elementquery.md#method-set "Defined by craft\elements\db\ElementQuery")                                         | Sets the value of a component property.
...
| [editable()](craft-elements-db-globalsetquery.md#method-editable)                                                                           | Sets the [editable](craft-elements-db-globalsetquery.md#editable) property.
...
| [handle()](craft-elements-db-globalsetquery.md#method-handle)                                                                               | Narrows the query results based on the global sets’ handles.
...
Sets the [editable](craft-elements-db-globalsetquery.md#editable) property.




[View source](https://github.com/craftcms/cms/blob/master/src/elements/db/GlobalSetQuery.php#L60-L64)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/db/GlobalSetQuery.php#L98-L102)
...
| [beforePrepare()](craft-elements-db-globalsetquery.md#method-beforeprepare)                                                                               | This method is called at the beginning of preparing an element query for the query builder.
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/db/GlobalSetQuery.php#L107-L125)
