...
:   [craft\elements\Category](craft-elements-category.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php)
...
| [cpEditUrl](craft-elements-category.md#cpediturl)                                                                                | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null)
...
| [deletedWithGroup](craft-elements-category.md#deletedwithgroup)                                                                  | [boolean](http://php.net/language.types.boolean) – Whether the category was deleted along with its group
...
| [editorHtml](craft-elements-category.md#editorhtml)                                                                              | [string](http://php.net/language.types.string) – The HTML for the editor HUD
...
| [fieldLayout](craft-elements-category.md#fieldlayout)                                                                            | [craft\models\FieldLayout](craft-models-fieldlayout.md), [null](http://php.net/language.types.null)
...
| [gqlTypeName](craft-elements-category.md#gqltypename)                                                                            | [string](http://php.net/language.types.string)
| [group](craft-elements-category.md#group)                                                                                        | [craft\models\CategoryGroup](craft-models-categorygroup.md)
| [groupId](craft-elements-category.md#groupid)                                                                                    | [integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null) – Group ID
...
| [isEditable](craft-elements-category.md#iseditable)                                                                              | [boolean](http://php.net/language.types.boolean)
...
| [newParentId](craft-elements-category.md#newparentid)                                                                            | [integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null) – New parent ID
...
| [uriFormat](craft-elements-category.md#uriformat)                                                                                | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null)
...
Whether the category was deleted along with its group

See also [beforeDelete()](craft-elements-category.md#method-beforedelete)

[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L336)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L325)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L330)
...
| [afterMoveInStructure()](craft-elements-category.md#method-aftermoveinstructure)                                                                | Performs actions after an element is moved within a structure.
...
| [afterRestore()](craft-elements-category.md#method-afterrestore)                                                                                | Performs actions after an element is restored.
| [afterSave()](craft-elements-category.md#method-aftersave)                                                                                      | Performs actions after an element is saved.
...
| [beforeDelete()](craft-elements-category.md#method-beforedelete)                                                                                | Performs actions before an element is deleted.
...
| [beforeSave()](craft-elements-category.md#method-beforesave)                                                                                    | Performs actions before an element is saved.
...
| [displayName()](craft-elements-category.md#method-displayname)                                                                                  | Returns the display name of this class.
...
| [extraFields()](craft-elements-category.md#method-extrafields)                                                                                  | Returns the list of fields that can be expanded further and returned by [toArray()](https://www.yiiframework.com/doc/api/2.0/yii-base-arrayabletrait#toArray()-detail).
| [fields()](https://www.yiiframework.com/doc/api/2.0/yii-base-arrayabletrait#fields()-detail "Defined by yii\base\ArrayableTrait")               | Returns the list of fields that should be returned by default by [toArray()](https://www.yiiframework.com/doc/api/2.0/yii-base-arrayabletrait#toArray()-detail) when no specific fields are specified.
| [find()](craft-elements-category.md#method-find)                                                                                                | Creates an [craft\elements\db\ElementQueryInterface](craft-elements-db-elementqueryinterface.md) instance for query purpose.
...
| [getCpEditUrl()](craft-elements-category.md#method-getcpediturl)                                                                                | Returns the element’s edit URL in the control panel.
...
| [getEditorHtml()](craft-elements-category.md#method-geteditorhtml)                                                                              | Returns the HTML for the element’s editor HUD.
...
| [getFieldLayout()](craft-elements-category.md#method-getfieldlayout)                                                                            | Returns the field layout used by this element.
...
| [getGqlTypeName()](craft-elements-category.md#method-getgqltypename)                                                                            | Returns the GraphQL type name for this element type.
| [getGroup()](craft-elements-category.md#method-getgroup)                                                                                        | Returns the category's group.
...
| [getIsEditable()](craft-elements-category.md#method-getiseditable)                                                                              | Returns whether the current user can edit the element.
...
| [getUriFormat()](craft-elements-category.md#method-geturiformat)                                                                                | Returns the URI format used to generate this element’s URI.
...
| [gqlScopesByContext()](craft-elements-category.md#method-gqlscopesbycontext)                                                                    | Returns the GraphQL scopes required by element's context.
| [gqlTypeNameByContext()](craft-elements-category.md#method-gqltypenamebycontext)                                                                | Returns the GraphQL type name by an element's context.
| [hasContent()](craft-elements-category.md#method-hascontent)                                                                                    | Returns whether elements of this type will be storing any data in the `content` table (titles or custom fields).
...
| [hasStatuses()](craft-elements-category.md#method-hasstatuses)                                                                                  | Returns whether elements of this type have statuses.
| [hasTitles()](craft-elements-category.md#method-hastitles)                                                                                      | Returns whether elements of this type have traditional titles.
| [hasUris()](craft-elements-category.md#method-hasuris)                                                                                          | Returns whether elements of this type can have their own slugs and URIs.
...
| [isLocalized()](craft-elements-category.md#method-islocalized)                                                                                  | Returns whether elements of this type store content on a per-site basis.
...
| [lowerDisplayName()](craft-elements-category.md#method-lowerdisplayname)                                                                        | Returns the lowercase version of [displayName()](craft-elements-category.md#method-displayname).
...
| [pluralDisplayName()](craft-elements-category.md#method-pluraldisplayname)                                                                      | Returns the plural version of [displayName()](craft-elements-category.md#method-displayname).
| [pluralLowerDisplayName()](craft-elements-category.md#method-plurallowerdisplayname)                                                            | Returns the plural, lowercase version of [displayName()](craft-elements-category.md#method-displayname).
| [refHandle()](craft-elements-category.md#method-refhandle)                                                                                      | Returns the handle that should be used to refer to this element type from reference tags.
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L632-L687)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L609-L627)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L536-L571)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L576-L604)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L510-L530)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L45-L48)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L347-L352)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L126-L129)



#### Returns

[craft\elements\db\CategoryQuery](craft-elements-db-categoryquery.md) – The newly created [craft\elements\db\CategoryQuery](craft-elements-db-categoryquery.md) instance.
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L412-L423)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L460-L492)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L428-L431)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L498-L501)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L439-L452)
...
- [yii\base\InvalidConfigException](https://www.yiiframework.com/doc/api/2.0/yii-base-invalidconfigexception)\
  if [groupId](craft-elements-category.md#groupid) is missing or invalid
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L404-L407)
...
Note that element types that can have URIs must return `true` from [hasUris()](craft-elements-category.md#method-hasuris).




[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L367-L376)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L145-L149)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L135-L139)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L85-L88)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L117-L120)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L93-L96)
...
Note that individual elements must also return a URI format from [getUriFormat()](craft-elements-category.md#method-geturiformat) if they are to actually get a URI.




[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L101-L104)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L109-L112)
...
Returns the lowercase version of [displayName()](craft-elements-category.md#method-displayname).
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L53-L56)
...
Returns the plural version of [displayName()](craft-elements-category.md#method-displayname).
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L61-L64)
...
Returns the plural, lowercase version of [displayName()](craft-elements-category.md#method-displayname).
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L69-L72)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L77-L80)
...
| Method                                                                                                                                                  | Description
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [defineActions()](craft-elements-category.md#method-defineactions)                                                                                      | Defines the available element actions for a given source.
| [defineDefaultTableAttributes()](craft-elements-category.md#method-definedefaulttableattributes)                                                        | Returns the list of table attribute keys that should be shown by default.
...
| [defineRules()](craft-elements-category.md#method-definerules)                                                                                          | Returns the validation rules for attributes.
...
| [defineSortOptions()](craft-elements-category.md#method-definesortoptions)                                                                              | Returns the sort options for the element type.
| [defineSources()](craft-elements-category.md#method-definesources)                                                                                      | Defines the sources that elements of this type may belong to.
| [defineTableAttributes()](craft-elements-category.md#method-definetableattributes)                                                                      | Defines all of the available columns that can be shown in table views.
...
| [route()](craft-elements-category.md#method-route)                                                                                                      | Returns the route that should be used when the element’s URI is requested.
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L181-L267)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L315-L320)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L357-L362)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L272-L294)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L154-L176)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L299-L310)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/Category.php#L381-L399)
