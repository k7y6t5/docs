---
title: craft\events\ResolveResourcePathEvent
code:
  - php
  - twig
---

# ResolveResourcePathEvent
...
:   [craft\events\ResolveResourcePathEvent](craft-events-resolveresourcepathevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/ResolveResourcePathEvent.php)
...
| [path](craft-events-resolveresourcepathevent.md#path)                                                          | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The file path that the URI should resolve to.
...
| [uri](craft-events-resolveresourcepathevent.md#uri)                                                            | [string](http://php.net/language.types.string) – The resource URI (sans "cpresources/").
...
The file path that the URI should resolve to.



[View source](https://github.com/craftcms/cms/blob/master/src/events/ResolveResourcePathEvent.php#L28)
...
The resource URI (sans "cpresources/").



[View source](https://github.com/craftcms/cms/blob/master/src/events/ResolveResourcePathEvent.php#L23)
