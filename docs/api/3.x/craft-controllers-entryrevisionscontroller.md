---
title: craft\controllers\EntryRevisionsController
code:
  - php
  - twig
---

# EntryRevisionsController
...
:   [craft\controllers\EntryRevisionsController](craft-controllers-entryrevisionscontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/EntryRevisionsController.php)
...
| [actionCreateDraft()](craft-controllers-entryrevisionscontroller.md#method-actioncreatedraft)                                                           | Creates a new entry draft and redirects the client to its edit URL
| [actionDeleteDraft()](craft-controllers-entryrevisionscontroller.md#method-actiondeletedraft)                                                           | Deletes a draft.
| [actionPublishDraft()](craft-controllers-entryrevisionscontroller.md#method-actionpublishdraft)                                                         | Publish a draft.
| [actionRevertEntryToVersion()](craft-controllers-entryrevisionscontroller.md#method-actionrevertentrytoversion)                                         | Reverts an entry to a version.
| [actionSaveDraft()](craft-controllers-entryrevisionscontroller.md#method-actionsavedraft)                                                               | Saves a draft, or creates a new one.
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/EntryRevisionsController.php#L49-L134)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/EntryRevisionsController.php#L277-L310)
...
- [yii\web\NotFoundHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-notfoundhttpexception)\
  if the requested entry draft cannot be found
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/EntryRevisionsController.php#L320-L423)
...
- [yii\web\ServerErrorHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-servererrorhttpexception)\
  if the entry draft is missing its entry
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/EntryRevisionsController.php#L432-L473)
...
- [yii\web\NotFoundHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-notfoundhttpexception)\
  if the requested entry version cannot be found
- [yii\web\ServerErrorHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-servererrorhttpexception)\
  if the entry version is missing its entry
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/EntryRevisionsController.php#L142-L269)
