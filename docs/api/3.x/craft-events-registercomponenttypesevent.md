---
title: craft\events\RegisterComponentTypesEvent
code:
  - php
  - twig
---
...
:   [craft\events\RegisterComponentTypesEvent](craft-events-registercomponenttypesevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterComponentTypesEvent.php)
...
| [types](craft-events-registercomponenttypesevent.md#types)                                                     | [string](http://php.net/language.types.string)[] – List of registered component types classes.
...
List of registered component types classes.



[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterComponentTypesEvent.php#L23)
