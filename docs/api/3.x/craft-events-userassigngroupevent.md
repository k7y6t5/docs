---
title: craft\events\UserAssignGroupEvent
code:
  - php
  - twig
---

# UserAssignGroupEvent
...
:   [craft\events\UserAssignGroupEvent](craft-events-userassigngroupevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/UserAssignGroupEvent.php)
...
| [user](craft-events-userassigngroupevent.md#user)                                                              | [craft\elements\User](craft-elements-user.md), [null](http://php.net/language.types.null) – The user model associated with this event
...
The user model associated with this event



[View source](https://github.com/craftcms/cms/blob/master/src/events/UserAssignGroupEvent.php#L23)
