...
:   [craft\records\Section](craft-records-section.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/Section.php)
...
| [siteSettings](craft-records-section.md#sitesettings)                                                                                                  | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
| [structure](craft-records-section.md#structure)                                                                                                        | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [getSiteSettings()](craft-records-section.md#method-getsitesettings)                                                                                            | Returns the associated site settings.
| [getStructure()](craft-records-section.md#method-getstructure)                                                                                                  | Returns the section’s structure.
...
| [tableName()](craft-records-section.md#method-tablename)                                                                                                        | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/Section.php#L49-L52)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/Section.php#L59-L62)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/Section.php#L39-L42)
