---
title: craft\events\BackupEvent
code:
  - php
  - twig
---
...
:   [craft\events\BackupEvent](craft-events-backupevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/BackupEvent.php)
...
| [file](craft-events-backupevent.md#file)                                                                       | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The file path to the backup.
...
| [ignoreTables](craft-events-backupevent.md#ignoretables)                                                       | [string](http://php.net/language.types.string)[] – The table names whose data should be excluded from the backup.
...
The file path to the backup.



[View source](https://github.com/craftcms/cms/blob/master/src/events/BackupEvent.php#L23)
...
The table names whose data should be excluded from the backup.



[View source](https://github.com/craftcms/cms/blob/master/src/events/BackupEvent.php#L29)
