---
title: craft\events\PopulateElementEvent
code:
  - php
  - twig
---

# PopulateElementEvent
...
:   [craft\events\PopulateElementEvent](craft-events-populateelementevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/PopulateElementEvent.php)
...
| [row](craft-events-populateelementevent.md#row)                                                                | [array](http://php.net/language.types.array), [null](http://php.net/language.types.null) – The element query’s result for this element.
...
The element query’s result for this element.



[View source](https://github.com/craftcms/cms/blob/master/src/events/PopulateElementEvent.php#L21)
