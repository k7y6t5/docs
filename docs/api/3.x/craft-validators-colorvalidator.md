---
title: craft\validators\ColorValidator
code:
  - php
  - twig
---
...
:   [craft\validators\ColorValidator](craft-validators-colorvalidator.md) &raquo;
[yii\validators\RegularExpressionValidator](https://www.yiiframework.com/doc/api/2.0/yii-validators-regularexpressionvalidator) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/ColorValidator.php)
...
| [not](https://www.yiiframework.com/doc/api/2.0/yii-validators-regularexpressionvalidator#$not-detail "Defined by yii\validators\RegularExpressionValidator")     | [boolean](http://php.net/language.types.boolean) – Whether to invert the validation logic.
...
| [pattern](craft-validators-colorvalidator.md#pattern)                                                                                                            | [string](http://php.net/language.types.string) – The regular expression to be matched with
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/ColorValidator.php#L49)
...
| [init()](craft-validators-colorvalidator.md#method-init)                                                                                                              | Initializes the object.
...
| [normalizeColor()](craft-validators-colorvalidator.md#method-normalizecolor)                                                                                          | Normalizes a color value.
...
| [validateAttribute()](craft-validators-colorvalidator.md#method-validateattribute)                                                                                    | Validates a single attribute.
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/ColorValidator.php#L54-L60)
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/ColorValidator.php#L28-L44)


#### Arguments

- `$color` ([string](http://php.net/language.types.string))
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/ColorValidator.php#L65-L85)
