---
title: craft\queue\jobs\ConvertEntryRevisions
code:
  - php
  - twig
---

# ConvertEntryRevisions
...
:   [craft\queue\jobs\ConvertEntryRevisions](craft-queue-jobs-convertentryrevisions.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/queue/jobs/ConvertEntryRevisions.php)
...
| [execute()](craft-queue-jobs-convertentryrevisions.md#method-execute)                                                                     |
...
[View source](https://github.com/craftcms/cms/blob/master/src/queue/jobs/ConvertEntryRevisions.php#L61-L78)
...
| Method                                                                                      | Description
| ------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------
| [defaultDescription()](craft-queue-jobs-convertentryrevisions.md#method-defaultdescription) | Returns a default description for [getDescription()](craft-queue-basejob.md#method-getdescription).
...
[View source](https://github.com/craftcms/cms/blob/master/src/queue/jobs/ConvertEntryRevisions.php#L83-L86)
