...
:   [craft\queue\Command](craft-queue-command.md) &raquo;
[yii\queue\cli\Command](https://github.com/yiisoft/yii2-queue/blob/master/src/cli/Command.php) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/queue/Command.php)
...
| [defaultAction](craft-queue-command.md#defaultaction)                                                                                                | [string](http://php.net/language.types.string)
...
| [isolate](https://github.com/yiisoft/yii2-queue/blob/master/src/cli/Command.php#$isolate-detail "Defined by yii\queue\cli\Command")                  | [boolean](http://php.net/language.types.boolean) – Isolate mode.
...
| [phpBinary](https://github.com/yiisoft/yii2-queue/blob/master/src/cli/Command.php#$phpBinary-detail "Defined by yii\queue\cli\Command")              | [string](http://php.net/language.types.string) – Path to php interpreter that uses to run child processes.
| [queue](craft-queue-command.md#queue)                                                                                                                | [craft\queue\Queue](craft-queue-queue.md)
...
| [verbose](https://github.com/yiisoft/yii2-queue/blob/master/src/cli/Command.php#$verbose-detail "Defined by yii\queue\cli\Command")                  | [boolean](http://php.net/language.types.boolean) – Verbose mode of a job execute.
| [verboseConfig](craft-queue-command.md#verboseconfig)                                                                                                | [array](http://php.net/language.types.array) – Additional options to the verbose behavior.
...
[View source](https://github.com/craftcms/cms/blob/master/src/queue/Command.php#L31)
...
[View source](https://github.com/craftcms/cms/blob/master/src/queue/Command.php#L26)
...
[View source](https://github.com/craftcms/cms/blob/master/src/queue/Command.php#L36-L38)
...
| [actionListen()](craft-queue-command.md#method-actionlisten)                                                                                                  | Listens for new jobs added to the queue and runs them
| [actionRelease()](craft-queue-command.md#method-actionrelease)                                                                                                |
| [actionRetry()](craft-queue-command.md#method-actionretry)                                                                                                    | Re-adds a failed job(s) to the queue.
| [actionRun()](craft-queue-command.md#method-actionrun)                                                                                                        | Runs all jobs in the queue.
| [actions()](craft-queue-command.md#method-actions)                                                                                                            | Declares external actions for the controller.
...
| [beforeAction()](craft-queue-command.md#method-beforeaction)                                                                                                  | This method is invoked right before an action is executed.
...
| [options()](https://www.yiiframework.com/doc/api/2.0/yii-console-controller#options()-detail "Defined by yii\console\Controller")                             | Returns the names of valid options for the action (id) An option requires the existence of a public member variable whose name is the option name.
...
[View source](https://github.com/craftcms/cms/blob/master/src/queue/Command.php#L86-L89)
...
[View source](https://github.com/craftcms/cms/blob/master/src/queue/Command.php#L123-L137)


#### Arguments

- `$job` ([string](http://php.net/language.types.string)) – The job ID to release. Pass `all` to release all jobs.
...
[View source](https://github.com/craftcms/cms/blob/master/src/queue/Command.php#L98-L115)


#### Arguments

- `$job` ([integer](http://php.net/language.types.integer), [string](http://php.net/language.types.string)) – The job ID that should be retried, or pass `all` to retry all failed jobs
...
[View source](https://github.com/craftcms/cms/blob/master/src/queue/Command.php#L75-L79)
...
[View source](https://github.com/craftcms/cms/blob/master/src/queue/Command.php#L63-L68)
...
[View source](https://github.com/craftcms/cms/blob/master/src/queue/Command.php#L51-L58)
...
| Method                                                                                                                                                                | Description
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------
| [canIsolate()](https://github.com/yiisoft/yii2-queue/blob/master/src/cli/Command.php#canIsolate()-detail "Defined by yii\queue\cli\Command")                          |
| [canVerbose()](https://github.com/yiisoft/yii2-queue/blob/master/src/cli/Command.php#canVerbose()-detail "Defined by yii\queue\cli\Command")                          |
...
| [handleMessage()](https://github.com/yiisoft/yii2-queue/blob/master/src/cli/Command.php#handleMessage()-detail "Defined by yii\queue\cli\Command")                    | Handles message using child process.
| [isWorkerAction()](craft-queue-command.md#method-isworkeraction)                                                                                                      |
...
[View source](https://github.com/craftcms/cms/blob/master/src/queue/Command.php#L43-L46)


#### Arguments

- `$actionID` ([string](http://php.net/language.types.string))
...
| ------------------ | ------------------------------------------------------------------------------------------------
| `EXEC_DONE`        | The exit code of the exec action which is returned when job was done.
| `EXEC_RETRY`       | The exit code of the exec action which is returned when job wasn't done and wanted next attempt.
| `EXIT_CODE_ERROR`  |
| `EXIT_CODE_NORMAL` |
