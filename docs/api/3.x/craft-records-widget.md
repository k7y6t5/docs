...
:   [craft\records\Widget](craft-records-widget.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/Widget.php)
...
| [user](craft-records-widget.md#user)                                                                                                                   | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [getUser()](craft-records-widget.md#method-getuser)                                                                                                             | Returns the widget’s user.
...
| [tableName()](craft-records-widget.md#method-tablename)                                                                                                         | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/Widget.php#L43-L46)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/Widget.php#L33-L36)
