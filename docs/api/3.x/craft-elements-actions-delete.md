---
title: craft\elements\actions\Delete
code:
  - php
  - twig
---
...
:   [craft\elements\actions\Delete](craft-elements-actions-delete.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/Delete.php)
...
| [confirmationMessage](craft-elements-actions-delete.md#confirmationmessage)                                                      | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The confirmation message that should be shown before the elements get deleted
...
| [successMessage](craft-elements-actions-delete.md#successmessage)                                                                | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The message that should be shown after the elements get deleted
| [triggerHtml](craft-base-elementaction.md#triggerhtml "Defined by craft\base\ElementAction")                                     | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The action’s trigger HTML.
| [triggerLabel](craft-elements-actions-delete.md#triggerlabel)                                                                    | [string](http://php.net/language.types.string) – The action’s trigger label
...
The confirmation message that should be shown before the elements get deleted



[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/Delete.php#L25)
...
The message that should be shown after the elements get deleted



[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/Delete.php#L30)
...
| [getConfirmationMessage()](craft-elements-actions-delete.md#method-getconfirmationmessage)                                                      | Returns a confirmation message that should be displayed before the action is performed.
...
| [getTriggerHtml()](craft-base-elementaction.md#method-gettriggerhtml "Defined by craft\base\ElementAction")                                     | Returns the action’s trigger HTML.
| [getTriggerLabel()](craft-elements-actions-delete.md#method-gettriggerlabel)                                                                    | Returns the action’s trigger label.
...
| [isDestructive()](craft-elements-actions-delete.md#method-isdestructive)                                                                        | Returns whether this action is destructive in nature.
...
| [performAction()](craft-elements-actions-delete.md#method-performaction)                                                                        | Performs the action on any elements that match the given criteria.
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/Delete.php#L51-L54)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/Delete.php#L35-L38)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/Delete.php#L43-L46)
...
[View source](https://github.com/craftcms/cms/blob/master/src/elements/actions/Delete.php#L59-L69)
