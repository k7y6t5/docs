---
title: craft\events\RegisterEmailMessagesEvent
code:
  - php
  - twig
---

# RegisterEmailMessagesEvent
...
:   [craft\events\RegisterEmailMessagesEvent](craft-events-registeremailmessagesevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterEmailMessagesEvent.php)
...
| [messages](craft-events-registeremailmessagesevent.md#messages)                                                | [array](http://php.net/language.types.array) – List of registered email messages.
...
List of registered email messages. Each message should contain 'key' and optionally 'heading', 'subject', and 'body' keys.



[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterEmailMessagesEvent.php#L23)
