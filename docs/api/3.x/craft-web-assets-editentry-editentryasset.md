---
title: craft\web\assets\editentry\EditEntryAsset
code:
  - php
  - twig
---
...
:   craft\web\assets\editentry

Inherits

:   [craft\web\assets\editentry\EditEntryAsset](craft-web-assets-editentry-editentryasset.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/editentry/EditEntryAsset.php)
...
| [init()](craft-web-assets-editentry-editentryasset.md#method-init)                                                                                | Initializes the bundle.
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/editentry/EditEntryAsset.php#L21-L34)
