---
title: craft\web\assets\routes\RoutesAsset
code:
  - php
  - twig
---
...
:   craft\web\assets\routes

Inherits

:   [craft\web\assets\routes\RoutesAsset](craft-web-assets-routes-routesasset.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/routes/RoutesAsset.php)
...
| [init()](craft-web-assets-routes-routesasset.md#method-init)                                                                                      | Initializes the bundle.
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/routes/RoutesAsset.php#L21-L38)
