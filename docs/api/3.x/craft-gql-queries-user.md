...
:   [craft\gql\queries\User](craft-gql-queries-user.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/gql/queries/User.php)
...
| [getQueries()](craft-gql-queries-user.md#method-getqueries)                                                                 | Returns the queries defined by the class as an array.
...
[View source](https://github.com/craftcms/cms/blob/master/src/gql/queries/User.php#L28-L48)
