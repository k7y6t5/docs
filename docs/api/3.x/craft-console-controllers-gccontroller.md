---
title: craft\console\controllers\GcController
code:
  - php
  - twig
---
...
:   [craft\console\controllers\GcController](craft-console-controllers-gccontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/GcController.php)
...
| [defaultAction](craft-console-controllers-gccontroller.md#defaultaction)                                                                             | [string](http://php.net/language.types.string) – The ID of the action that is used when the action ID is not specified in the request.
| [deleteAllTrashed](craft-console-controllers-gccontroller.md#deletealltrashed)                                                                       | [boolean](http://php.net/language.types.boolean) – Whether all soft-deleted items should be deleted, rather than just the ones that were deleted long enough ago to be ready for hard-deletion per the `softDeleteDuration` config setting.
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/GcController.php#L26)
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/GcController.php#L33)
...
| [actionRun()](craft-console-controllers-gccontroller.md#method-actionrun)                                                                                     | Runs garbage collection.
...
| [options()](craft-console-controllers-gccontroller.md#method-options)                                                                                         | Returns the names of valid options for the action (id) An option requires the existence of a public member variable whose name is the option name.
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/GcController.php#L50-L60)
...
[View source](https://github.com/craftcms/cms/blob/master/src/console/controllers/GcController.php#L38-L43)
