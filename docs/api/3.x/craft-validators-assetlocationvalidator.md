---
title: craft\validators\AssetLocationValidator
code:
  - php
  - twig
---
...
:   [craft\validators\AssetLocationValidator](craft-validators-assetlocationvalidator.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/AssetLocationValidator.php)
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [allowedExtensions](craft-validators-assetlocationvalidator.md#allowedextensions)                                                                                | [string](http://php.net/language.types.string)[], [null](http://php.net/language.types.null) – Allowed file extensions
...
| [avoidFilenameConflicts](craft-validators-assetlocationvalidator.md#avoidfilenameconflicts)                                                                      | [boolean](http://php.net/language.types.boolean) – Whether Asset should avoid filename conflicts when saved.
...
| [conflictingFilenameAttribute](craft-validators-assetlocationvalidator.md#conflictingfilenameattribute)                                                          | [string](http://php.net/language.types.string) – The conflicting filename attribute on the model
| [disallowedExtension](craft-validators-assetlocationvalidator.md#disallowedextension)                                                                            | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – User-defined error message used when the extension is disallowed.
...
| [errorCodeAttribute](craft-validators-assetlocationvalidator.md#errorcodeattribute)                                                                              | [string](http://php.net/language.types.string) – The error code attribute on the model
...
| [filenameAttribute](craft-validators-assetlocationvalidator.md#filenameattribute)                                                                                | [string](http://php.net/language.types.string) – The filename attribute on the model
| [filenameConflict](craft-validators-assetlocationvalidator.md#filenameconflict)                                                                                  | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – User-defined error message used when a file already exists with the same name.
| [folderIdAttribute](craft-validators-assetlocationvalidator.md#folderidattribute)                                                                                | [string](http://php.net/language.types.string) – The folder ID attribute on the model
...
| [suggestedFilenameAttribute](craft-validators-assetlocationvalidator.md#suggestedfilenameattribute)                                                              | [string](http://php.net/language.types.string) – The suggested filename attribute on the model
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/AssetLocationValidator.php#L54)
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/AssetLocationValidator.php#L69)
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/AssetLocationValidator.php#L44)
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/AssetLocationValidator.php#L59)
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/AssetLocationValidator.php#L49)
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/AssetLocationValidator.php#L34)
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/AssetLocationValidator.php#L64)
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/AssetLocationValidator.php#L29)
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/AssetLocationValidator.php#L39)
...
| [addLocationError()](craft-validators-assetlocationvalidator.md#method-addlocationerror)                                                                              | Adds a location error to the model.
...
| [init()](craft-validators-assetlocationvalidator.md#method-init)                                                                                                      | Initializes the object.
...
| [validateAttribute()](craft-validators-assetlocationvalidator.md#method-validateattribute)                                                                            | Validates a single attribute.
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/AssetLocationValidator.php#L152-L159)


#### Arguments

- `$model` ([yii\base\Model](https://www.yiiframework.com/doc/api/2.0/yii-base-model))
- `$attribute` ([string](http://php.net/language.types.string))
- `$errorCode` ([string](http://php.net/language.types.string))
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/AssetLocationValidator.php#L74-L89)
...
[View source](https://github.com/craftcms/cms/blob/master/src/validators/AssetLocationValidator.php#L94-L141)
