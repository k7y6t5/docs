---
title: craft\events\DefineConsoleActionsEvent
code:
  - php
  - twig
---
...
:   [craft\events\DefineConsoleActionsEvent](craft-events-defineconsoleactionsevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/DefineConsoleActionsEvent.php)
...
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [actions](craft-events-defineconsoleactionsevent.md#actions)                                                   | [array](http://php.net/language.types.array) – The additional actions that should be available to console controllers.
...
The additional actions that should be available to console controllers.

See [craft\console\Controller::defineActions()](craft-console-controller.md#method-defineactions) for details on what to set on this.



[View source](https://github.com/craftcms/cms/blob/master/src/events/DefineConsoleActionsEvent.php#L25)
