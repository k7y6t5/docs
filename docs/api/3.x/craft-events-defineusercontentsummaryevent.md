---
title: craft\events\DefineUserContentSummaryEvent
code:
  - php
  - twig
---
...
:   [craft\events\DefineUserContentSummaryEvent](craft-events-defineusercontentsummaryevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/DefineUserContentSummaryEvent.php)
...
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [contentSummary](craft-events-defineusercontentsummaryevent.md#contentsummary)                                 | [string](http://php.net/language.types.string)[] – Summary of content that is owned by the user(s)
...
| [userId](craft-events-defineusercontentsummaryevent.md#userid)                                                 | [integer](http://php.net/language.types.integer), [integer](http://php.net/language.types.integer)[] – The user ID(s) associated with the event
...
Summary of content that is owned by the user(s)



[View source](https://github.com/craftcms/cms/blob/master/src/events/DefineUserContentSummaryEvent.php#L28)
...
The user ID(s) associated with the event



[View source](https://github.com/craftcms/cms/blob/master/src/events/DefineUserContentSummaryEvent.php#L23)
