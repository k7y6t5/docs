---
title: craft\events\RegisterCacheOptionsEvent
code:
  - php
  - twig
---

# RegisterCacheOptionsEvent
...
:   [craft\events\RegisterCacheOptionsEvent](craft-events-registercacheoptionsevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterCacheOptionsEvent.php)
...
| [options](craft-events-registercacheoptionsevent.md#options)                                                   | [array](http://php.net/language.types.array) – List of registered cache options for the Clear Caches tool.
...
List of registered cache options for the Clear Caches tool. Each option should contain 'key', 'action', and 'label' keys.



[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterCacheOptionsEvent.php#L23)
