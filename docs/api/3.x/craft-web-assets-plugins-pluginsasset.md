---
title: craft\web\assets\plugins\PluginsAsset
code:
  - php
  - twig
---
...
:   [craft\web\assets\plugins\PluginsAsset](craft-web-assets-plugins-pluginsasset.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/plugins/PluginsAsset.php)
...
| [init()](craft-web-assets-plugins-pluginsasset.md#method-init)                                                                            | Initializes the bundle.
...
| [registerAssetFiles()](craft-web-assets-plugins-pluginsasset.md#method-registerassetfiles)                                                | Registers the CSS and JS files with the given view.
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/plugins/PluginsAsset.php#L22-L39)
...
[View source](https://github.com/craftcms/cms/blob/master/src/web/assets/plugins/PluginsAsset.php#L44-L65)
