---
title: craft\mail\transportadapters\Smtp
code:
  - php
  - twig
---
...
:   [craft\mail\transportadapters\Smtp](craft-mail-transportadapters-smtp.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/mail/transportadapters/Smtp.php)
...
| [encryptionMethod](craft-mail-transportadapters-smtp.md#encryptionmethod)                                                        | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The encryption method that should be used, if any (ssl or tls)
| [errors](https://www.yiiframework.com/doc/api/2.0/yii-base-model#$errors-detail "Defined by yii\base\Model")                     | [array](http://php.net/language.types.array) – Errors for all attributes or the specified attribute.
| [firstErrors](https://www.yiiframework.com/doc/api/2.0/yii-base-model#$firstErrors-detail "Defined by yii\base\Model")           | [array](http://php.net/language.types.array) – The first errors.
| [host](craft-mail-transportadapters-smtp.md#host)                                                                                | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The host that should be used
...
| [isNew](craft-base-savablecomponent.md#isnew "Defined by craft\base\SavableComponent")                                           | [boolean](http://php.net/language.types.boolean) – Whether the component is new
| [iterator](https://www.yiiframework.com/doc/api/2.0/yii-base-model#$iterator-detail "Defined by yii\base\Model")                 | [ArrayIterator](http://php.net/class.arrayiterator) – An iterator for traversing the items in the list.
| [password](craft-mail-transportadapters-smtp.md#password)                                                                        | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The password that should be used
| [port](craft-mail-transportadapters-smtp.md#port)                                                                                | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The port that should be used
| [scenario](https://www.yiiframework.com/doc/api/2.0/yii-base-model#$scenario-detail "Defined by yii\base\Model")                 | [string](http://php.net/language.types.string) – The scenario that this model is in.
| [settings](craft-base-savablecomponent.md#settings "Defined by craft\base\SavableComponent")                                     | [array](http://php.net/language.types.array) – The component’s settings.
| [settingsHtml](craft-mail-transportadapters-smtp.md#settingshtml)                                                                | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null)
| [timeout](craft-mail-transportadapters-smtp.md#timeout)                                                                          | [string](http://php.net/language.types.string) – The timeout duration (in seconds)
| [useAuthentication](craft-mail-transportadapters-smtp.md#useauthentication)                                                      | [boolean](http://php.net/language.types.boolean), [null](http://php.net/language.types.null) – Whether to use authentication
| [username](craft-mail-transportadapters-smtp.md#username)                                                                        | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The username that should be used
...
The encryption method that should be used, if any (ssl or tls)



[View source](https://github.com/craftcms/cms/blob/master/src/mail/transportadapters/Smtp.php#L57)
...
[View source](https://github.com/craftcms/cms/blob/master/src/mail/transportadapters/Smtp.php#L32)
...
[View source](https://github.com/craftcms/cms/blob/master/src/mail/transportadapters/Smtp.php#L52)
...
[View source](https://github.com/craftcms/cms/blob/master/src/mail/transportadapters/Smtp.php#L37)
...
[View source](https://github.com/craftcms/cms/blob/master/src/mail/transportadapters/Smtp.php#L62)
...
[View source](https://github.com/craftcms/cms/blob/master/src/mail/transportadapters/Smtp.php#L42)
...
[View source](https://github.com/craftcms/cms/blob/master/src/mail/transportadapters/Smtp.php#L47)
...
| [afterDelete()](craft-base-savablecomponent.md#method-afterdelete "Defined by craft\base\SavableComponent")                                     | Performs actions after a component is deleted.
| [afterSave()](craft-base-savablecomponent.md#method-aftersave "Defined by craft\base\SavableComponent")                                         | Performs actions after a component is saved.
...
| [attributeLabels()](craft-mail-transportadapters-smtp.md#method-attributelabels)                                                                | Returns the attribute labels.
| [attributes()](https://www.yiiframework.com/doc/api/2.0/yii-base-model#attributes()-detail "Defined by yii\base\Model")                         | Returns the list of attribute names.
| [beforeApplyDelete()](craft-base-savablecomponent.md#method-beforeapplydelete "Defined by craft\base\SavableComponent")                         | Performs actions before a component delete is applied to the database.
| [beforeDelete()](craft-base-savablecomponent.md#method-beforedelete "Defined by craft\base\SavableComponent")                                   | Performs actions before a component is deleted.
| [beforeSave()](craft-base-savablecomponent.md#method-beforesave "Defined by craft\base\SavableComponent")                                       | Performs actions before a component is saved.
| [beforeValidate()](https://www.yiiframework.com/doc/api/2.0/yii-base-model#beforeValidate()-detail "Defined by yii\base\Model")                 | This method is invoked before validation starts.
| [behaviors()](craft-mail-transportadapters-smtp.md#method-behaviors)                                                                            | Returns a list of behaviors that this component should behave as.
...
| [defineTransport()](craft-mail-transportadapters-smtp.md#method-definetransport)                                                                | Returns the config array or \Swift_Transport object that should be passed to [craft\mail\Mailer::setTransport()](https://www.yiiframework.com/extension/yiisoft/yii2-swiftmailer/doc/api/2.2/yii-swiftmailer-mailer#setTransport()-detail).
| [detachBehavior()](https://www.yiiframework.com/doc/api/2.0/yii-base-component#detachBehavior()-detail "Defined by yii\base\Component")         | Detaches a behavior from the component.
| [detachBehaviors()](https://www.yiiframework.com/doc/api/2.0/yii-base-component#detachBehaviors()-detail "Defined by yii\base\Component")       | Detaches all behaviors from the component.
| [displayName()](craft-mail-transportadapters-smtp.md#method-displayname)                                                                        | Returns the display name of this class.
...
| [getIsNew()](craft-base-savablecomponent.md#method-getisnew "Defined by craft\base\SavableComponent")                                           | Returns whether the component is new (unsaved).
| [getIterator()](https://www.yiiframework.com/doc/api/2.0/yii-base-model#getIterator()-detail "Defined by yii\base\Model")                       | Returns an iterator for traversing the attributes in the model.
| [getScenario()](https://www.yiiframework.com/doc/api/2.0/yii-base-model#getScenario()-detail "Defined by yii\base\Model")                       | Returns the scenario that this model is used in.
| [getSettings()](craft-base-savablecomponent.md#method-getsettings "Defined by craft\base\SavableComponent")                                     | Returns an array of the component’s settings.
| [getSettingsHtml()](craft-mail-transportadapters-smtp.md#method-getsettingshtml)                                                                | Returns the component’s settings HTML.
...
| [isSelectable()](craft-base-savablecomponent.md#method-isselectable "Defined by craft\base\SavableComponent")                                   | Returns whether the component should be selectable in component Type selects.
...
| [settingsAttributes()](craft-base-savablecomponent.md#method-settingsattributes "Defined by craft\base\SavableComponent")                       | Returns the list of settings attribute names.
...
[View source](https://github.com/craftcms/cms/blob/master/src/mail/transportadapters/Smtp.php#L85-L96)
...
[View source](https://github.com/craftcms/cms/blob/master/src/mail/transportadapters/Smtp.php#L67-L80)
...
[View source](https://github.com/craftcms/cms/blob/master/src/mail/transportadapters/Smtp.php#L132-L151)
...
[View source](https://github.com/craftcms/cms/blob/master/src/mail/transportadapters/Smtp.php#L24-L27)
...
[View source](https://github.com/craftcms/cms/blob/master/src/mail/transportadapters/Smtp.php#L122-L127)
...
| Method                                                                                                                                                  | Description
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [defineRules()](craft-mail-transportadapters-smtp.md#method-definerules)                                                                                | Returns the validation rules for attributes.
...
[View source](https://github.com/craftcms/cms/blob/master/src/mail/transportadapters/Smtp.php#L101-L117)
