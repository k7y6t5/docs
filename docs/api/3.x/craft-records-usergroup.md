...
:   [craft\records\UserGroup](craft-records-usergroup.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/UserGroup.php)
...
| [users](craft-records-usergroup.md#users)                                                                                                              | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface)
...
| [getUsers()](craft-records-usergroup.md#method-getusers)                                                                                                        | Returns the group’s users.
...
| [tableName()](craft-records-usergroup.md#method-tablename)                                                                                                      | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/UserGroup.php#L40-L44)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/UserGroup.php#L30-L33)
