---
title: craft\events\RegisterGqlQueriesEvent
code:
  - php
  - twig
---
...
:   [craft\events\RegisterGqlQueriesEvent](craft-events-registergqlqueriesevent.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterGqlQueriesEvent.php)
...
| [queries](craft-events-registergqlqueriesevent.md#queries)                                                     | [array](http://php.net/language.types.array)[] – List of GraphQL query definitions
...
List of GraphQL query definitions



[View source](https://github.com/craftcms/cms/blob/master/src/events/RegisterGqlQueriesEvent.php#L23)
