...
:   [craft\records\Site](craft-records-site.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/Site.php)
...
| [group](craft-records-site.md#group)                                                                                                                   | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [getGroup()](craft-records-site.md#method-getgroup)                                                                                                             | Returns the site’s group.
...
| [tableName()](craft-records-site.md#method-tablename)                                                                                                           | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/Site.php#L49-L52)
...
[View source](https://github.com/craftcms/cms/blob/master/src/records/Site.php#L39-L42)
