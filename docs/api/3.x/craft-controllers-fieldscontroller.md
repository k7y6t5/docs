---
title: craft\controllers\FieldsController
code:
  - php
  - twig
---
...
:   [craft\controllers\FieldsController](craft-controllers-fieldscontroller.md) &raquo;
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/FieldsController.php)
...
| [actionDeleteField()](craft-controllers-fieldscontroller.md#method-actiondeletefield)                                                                   | Deletes a field.
| [actionDeleteGroup()](craft-controllers-fieldscontroller.md#method-actiondeletegroup)                                                                   | Deletes a field group.
| [actionEditField()](craft-controllers-fieldscontroller.md#method-actioneditfield)                                                                       | Edits a field.
| [actionRenderSettings()](craft-controllers-fieldscontroller.md#method-actionrendersettings)                                                             | Renders a field's settings.
| [actionSaveField()](craft-controllers-fieldscontroller.md#method-actionsavefield)                                                                       | Saves a field.
| [actionSaveGroup()](craft-controllers-fieldscontroller.md#method-actionsavegroup)                                                                       | Saves a field group.
...
| [init()](craft-controllers-fieldscontroller.md#method-init)                                                                                             | Initializes the object.
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/FieldsController.php#L332-L341)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/FieldsController.php#L85-L98)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/FieldsController.php#L113-L255)


#### Arguments

- `$fieldId` ([integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null)) – The field’s ID, if editing an existing field
- `$field` ([craft\base\FieldInterface](craft-base-fieldinterface.md), [null](http://php.net/language.types.null)) – The field being edited, if there were any validation errors
- `$groupId` ([integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null)) – The default group ID that the field should be saved in
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/FieldsController.php#L263-L283)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/FieldsController.php#L290-L325)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/FieldsController.php#L53-L78)
...
[View source](https://github.com/craftcms/cms/blob/master/src/controllers/FieldsController.php#L37-L43)
