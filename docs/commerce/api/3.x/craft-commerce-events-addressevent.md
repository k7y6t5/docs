---
title: craft\commerce\events\AddressEvent
code:
  - php
  - twig
---
...
:   [craft\commerce\events\AddressEvent](craft-commerce-events-addressevent.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/AddressEvent.php)
...
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [address](craft-commerce-events-addressevent.md#address)                                                       | [craft\commerce\models\Address](craft-commerce-models-address.md) – The address model
...
| [isNew](craft-commerce-events-addressevent.md#isnew)                                                           | [boolean](http://php.net/language.types.boolean) – If this is a new address
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/AddressEvent.php#L24)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/AddressEvent.php#L29)
