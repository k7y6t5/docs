---
title: craft\commerce\controllers\CartController
code:
  - php
  - twig
---
...
:   [craft\commerce\controllers\CartController](craft-commerce-controllers-cartcontroller.md) &raquo;
[craft\commerce\controllers\BaseFrontEndController](craft-commerce-controllers-basefrontendcontroller.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/CartController.php)
...
| Property                                                                                                                                             | Description
| ---------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [_cart](craft-commerce-controllers-cartcontroller.md#cart)                                                                                           | [craft\commerce\elements\Order](craft-commerce-elements-order.md) – The cart element
| [_cartVariable](craft-commerce-controllers-cartcontroller.md#cartvariable)                                                                           | [string](http://php.net/language.types.string) – The name of the cart variable
| [allowAnonymous](craft-commerce-controllers-basefrontendcontroller.md#allowanonymous "Defined by craft\commerce\controllers\BaseFrontEndController") | [integer](http://php.net/language.types.integer), [boolean](http://php.net/language.types.boolean), [integer](http://php.net/language.types.integer)[], [string](http://php.net/language.types.string)[] – Whether this controller’s actions can be accessed anonymously.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/CartController.php#L35)
...
The name of the cart variable



[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/CartController.php#L40)
...
| [actionGetCart()](craft-commerce-controllers-cartcontroller.md#method-actiongetcart)                                                                    | Returns the cart as JSON
| [actionLoadCart()](craft-commerce-controllers-cartcontroller.md#method-actionloadcart)                                                                  |
| [actionUpdateCart()](craft-commerce-controllers-cartcontroller.md#method-actionupdatecart)                                                              | Updates the cart by adding purchasables to the cart, updating line items, or updating various cart attributes.
...
| [init()](craft-commerce-controllers-cartcontroller.md#method-init)                                                                                      |
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/CartController.php#L53-L60)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/CartController.php#L252-L312)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/CartController.php#L67-L245)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/CartController.php#L43-L48)
...
| Method                                                                                                                                              | Description
| --------------------------------------------------------------------------------------------------------------------------------------------------- | -----------
| [cartArray()](craft-commerce-controllers-basefrontendcontroller.md#method-cartarray "Defined by craft\commerce\controllers\BaseFrontEndController") |
