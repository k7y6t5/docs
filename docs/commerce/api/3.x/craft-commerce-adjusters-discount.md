---
title: craft\commerce\adjusters\Discount
code:
  - php
  - twig
---
...
:   [craft\commerce\adjusters\Discount](craft-commerce-adjusters-discount.md) &raquo;
...
:   [ArrayAccess](http://php.net/class.arrayaccess), [IteratorAggregate](http://php.net/class.iteratoraggregate), [craft\base\ComponentInterface](https://docs.craftcms.com/api/v3/craft-base-componentinterface.html), [craft\commerce\base\AdjusterInterface](craft-commerce-base-adjusterinterface.md), [yii\base\Arrayable](https://www.yiiframework.com/doc/api/2.0/yii-base-arrayable), [yii\base\Configurable](https://www.yiiframework.com/doc/api/2.0/yii-base-configurable), [yii\base\StaticInstanceInterface](https://www.yiiframework.com/doc/api/2.0/yii-base-staticinstanceinterface)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/adjusters/Discount.php)
...
| [adjust()](craft-commerce-adjusters-discount.md#method-adjust)                                                                                  | Returns adjustments to add to the order
...
[View source](https://github.com/craftcms/commerce/blob/master/src/adjusters/Discount.php#L101-L224)
...
| ------------------ | ---------------------------------
| `ADJUSTMENT_TYPE`  | The discount adjustment type.
| `SCENARIO_DEFAULT` | The name of the default scenario.


## Events

### EVENT_AFTER_DISCOUNT_ADJUSTMENTS_CREATED
