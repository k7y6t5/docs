---
title: craft\commerce\elements\actions\DeleteProduct
code:
  - php
  - twig
---
...
:   [craft\commerce\elements\actions\DeleteProduct](craft-commerce-elements-actions-deleteproduct.md) &raquo;
[craft\elements\actions\Delete](https://docs.craftcms.com/api/v3/craft-elements-actions-delete.html) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/elements/actions/DeleteProduct.php)
...
| [confirmationMessage](https://docs.craftcms.com/api/v3/craft-elements-actions-delete.html#confirmationmessage "Defined by craft\elements\actions\Delete") | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The confirmation message that should be shown before the elements get deleted
...
| [successMessage](https://docs.craftcms.com/api/v3/craft-elements-actions-delete.html#successmessage "Defined by craft\elements\actions\Delete")           | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The message that should be shown after the elements get deleted
| [triggerHtml](https://docs.craftcms.com/api/v3/craft-base-elementaction.html#triggerhtml "Defined by craft\base\ElementAction")                           | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The action’s trigger HTML.
| [triggerLabel](https://docs.craftcms.com/api/v3/craft-elements-actions-delete.html#triggerlabel "Defined by craft\elements\actions\Delete")               | [string](http://php.net/language.types.string) – The action’s trigger label
...
| [getConfirmationMessage()](https://docs.craftcms.com/api/v3/craft-elements-actions-delete.html#method-getconfirmationmessage "Defined by craft\elements\actions\Delete") | Returns a confirmation message that should be displayed before the action is performed.
...
| [getTriggerHtml()](https://docs.craftcms.com/api/v3/craft-base-elementaction.html#method-gettriggerhtml "Defined by craft\base\ElementAction")                           | Returns the action’s trigger HTML.
| [getTriggerLabel()](https://docs.craftcms.com/api/v3/craft-elements-actions-delete.html#method-gettriggerlabel "Defined by craft\elements\actions\Delete")               | Returns the action’s trigger label.
...
| [isDestructive()](https://docs.craftcms.com/api/v3/craft-elements-actions-delete.html#method-isdestructive "Defined by craft\elements\actions\Delete")                   | Returns whether this action is destructive in nature.
...
| [performAction()](craft-commerce-elements-actions-deleteproduct.md#method-performaction)                                                                                 | Performs the action on any elements that match the given criteria.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/elements/actions/DeleteProduct.php#L26-L39)


#### Arguments

- `$query` ([craft\elements\db\ElementQueryInterface](https://docs.craftcms.com/api/v3/craft-elements-db-elementqueryinterface.html)) – The element query defining which elements the action should affect.
