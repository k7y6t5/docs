---
title: craft\commerce\records\PaymentSource
code:
  - php
  - twig
---
...
:   [craft\commerce\records\PaymentSource](craft-commerce-records-paymentsource.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/PaymentSource.php)
...
| [gateway](craft-commerce-records-paymentsource.md#gateway)                                                                                             | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [user](craft-commerce-records-paymentsource.md#user)                                                                                                   | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [getGateway()](craft-commerce-records-paymentsource.md#method-getgateway)                                                                                       | Return the payment source's gateway
...
| [getUser()](craft-commerce-records-paymentsource.md#method-getuser)                                                                                             | Return the payment source's owner user.
...
| [tableName()](craft-commerce-records-paymentsource.md#method-tablename)                                                                                         | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/PaymentSource.php#L43-L46)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/PaymentSource.php#L54-L57)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/PaymentSource.php#L33-L36)
