---
title: craft\commerce\controllers\BaseFrontEndController
code:
  - php
  - twig
---
...
:   [craft\commerce\controllers\CartController](craft-commerce-controllers-cartcontroller.md), [craft\commerce\controllers\CustomerAddressesController](craft-commerce-controllers-customeraddressescontroller.md), [craft\commerce\controllers\DownloadsController](craft-commerce-controllers-downloadscontroller.md), [craft\commerce\controllers\PaymentSourcesController](craft-commerce-controllers-paymentsourcescontroller.md), [craft\commerce\controllers\PaymentsController](craft-commerce-controllers-paymentscontroller.md)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/BaseFrontEndController.php)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/BaseFrontEndController.php#L44)
...
| Method                                                                               | Description
| ------------------------------------------------------------------------------------ | -----------
| [cartArray()](craft-commerce-controllers-basefrontendcontroller.md#method-cartarray) |
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/BaseFrontEndController.php#L51-L73)
...
### EVENT_MODIFY_CART_INFO



Type

:   `\craft\commerce\controllers\Event`



The event that is triggered when an cart is returned as an array (for ajax cart update requests)
