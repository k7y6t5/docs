---
title: craft\commerce\records\CustomerAddress
code:
  - php
  - twig
---
...
:   [craft\commerce\records\CustomerAddress](craft-commerce-records-customeraddress.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/CustomerAddress.php)
...
| [tableName()](craft-commerce-records-customeraddress.md#method-tablename)                                                                                       | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/CustomerAddress.php#L26-L29)
