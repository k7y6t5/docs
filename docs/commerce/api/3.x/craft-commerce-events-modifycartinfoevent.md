---
title: craft\commerce\events\ModifyCartInfoEvent
code:
  - php
  - twig
---
...
:   [craft\commerce\events\ModifyCartInfoEvent](craft-commerce-events-modifycartinfoevent.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/ModifyCartInfoEvent.php)
...
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [cart](craft-commerce-events-modifycartinfoevent.md#cart)                                                      | [craft\commerce\elements\Order](craft-commerce-elements-order.md), [null](http://php.net/language.types.null)
| [cartInfo](craft-commerce-events-modifycartinfoevent.md#cartinfo)                                              | [array](http://php.net/language.types.array) – The cart info that is allowed to be modified
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/ModifyCartInfoEvent.php#L34)
...
The cart info that is allowed to be modified



[View source](https://github.com/craftcms/commerce/blob/master/src/events/ModifyCartInfoEvent.php#L24)
