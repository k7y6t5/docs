---
title: craft\commerce\records\Address
code:
  - php
  - twig
---
...
:   [craft\commerce\records\Address](craft-commerce-records-address.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Address.php)
...
| [country](craft-commerce-records-address.md#country)                                                                                                   | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [state](craft-commerce-records-address.md#state)                                                                                                       | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [getCountry()](craft-commerce-records-address.md#method-getcountry)                                                                                             | Returns the address's country
...
| [getState()](craft-commerce-records-address.md#method-getstate)                                                                                                 | Returns the address's state
...
| [tableName()](craft-commerce-records-address.md#method-tablename)                                                                                               | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Address.php#L74-L77)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Address.php#L64-L67)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Address.php#L54-L57)
