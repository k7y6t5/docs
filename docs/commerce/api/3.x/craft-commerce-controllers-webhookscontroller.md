---
title: craft\commerce\controllers\WebhooksController
code:
  - php
  - twig
---
...
:   [craft\commerce\controllers\WebhooksController](craft-commerce-controllers-webhookscontroller.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/WebhooksController.php)
...
| [enableCsrfValidation](craft-commerce-controllers-webhookscontroller.md#enablecsrfvalidation)                                                  | [boolean](http://php.net/language.types.boolean) – Whether to enable CSRF validation for the actions in this controller.
...
CSRF validation is enabled only when both this property and [yii\web\Request::$enableCsrfValidation](https://www.yiiframework.com/doc/api/2.0/yii-web-request#$enableCsrfValidation-detail) are true.





[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/WebhooksController.php#L33)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/WebhooksController.php#L28)
...
| [actionProcessWebhook()](craft-commerce-controllers-webhookscontroller.md#method-actionprocesswebhook)                                                  |
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/WebhooksController.php#L39-L54)
