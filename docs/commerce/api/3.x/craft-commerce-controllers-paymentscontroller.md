---
title: craft\commerce\controllers\PaymentsController
code:
  - php
  - twig
---
...
:   [craft\commerce\controllers\PaymentsController](craft-commerce-controllers-paymentscontroller.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/PaymentsController.php)
...
| [actionCompletePayment()](craft-commerce-controllers-paymentscontroller.md#method-actioncompletepayment)                                                | Processes return from off-site payment
| [actionPay()](craft-commerce-controllers-paymentscontroller.md#method-actionpay)                                                                        |
...
| [beforeAction()](craft-commerce-controllers-paymentscontroller.md#method-beforeaction)                                                                  | This method is invoked right before an action is executed.
...
| [init()](craft-commerce-controllers-paymentscontroller.md#method-init)                                                                                  |
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/PaymentsController.php#L429-L464)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/PaymentsController.php#L60-L421)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/PaymentsController.php#L44-L52)
...
- [yii\web\ForbiddenHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-forbiddenhttpexception)\
  if the user is not logged in or locks the necessary permissions
- [craft\web\ServiceUnavailableHttpException](https://docs.craftcms.com/api/v3/craft-web-serviceunavailablehttpexception.html)\
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/PaymentsController.php#L34-L39)
