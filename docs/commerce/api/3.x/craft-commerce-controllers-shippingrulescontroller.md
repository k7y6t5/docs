---
title: craft\commerce\controllers\ShippingRulesController
code:
  - php
  - twig
---

# ShippingRulesController
...
:   [craft\commerce\controllers\ShippingRulesController](craft-commerce-controllers-shippingrulescontroller.md) &raquo;
[craft\commerce\controllers\BaseShippingSettingsController](craft-commerce-controllers-baseshippingsettingscontroller.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/ShippingRulesController.php)
...
| [actionDelete()](craft-commerce-controllers-shippingrulescontroller.md#method-actiondelete)                                                             |
| [actionEdit()](craft-commerce-controllers-shippingrulescontroller.md#method-actionedit)                                                                 |
| [actionReorder()](craft-commerce-controllers-shippingrulescontroller.md#method-actionreorder)                                                           |
| [actionSave()](craft-commerce-controllers-shippingrulescontroller.md#method-actionsave)                                                                 |
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/ShippingRulesController.php#L185-L197)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/ShippingRulesController.php#L34-L114)


#### Arguments

- `$methodId` ([integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null))
- `$ruleId` ([integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null))
- `$shippingRule` ([craft\commerce\models\ShippingRule](craft-commerce-models-shippingrule.md), [null](http://php.net/language.types.null))
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/ShippingRulesController.php#L171-L180)



#### Returns

[null](http://php.net/language.types.null), [yii\web\Response](https://www.yiiframework.com/doc/api/2.0/yii-web-response)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/ShippingRulesController.php#L119-L165)
