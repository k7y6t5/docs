---
title: craft\commerce\elements\actions\UpdateOrderStatus
code:
  - php
  - twig
---
...
:   [craft\commerce\elements\actions\UpdateOrderStatus](craft-commerce-elements-actions-updateorderstatus.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/elements/actions/UpdateOrderStatus.php)
...
| [message](craft-commerce-elements-actions-updateorderstatus.md#message)                                                                         | [string](http://php.net/language.types.string)
| [orderStatusId](craft-commerce-elements-actions-updateorderstatus.md#orderstatusid)                                                             | [integer](http://php.net/language.types.integer)
...
| [triggerHtml](craft-commerce-elements-actions-updateorderstatus.md#triggerhtml)                                                                 | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null) – The action’s trigger HTML.
| [triggerLabel](craft-commerce-elements-actions-updateorderstatus.md#triggerlabel)                                                               | [string](http://php.net/language.types.string) – The action’s trigger label
...
[View source](https://github.com/craftcms/commerce/blob/master/src/elements/actions/UpdateOrderStatus.php#L35)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/elements/actions/UpdateOrderStatus.php#L30)
...
| [getTriggerHtml()](craft-commerce-elements-actions-updateorderstatus.md#method-gettriggerhtml)                                                                 | Returns the action’s trigger HTML.
| [getTriggerLabel()](craft-commerce-elements-actions-updateorderstatus.md#method-gettriggerlabel)                                                               | Returns the action’s trigger label.
...
| [performAction()](craft-commerce-elements-actions-updateorderstatus.md#method-performaction)                                                                   | Performs the action on any elements that match the given criteria.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/elements/actions/UpdateOrderStatus.php#L49-L86)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/elements/actions/UpdateOrderStatus.php#L41-L44)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/elements/actions/UpdateOrderStatus.php#L91-L103)
