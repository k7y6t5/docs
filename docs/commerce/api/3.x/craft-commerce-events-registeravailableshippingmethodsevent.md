---
title: craft\commerce\events\RegisterAvailableShippingMethodsEvent
code:
  - php
  - twig
---

# RegisterAvailableShippingMethodsEvent
...
:   [craft\commerce\events\RegisterAvailableShippingMethodsEvent](craft-commerce-events-registeravailableshippingmethodsevent.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/RegisterAvailableShippingMethodsEvent.php)
...
| [order](craft-commerce-events-registeravailableshippingmethodsevent.md#order)                                  | [craft\commerce\elements\Order](craft-commerce-elements-order.md) – The order the shipping method should be available for
...
| [shippingMethods](craft-commerce-events-registeravailableshippingmethodsevent.md#shippingmethods)              | [craft\commerce\base\ShippingMethodInterface](craft-commerce-base-shippingmethodinterface.md)[] – The shipping methods available to the order.
...
The order the shipping method should be available for



[View source](https://github.com/craftcms/commerce/blob/master/src/events/RegisterAvailableShippingMethodsEvent.php#L25)
...
The shipping methods available to the order.



[View source](https://github.com/craftcms/commerce/blob/master/src/events/RegisterAvailableShippingMethodsEvent.php#L30)
