---
title: craft\commerce\records\Subscription
code:
  - php
  - twig
---
...
:   [craft\commerce\records\Subscription](craft-commerce-records-subscription.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Subscription.php)
...
| [gateway](craft-commerce-records-subscription.md#gateway)                                                                                              | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [plan](craft-commerce-records-subscription.md#plan)                                                                                                    | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [user](craft-commerce-records-subscription.md#user)                                                                                                    | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [getGateway()](craft-commerce-records-subscription.md#method-getgateway)                                                                                        | Return the subscription's gateway
...
| [getPlan()](craft-commerce-records-subscription.md#method-getplan)                                                                                              | Return the subscription's plan
...
| [getUser()](craft-commerce-records-subscription.md#method-getuser)                                                                                              | Return the subscription's user
...
| [tableName()](craft-commerce-records-subscription.md#method-tablename)                                                                                          | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Subscription.php#L56-L59)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Subscription.php#L76-L79)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Subscription.php#L66-L69)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Subscription.php#L46-L49)
