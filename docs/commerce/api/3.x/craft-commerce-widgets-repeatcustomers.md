---
title: craft\commerce\widgets\RepeatCustomers
code:
  - php
  - twig
---
...
:   [craft\commerce\widgets\RepeatCustomers](craft-commerce-widgets-repeatcustomers.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/widgets/RepeatCustomers.php)
...
| [bodyHtml](craft-commerce-widgets-repeatcustomers.md#bodyhtml)                                                                                  | [string](http://php.net/language.types.string), [false](http://php.net/language.types.boolean) – The widget’s body HTML, or `false` if the widget should not be visible.
...
| [dateRange](craft-commerce-widgets-repeatcustomers.md#daterange)                                                                                | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null)
...
| [endDate](craft-commerce-widgets-repeatcustomers.md#enddate)                                                                                    | [integer](http://php.net/language.types.integer), [DateTime](http://php.net/class.datetime), [null](http://php.net/language.types.null)
...
| [settingsHtml](craft-commerce-widgets-repeatcustomers.md#settingshtml)                                                                          | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null)
| [startDate](craft-commerce-widgets-repeatcustomers.md#startdate)                                                                                | [integer](http://php.net/language.types.integer), [DateTime](http://php.net/class.datetime), [null](http://php.net/language.types.null)
...
| [title](craft-commerce-widgets-repeatcustomers.md#title)                                                                                        | [string](http://php.net/language.types.string) – The widget’s title.
...
the first place, use [isSelectable()](craft-commerce-widgets-repeatcustomers.md#method-isselectable).)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/widgets/RepeatCustomers.php#L42)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/widgets/RepeatCustomers.php#L37)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/widgets/RepeatCustomers.php#L32)
...
| [displayName()](craft-commerce-widgets-repeatcustomers.md#method-displayname)                                                                                | Returns the display name of this class.
...
| [getBodyHtml()](craft-commerce-widgets-repeatcustomers.md#method-getbodyhtml)                                                                                | Returns the widget's body HTML.
...
| [getSettingsHtml()](craft-commerce-widgets-repeatcustomers.md#method-getsettingshtml)                                                                        | Returns the component’s settings HTML.
...
| [getTitle()](craft-commerce-widgets-repeatcustomers.md#method-gettitle)                                                                                      | Returns the widget’s title.
...
| [icon()](craft-commerce-widgets-repeatcustomers.md#method-icon)                                                                                              | Returns the path to the widget’s SVG icon, or the actual SVG contents.
...
| [init()](craft-commerce-widgets-repeatcustomers.md#method-init)                                                                                              | Initializes the object.
...
| [isSelectable()](craft-commerce-widgets-repeatcustomers.md#method-isselectable)                                                                              | Returns whether the component should be selectable in component Type selects.
| [load()](https://www.yiiframework.com/doc/api/2.0/yii-base-model#load()-detail "Defined by yii\base\Model")                                                  | Populates the model with input data.
| [loadMultiple()](https://www.yiiframework.com/doc/api/2.0/yii-base-model#loadMultiple()-detail "Defined by yii\base\Model")                                  | Populates a set of models with the data from end user.
| [maxColspan()](craft-commerce-widgets-repeatcustomers.md#method-maxcolspan)                                                                                  | Returns the widget’s maximum colspan.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/widgets/RepeatCustomers.php#L75-L78)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/widgets/RepeatCustomers.php#L99-L108)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/widgets/RepeatCustomers.php#L121-L131)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/widgets/RepeatCustomers.php#L91-L94)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/widgets/RepeatCustomers.php#L83-L86)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/widgets/RepeatCustomers.php#L52-L62)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/widgets/RepeatCustomers.php#L67-L70)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/widgets/RepeatCustomers.php#L113-L116)
