---
title: craft\commerce\events\DefaultLineItemStatusEvent
code:
  - php
  - twig
---
...
:   [craft\commerce\events\DefaultLineItemStatusEvent](craft-commerce-events-defaultlineitemstatusevent.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/DefaultLineItemStatusEvent.php)
...
| [lineItem](craft-commerce-events-defaultlineitemstatusevent.md#lineitem)                                       | [craft\commerce\models\LineItem](craft-commerce-models-lineitem.md) – The line item used to determine the line item status.
| [lineItemStatus](craft-commerce-events-defaultlineitemstatusevent.md#lineitemstatus)                           | [craft\commerce\models\LineItemStatus](craft-commerce-models-lineitemstatus.md) – The default line item status based on the line item
...
The line item used to determine the line item status.



[View source](https://github.com/craftcms/commerce/blob/master/src/events/DefaultLineItemStatusEvent.php#L30)
...
The default line item status based on the line item



[View source](https://github.com/craftcms/commerce/blob/master/src/events/DefaultLineItemStatusEvent.php#L25)
