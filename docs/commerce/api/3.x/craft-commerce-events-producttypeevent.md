---
title: craft\commerce\events\ProductTypeEvent
code:
  - php
  - twig
---
...
:   [craft\commerce\events\ProductTypeEvent](craft-commerce-events-producttypeevent.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/ProductTypeEvent.php)
...
| [isNew](craft-commerce-events-producttypeevent.md#isnew)                                                       | [boolean](http://php.net/language.types.boolean) – Whether the product type is brand new
...
| [productType](craft-commerce-events-producttypeevent.md#producttype)                                           | [craft\commerce\models\ProductType](craft-commerce-models-producttype.md), [null](http://php.net/language.types.null) – The product type model associated with the event.
...
Whether the product type is brand new



[View source](https://github.com/craftcms/commerce/blob/master/src/events/ProductTypeEvent.php#L29)
...
:   [craft\commerce\models\ProductType](craft-commerce-models-producttype.md), [null](http://php.net/language.types.null)



The product type model associated with the event.



[View source](https://github.com/craftcms/commerce/blob/master/src/events/ProductTypeEvent.php#L24)
