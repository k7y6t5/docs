---
title: craft\commerce\events\CustomizeVariantSnapshotFieldsEvent
code:
  - php
  - twig
---

# CustomizeVariantSnapshotFieldsEvent
...
:   [craft\commerce\events\CustomizeVariantSnapshotFieldsEvent](craft-commerce-events-customizevariantsnapshotfieldsevent.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/CustomizeVariantSnapshotFieldsEvent.php)
...
| [fields](craft-commerce-events-customizevariantsnapshotfieldsevent.md#fields)                                  | [array](http://php.net/language.types.array), [null](http://php.net/language.types.null) – The fields to be captured
...
| [variant](craft-commerce-events-customizevariantsnapshotfieldsevent.md#variant)                                | [craft\commerce\elements\Variant](craft-commerce-elements-variant.md) – The variant
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/CustomizeVariantSnapshotFieldsEvent.php#L29)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/CustomizeVariantSnapshotFieldsEvent.php#L24)
