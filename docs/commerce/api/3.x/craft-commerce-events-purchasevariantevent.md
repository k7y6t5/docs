---
title: craft\commerce\events\PurchaseVariantEvent
code:
  - php
  - twig
---

# PurchaseVariantEvent
...
:   [craft\commerce\events\PurchaseVariantEvent](craft-commerce-events-purchasevariantevent.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/PurchaseVariantEvent.php)
...
| [variant](craft-commerce-events-purchasevariantevent.md#variant)                                               | [craft\commerce\elements\Variant](craft-commerce-elements-variant.md) – The variant model
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/PurchaseVariantEvent.php#L24)
