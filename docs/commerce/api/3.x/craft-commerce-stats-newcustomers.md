---
title: craft\commerce\stats\NewCustomers
code:
  - php
  - twig
---
...
:   [craft\commerce\stats\NewCustomers](craft-commerce-stats-newcustomers.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/stats/NewCustomers.php)
...
| Property                                               | Description
| ------------------------------------------------------ | ----------------------------------------------
| [_handle](craft-commerce-stats-newcustomers.md#handle) | [string](http://php.net/language.types.string)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/stats/NewCustomers.php#L24)
...
| [getData()](craft-commerce-stats-newcustomers.md#method-getdata)                                                                            |
...
[View source](https://github.com/craftcms/commerce/blob/master/src/stats/NewCustomers.php#L29-L35)
