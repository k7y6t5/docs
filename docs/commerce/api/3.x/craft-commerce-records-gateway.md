---
title: craft\commerce\records\Gateway
code:
  - php
  - twig
---
...
:   [craft\commerce\records\Gateway](craft-commerce-records-gateway.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Gateway.php)
...
| [tableName()](craft-commerce-records-gateway.md#method-tablename)                                                                                               | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Gateway.php#L35-L38)
