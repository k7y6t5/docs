---
title: craft\commerce\records\Email
code:
  - php
  - twig
---
...
:   [craft\commerce\records\Email](craft-commerce-records-email.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Email.php)
...
| [tableName()](craft-commerce-records-email.md#method-tablename)                                                                                                 | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Email.php#L41-L44)
