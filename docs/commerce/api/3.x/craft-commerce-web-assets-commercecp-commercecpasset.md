---
title: craft\commerce\web\assets\commercecp\CommerceCpAsset
code:
  - php
  - twig
---
...
:   [craft\commerce\web\assets\commercecp\CommerceCpAsset](craft-commerce-web-assets-commercecp-commercecpasset.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/web/assets/commercecp/CommerceCpAsset.php)
...
| [init()](craft-commerce-web-assets-commercecp-commercecpasset.md#method-init)                                                             | Initializes the bundle.
...
| [registerAssetFiles()](craft-commerce-web-assets-commercecp-commercecpasset.md#method-registerassetfiles)                                 | Registers the CSS and JS files with the given view.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/web/assets/commercecp/CommerceCpAsset.php#L26-L40)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/web/assets/commercecp/CommerceCpAsset.php#L45-L82)
