---
title: craft\commerce\controllers\ProductsController
code:
  - php
  - twig
---
...
:   [craft\commerce\controllers\ProductsController](craft-commerce-controllers-productscontroller.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/ProductsController.php)
...
| [actionDeleteProduct()](craft-commerce-controllers-productscontroller.md#method-actiondeleteproduct)                                                    | Deletes a product.
| [actionDuplicateProduct()](craft-commerce-controllers-productscontroller.md#method-actionduplicateproduct)                                              | Duplicates a product.
| [actionEditProduct()](craft-commerce-controllers-productscontroller.md#method-actioneditproduct)                                                        |
| [actionProductIndex()](craft-commerce-controllers-productscontroller.md#method-actionproductindex)                                                      |
| [actionSaveProduct()](craft-commerce-controllers-productscontroller.md#method-actionsaveproduct)                                                        | Save a new or existing product.
| [actionVariantIndex()](craft-commerce-controllers-productscontroller.md#method-actionvariantindex)                                                      |
...
| [init()](craft-commerce-controllers-productscontroller.md#method-init)                                                                                  | Initializes the object.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/ProductsController.php#L167-L198)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/ProductsController.php#L342-L345)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/ProductsController.php#L87-L159)


#### Arguments

- `$productTypeHandle` ([string](http://php.net/language.types.string))
- `$productId` ([integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null))
...
- [craft\errors\SiteNotFoundException](https://docs.craftcms.com/api/v3/craft-errors-sitenotfoundexception.html)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/ProductsController.php#L60-L64)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/ProductsController.php#L212-L334)


#### Arguments

- `$duplicate` ([boolean](http://php.net/language.types.boolean)) – Whether the product should be duplicated
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/ProductsController.php#L69-L72)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/ProductsController.php#L50-L54)
...
| Method                                                                                                           | Description
| ---------------------------------------------------------------------------------------------------------------- | -----------
| [enforceProductPermissions()](craft-commerce-controllers-productscontroller.md#method-enforceproductpermissions) |
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/ProductsController.php#L352-L355)
