---
title: craft\commerce\events\ReportEvent
code:
  - php
  - twig
---
...
:   [craft\commerce\events\ReportEvent](craft-commerce-events-reportevent.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/ReportEvent.php)
...
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [columns](craft-commerce-events-reportevent.md#columns)                                                        |
...
| [endDate](craft-commerce-events-reportevent.md#enddate)                                                        |
| [format](craft-commerce-events-reportevent.md#format)                                                          |
...
| [orderQuery](craft-commerce-events-reportevent.md#orderquery)                                                  |
| [orders](craft-commerce-events-reportevent.md#orders)                                                          |
...
| [startDate](craft-commerce-events-reportevent.md#startdate)                                                    |
| [status](craft-commerce-events-reportevent.md#status)                                                          |
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/ReportEvent.php#L24)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/ReportEvent.php#L21)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/ReportEvent.php#L26)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/ReportEvent.php#L23)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/ReportEvent.php#L25)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/ReportEvent.php#L20)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/ReportEvent.php#L22)
