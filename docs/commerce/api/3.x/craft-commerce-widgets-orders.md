---
title: craft\commerce\widgets\Orders
code:
  - php
  - twig
---
...
:   [craft\commerce\widgets\Orders](craft-commerce-widgets-orders.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/widgets/Orders.php)
...
| [bodyHtml](craft-commerce-widgets-orders.md#bodyhtml)                                                                                           | [string](http://php.net/language.types.string), [false](http://php.net/language.types.boolean) – The widget’s body HTML, or `false` if the widget should not be visible.
...
| [limit](craft-commerce-widgets-orders.md#limit)                                                                                                 | [integer](http://php.net/language.types.integer)
| [orderStatusId](craft-commerce-widgets-orders.md#orderstatusid)                                                                                 | [integer](http://php.net/language.types.integer), [null](http://php.net/language.types.null)
...
| [settingsHtml](craft-commerce-widgets-orders.md#settingshtml)                                                                                   | [string](http://php.net/language.types.string), [null](http://php.net/language.types.null)
...
| [title](craft-commerce-widgets-orders.md#title)                                                                                                 | [string](http://php.net/language.types.string) – The widget’s title.
...
the first place, use [isSelectable()](craft-commerce-widgets-orders.md#method-isselectable).)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/widgets/Orders.php#L36)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/widgets/Orders.php#L31)
...
| [displayName()](craft-commerce-widgets-orders.md#method-displayname)                                                                                         | Returns the display name of this class.
...
| [getBodyHtml()](craft-commerce-widgets-orders.md#method-getbodyhtml)                                                                                         | Returns the widget's body HTML.
...
| [getSettingsHtml()](craft-commerce-widgets-orders.md#method-getsettingshtml)                                                                                 | Returns the component’s settings HTML.
...
| [getTitle()](craft-commerce-widgets-orders.md#method-gettitle)                                                                                               | Returns the widget’s title.
...
| [icon()](craft-commerce-widgets-orders.md#method-icon)                                                                                                       | Returns the path to the widget’s SVG icon, or the actual SVG contents.
...
| [isSelectable()](craft-commerce-widgets-orders.md#method-isselectable)                                                                                       | Returns whether the component should be selectable in component Type selects.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/widgets/Orders.php#L49-L52)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/widgets/Orders.php#L81-L95)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/widgets/Orders.php#L100-L116)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/widgets/Orders.php#L65-L76)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/widgets/Orders.php#L57-L60)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/widgets/Orders.php#L41-L44)
