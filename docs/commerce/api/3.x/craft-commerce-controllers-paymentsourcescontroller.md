---
title: craft\commerce\controllers\PaymentSourcesController
code:
  - php
  - twig
---
...
:   [craft\commerce\controllers\PaymentSourcesController](craft-commerce-controllers-paymentsourcescontroller.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/PaymentSourcesController.php)
...
| [actionAdd()](craft-commerce-controllers-paymentsourcescontroller.md#method-actionadd)                                                                  | Adds a payment source.
| [actionDelete()](craft-commerce-controllers-paymentsourcescontroller.md#method-actiondelete)                                                            | Deletes a payment source.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/PaymentSourcesController.php#L38-L107)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/controllers/PaymentSourcesController.php#L116-L155)
...
- [Throwable](http://php.net/class.throwable)\
  if failed to delete the payment source on the gateway
- [yii\web\BadRequestHttpException](https://www.yiiframework.com/doc/api/2.0/yii-web-badrequesthttpexception)\
