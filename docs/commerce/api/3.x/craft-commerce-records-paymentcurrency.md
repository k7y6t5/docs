---
title: craft\commerce\records\PaymentCurrency
code:
  - php
  - twig
---
...
:   [craft\commerce\records\PaymentCurrency](craft-commerce-records-paymentcurrency.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/PaymentCurrency.php)
...
| [tableName()](craft-commerce-records-paymentcurrency.md#method-tablename)                                                                                       | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/PaymentCurrency.php#L28-L31)
