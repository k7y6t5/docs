---
title: craft\commerce\records\Plan
code:
  - php
  - twig
---
...
:   [craft\commerce\records\Plan](craft-commerce-records-plan.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Plan.php)
...
| [gateway](craft-commerce-records-plan.md#gateway)                                                                                                      | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [getGateway()](craft-commerce-records-plan.md#method-getgateway)                                                                                                | Return the subscription plan's gateway
...
| [tableName()](craft-commerce-records-plan.md#method-tablename)                                                                                                  | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Plan.php#L48-L51)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Plan.php#L38-L41)
