---
title: craft\commerce\models\subscriptions\SubscriptionPayment
code:
  - php
  - twig
---
...
:   [craft\commerce\models\subscriptions\SubscriptionPayment](craft-commerce-models-subscriptions-subscriptionpayment.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/models/subscriptions/SubscriptionPayment.php)
...
| [paid](craft-commerce-models-subscriptions-subscriptionpayment.md#paid)                                                          | [boolean](http://php.net/language.types.boolean) – Whether payment has been collected
| [paymentAmount](craft-commerce-models-subscriptions-subscriptionpayment.md#paymentamount)                                        | [float](http://php.net/language.types.float) – Payment amount
| [paymentCurrency](craft-commerce-models-subscriptions-subscriptionpayment.md#paymentcurrency)                                    | [craft\commerce\models\Currency](craft-commerce-models-currency.md) – Payment currency
| [paymentDate](craft-commerce-models-subscriptions-subscriptionpayment.md#paymentdate)                                            | [DateTime](http://php.net/class.datetime) – Time of payment in UTC
| [paymentReference](craft-commerce-models-subscriptions-subscriptionpayment.md#paymentreference)                                  | [string](http://php.net/language.types.string) – The payment reference on gateway
| [response](craft-commerce-models-subscriptions-subscriptionpayment.md#response)                                                  | [string](http://php.net/language.types.string) – The gateway response text
...
[View source](https://github.com/craftcms/commerce/blob/master/src/models/subscriptions/SubscriptionPayment.php#L45)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/models/subscriptions/SubscriptionPayment.php#L25)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/models/subscriptions/SubscriptionPayment.php#L30)
...
Time of payment in UTC



[View source](https://github.com/craftcms/commerce/blob/master/src/models/subscriptions/SubscriptionPayment.php#L35)
...
The payment reference on gateway



[View source](https://github.com/craftcms/commerce/blob/master/src/models/subscriptions/SubscriptionPayment.php#L40)
...
The gateway response text



[View source](https://github.com/craftcms/commerce/blob/master/src/models/subscriptions/SubscriptionPayment.php#L50)
