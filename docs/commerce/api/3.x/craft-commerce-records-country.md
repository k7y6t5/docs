---
title: craft\commerce\records\Country
code:
  - php
  - twig
---
...
:   [craft\commerce\records\Country](craft-commerce-records-country.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Country.php)
...
| [states](craft-commerce-records-country.md#states)                                                                                                     | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface) – The relational query object.
...
| [getStates()](craft-commerce-records-country.md#method-getstates)                                                                                               | Returns the country's states
...
| [tableName()](craft-commerce-records-country.md#method-tablename)                                                                                               | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Country.php#L41-L44)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Country.php#L31-L34)
