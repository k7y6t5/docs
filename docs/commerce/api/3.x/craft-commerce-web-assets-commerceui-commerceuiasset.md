---
title: craft\commerce\web\assets\commerceui\CommerceUiAsset
code:
  - php
  - twig
---
...
[View source](https://github.com/craftcms/commerce/blob/master/src/web/assets/commerceui/CommerceUiAsset.php)
...
| Property                                                                 | Description
| ------------------------------------------------------------------------ | ----------------------------------------------
| [appCss](craft-commerce-web-assets-commerceui-commerceuiasset.md#appcss) | [string](http://php.net/language.types.string)
| [appJs](craft-commerce-web-assets-commerceui-commerceuiasset.md#appjs)   | [string](http://php.net/language.types.string)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/web/assets/commerceui/CommerceUiAsset.php#L33)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/web/assets/commerceui/CommerceUiAsset.php#L28)
...
| [init()](craft-commerce-web-assets-commerceui-commerceuiasset.md#method-init)                                                                     | Initializes the bundle.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/web/assets/commerceui/CommerceUiAsset.php#L38-L62)
