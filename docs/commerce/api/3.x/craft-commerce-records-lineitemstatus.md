---
title: craft\commerce\records\LineItemStatus
code:
  - php
  - twig
---
...
:   [craft\commerce\records\LineItemStatus](craft-commerce-records-lineitemstatus.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/LineItemStatus.php)
...
| [tableName()](craft-commerce-records-lineitemstatus.md#method-tablename)                                                                                        | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/LineItemStatus.php#L32-L35)
