---
title: craft\commerce\events\EmailEvent
code:
  - php
  - twig
---
...
:   [craft\commerce\events\EmailEvent](craft-commerce-events-emailevent.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/EmailEvent.php)
...
| [email](craft-commerce-events-emailevent.md#email)                                                             | [craft\commerce\models\Email](craft-commerce-models-email.md) – Email
...
| [isNew](craft-commerce-events-emailevent.md#isnew)                                                             | [boolean](http://php.net/language.types.boolean) – Whether the email is brand new.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/EmailEvent.php#L24)
...
Whether the email is brand new.



[View source](https://github.com/craftcms/commerce/blob/master/src/events/EmailEvent.php#L29)
