---
title: craft\commerce\records\ShippingCategory
code:
  - php
  - twig
---
...
:   [craft\commerce\records\ShippingCategory](craft-commerce-records-shippingcategory.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/ShippingCategory.php)
...
| [tableName()](craft-commerce-records-shippingcategory.md#method-tablename)                                                                                      | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/ShippingCategory.php#L29-L32)
