---
title: craft\commerce\records\Discount
code:
  - php
  - twig
---
...
:   [craft\commerce\records\Discount](craft-commerce-records-discount.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Discount.php)
...
| [categories](craft-commerce-records-discount.md#categories)                                                                                            | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface)
...
| [discountCategories](craft-commerce-records-discount.md#discountcategories)                                                                            | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface)
| [discountPurchasables](craft-commerce-records-discount.md#discountpurchasables)                                                                        | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface)
| [discountUserGroups](craft-commerce-records-discount.md#discountusergroups)                                                                            | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface)
| [errors](https://www.yiiframework.com/doc/api/2.0/yii-base-model#$errors-detail "Defined by yii\base\Model")                                           | [array](http://php.net/language.types.array) – Errors for all attributes or the specified attribute.
| [firstErrors](https://www.yiiframework.com/doc/api/2.0/yii-base-model#$firstErrors-detail "Defined by yii\base\Model")                                 | [array](http://php.net/language.types.array) – The first errors.
| [groups](craft-commerce-records-discount.md#groups)                                                                                                    | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface)
...
| [purchasables](craft-commerce-records-discount.md#purchasables)                                                                                        | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface)
...
| [getCategories()](craft-commerce-records-discount.md#method-getcategories)                                                                                      |
...
| [getDiscountCategories()](craft-commerce-records-discount.md#method-getdiscountcategories)                                                                      |
| [getDiscountPurchasables()](craft-commerce-records-discount.md#method-getdiscountpurchasables)                                                                  |
| [getDiscountUserGroups()](craft-commerce-records-discount.md#method-getdiscountusergroups)                                                                      |
...
| [getGroups()](craft-commerce-records-discount.md#method-getgroups)                                                                                              |
...
| [getPurchasables()](craft-commerce-records-discount.md#method-getpurchasables)                                                                                  |
...
| [tableName()](craft-commerce-records-discount.md#method-tablename)                                                                                              | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Discount.php#L125-L128)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Discount.php#L101-L104)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Discount.php#L93-L96)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Discount.php#L85-L88)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Discount.php#L109-L112)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Discount.php#L117-L120)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/Discount.php#L77-L80)
...
| --------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| `APPLIED_TO_ALL_LINE_ITEMS`                   |
| `APPLIED_TO_MATCHING_LINE_ITEMS`              |
| `BASE_DISCOUNT_TYPE_PERCENT_ITEMS`            |
| `BASE_DISCOUNT_TYPE_PERCENT_ITEMS_DISCOUNTED` |
| `BASE_DISCOUNT_TYPE_PERCENT_TOTAL`            |
| `BASE_DISCOUNT_TYPE_PERCENT_TOTAL_DISCOUNTED` |
| `BASE_DISCOUNT_TYPE_VALUE`                    |
| `CATEGORY_RELATIONSHIP_TYPE_BOTH`             |
| `CATEGORY_RELATIONSHIP_TYPE_SOURCE`           |
...
| `TYPE_DISCOUNTED_SALEPRICE`                   |
| `TYPE_ORIGINAL_SALEPRICE`                     |
