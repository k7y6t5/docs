---
title: craft\commerce\events\RefundTransactionEvent
code:
  - php
  - twig
---
...
:   [craft\commerce\events\RefundTransactionEvent](craft-commerce-events-refundtransactionevent.md) &raquo;
[craft\commerce\events\TransactionEvent](craft-commerce-events-transactionevent.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/RefundTransactionEvent.php)
...
| ------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| [amount](craft-commerce-events-refundtransactionevent.md#amount)                                                         | [float](http://php.net/language.types.float) – The amount to refund
...
| [transaction](craft-commerce-events-transactionevent.md#transaction "Defined by craft\commerce\events\TransactionEvent") | [craft\commerce\models\Transaction](craft-commerce-models-transaction.md) – The transaction model
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/RefundTransactionEvent.php#L21)
