---
title: craft\commerce\records\OrderStatus
code:
  - php
  - twig
---
...
:   [craft\commerce\records\OrderStatus](craft-commerce-records-orderstatus.md) &raquo;
...
:   [craft\db\SoftDeleteTrait](https://docs.craftcms.com/api/v3/craft-db-softdeletetrait.html), [yii\base\ArrayableTrait](https://www.yiiframework.com/doc/api/2.0/yii-base-arrayabletrait), [yii\base\StaticInstanceTrait](https://www.yiiframework.com/doc/api/2.0/yii-base-staticinstancetrait)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/OrderStatus.php)
...
| [emails](craft-commerce-records-orderstatus.md#emails)                                                                                                 | [yii\db\ActiveQueryInterface](https://www.yiiframework.com/doc/api/2.0/yii-db-activequeryinterface)
...
| [behaviors()](https://docs.craftcms.com/api/v3/craft-db-softdeletetrait.html#method-behaviors "Defined by craft\db\SoftDeleteTrait")                            | Returns a list of behaviors that this component should behave as.
...
| [getEmails()](craft-commerce-records-orderstatus.md#method-getemails)                                                                                           |
...
| [tableName()](craft-commerce-records-orderstatus.md#method-tablename)                                                                                           | Declares the name of the database table associated with this AR class.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/OrderStatus.php#L45-L48)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/records/OrderStatus.php#L37-L40)
