---
title: craft\commerce\events\DefaultOrderStatusEvent
code:
  - php
  - twig
---

# DefaultOrderStatusEvent
...
:   [craft\commerce\events\DefaultOrderStatusEvent](craft-commerce-events-defaultorderstatusevent.md) &raquo;
...
[View source](https://github.com/craftcms/commerce/blob/master/src/events/DefaultOrderStatusEvent.php)
...
| [order](craft-commerce-events-defaultorderstatusevent.md#order)                                                | [craft\commerce\elements\Order](craft-commerce-elements-order.md) – The order used to determine the order status.
| [orderStatus](craft-commerce-events-defaultorderstatusevent.md#orderstatus)                                    | [craft\commerce\models\OrderStatus](craft-commerce-models-orderstatus.md) – The default order status based on the order
...
The order used to determine the order status.



[View source](https://github.com/craftcms/commerce/blob/master/src/events/DefaultOrderStatusEvent.php#L30)
...
The default order status based on the order



[View source](https://github.com/craftcms/commerce/blob/master/src/events/DefaultOrderStatusEvent.php#L25)
