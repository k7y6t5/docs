---
title: craft\commerce\exports\LineItemExport
code:
  - php
  - twig
---
...
:   [craft\commerce\exports\LineItemExport](craft-commerce-exports-lineitemexport.md) &raquo;
[craft\base\ElementExporter](https://docs.craftcms.com/api/v3/craft-base-elementexporter.html) &raquo;
...
:   [ArrayAccess](http://php.net/class.arrayaccess), [IteratorAggregate](http://php.net/class.iteratoraggregate), [craft\base\ComponentInterface](https://docs.craftcms.com/api/v3/craft-base-componentinterface.html), [craft\base\ElementExporterInterface](https://docs.craftcms.com/api/v3/craft-base-elementexporterinterface.html), [yii\base\Arrayable](https://www.yiiframework.com/doc/api/2.0/yii-base-arrayable), [yii\base\Configurable](https://www.yiiframework.com/doc/api/2.0/yii-base-configurable), [yii\base\StaticInstanceInterface](https://www.yiiframework.com/doc/api/2.0/yii-base-staticinstanceinterface)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/exports/LineItemExport.php)
...
| [filename](https://docs.craftcms.com/api/v3/craft-base-elementexporter.html#filename "Defined by craft\base\ElementExporter")    | [string](http://php.net/language.types.string)
...
| Property                                                                                                                            | Description
| ----------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------
| [elementType](https://docs.craftcms.com/api/v3/craft-base-elementexporter.html#elementtype "Defined by craft\base\ElementExporter") | [string](http://php.net/language.types.string), [craft\base\ElementInterface](https://docs.craftcms.com/api/v3/craft-base-elementinterface.html)
...
| [displayName()](craft-commerce-exports-lineitemexport.md#method-displayname)                                                                       | Returns the display name of this class.
| [ensureBehaviors()](https://www.yiiframework.com/doc/api/2.0/yii-base-component#ensureBehaviors()-detail "Defined by yii\base\Component")          | Makes sure that the behaviors declared in [behaviors()](https://www.yiiframework.com/doc/api/2.0/yii-base-component#behaviors()-detail) are attached to this component.
| [export()](craft-commerce-exports-lineitemexport.md#method-export)                                                                                 | Creates the export data for elements fetched with the given element query.
...
| [getFilename()](https://docs.craftcms.com/api/v3/craft-base-elementexporter.html#method-getfilename "Defined by craft\base\ElementExporter")       | Returns the filename (sans extension) that the export file should have.
...
| [setElementType()](https://docs.craftcms.com/api/v3/craft-base-elementexporter.html#method-setelementtype "Defined by craft\base\ElementExporter") | Sets the element type on the exporter.
...
[View source](https://github.com/craftcms/commerce/blob/master/src/exports/LineItemExport.php#L24-L27)
...
[View source](https://github.com/craftcms/commerce/blob/master/src/exports/LineItemExport.php#L32-L93)


#### Arguments

- `$query` ([craft\elements\db\ElementQueryInterface](https://docs.craftcms.com/api/v3/craft-elements-db-elementqueryinterface.html)) – The element query
